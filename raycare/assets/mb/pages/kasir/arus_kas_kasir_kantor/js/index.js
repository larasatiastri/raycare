mb.app.arus_kas_kasir = mb.app.arus_kas_kasir || {};
(function(o){

    var 
        baseAppUrl              = '',
        $form   = $('#form_index'),
        $table1 = $('#table_arus_kas_kasir')
        ;
    ...
    var handleDataTable = function() 
    {
    	...
    	oTable = $table1.dataTable({
			...
			'ajax'              	: {
				'url' : baseAppUrl + 'listing/' + tgl_awal + '/' + tgl_akhir,
				'type' : 'POST',
			},			
			'pageLength'			: 10,
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'kasir/arus_kas_kasir_kantor/';
        handleDateRangePicker();
        handleDataTable();

    };
 }(mb.app.arus_kas_kasir));


// initialize  mb.app.home.table
$(function(){
    mb.app.arus_kas_kasir.init();
});