...
<div class="portlet light">
	<div class="portlet">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-check font-blue-sharp bold"></i>
			...
			<div class="actions">
				<a class="btn btn-default btn-circle" href="<?=base_url()?>keuangan/persetujuan_permintaan_biaya/history">
		...
		<div class="portlet-body">
			<table class="table table-striped table-hover" id="table_persetujuan_permintaan_biaya">
				<thead>
				<tr>
