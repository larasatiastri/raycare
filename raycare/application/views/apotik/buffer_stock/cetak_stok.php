                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption" align="center" style="font-size:16px;text-transform: uppercase;padding-bottom:10px;color:#2462AC;">
                            <strong><span class="caption-subject"><?=translate("Daftar stok yang tersedia di ", $this->session->userdata("language"))?><?=$gudang['nama']?></span></strong>
                ...
                // die(dump($result));
                        ...
                        ?>
                        	<tr>
                        		...
                        		<td><?=$row['unit']?></td>
                        		<td><?=$row['bn_sn_lot']?></td>
                        		<td><?=($row['expire_date'] != '' && $row['expire_date'] != NULL)?date('d M Y', strtotime($row['expire_date'])):'-'?></td>
                        	</tr>
                        <?php
                        		$i++;
                         	}
