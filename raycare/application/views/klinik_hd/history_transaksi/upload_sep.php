	        		...
	        		<div class="alert alert-success display-hide">
	               	...
	               	<div class="form-body" >
		               	<div class="form-group">
							...
							<div class="col-md-8">
								<input class="form-control" id="no_sep_0" name="upload_sep[0][no_sep]" placeholder="No. SEP" value="<?=$data_tindakan['no_sep']?>" >
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-4"><?=translate("Upload SEP", $this->session->userdata("language"))?> :<span class="required">*</span></label>
							<div class="col-md-8">
								<input type="hidden" required name="upload_sep[0][url]" id="url_sep_0" value="<?=$data_tindakan['url_sep']?>">
								<div id="upload_0">
							...
							<?php
								if($data_tindakan['url_sep'] != NULL || $data_tindakan['url_sep'] != ''){
									...
									<li class="working">
										<div class="thumbnail">
											<a class="fancybox-button" title="<?=$data_tindakan['no_transaksi'].'/'.$data_tindakan['url_sep']?>" href="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/klinik_hd/history_transaksi/images/<?=$data_tindakan['no_transaksi'].'/'.$data_tindakan['url_sep']?>" data-rel="fancybox-button">
											<img src="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/klinik_hd/history_transaksi/images/<?=$data_tindakan['no_transaksi'].'/'.$data_tindakan['url_sep']?>" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a>
										</div>
										<span></span>
									</li>
									<?php
