mb.app.pencairan_dana = mb.app.pencairan_dana || {};
(function(o){

    var 
        baseAppUrl              = '',
        $form   = $('#form_index'),
        $table1 = $('#table_pencairan_dana'),
    ...
    var handleDataTable = function() 
    {
        ...
        oTable = $table1.dataTable({
            ...
            'columns'               : [
                ...
                { 'name' : 'pembayaran_transaksi.created_date tanggal', 'visible' : true, 'searchable': true, 'orderable': false },
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'keuangan/pencairan_dana/';
        handleDataTable();

    };
 }(mb.app.pencairan_dana));


// initialize  mb.app.home.table
$(function(){
    mb.app.pencairan_dana.init();
});