<?php
    ...
    echo form_open(base_url()."apotik/box_paket/save", $form_attr, $hidden);
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate('Pengepakan Box Paket', $this->session->userdata('language'))?></span>
		</div>
		<?php $msg = translate("Apakah anda yakin akan membuat box paket ini?",$this->session->userdata("language"));?>
		<div class="actions">	
			<a class="btn btn-circle btn-default" href="<?=base_url()?>apotik/box_paket/history"><i class="fa fa-undo"></i>  <?=translate("History", $this->session->userdata("language"))?></a>
			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body form">
                    ...
                    <div class="form-group">
                        <label class="col-md-12"><?=translate("Gudang", $this->session->userdata("language"))?> <span style="color:red;" class="required">*</span>:</label>
                        <div class="col-md-12">
                            <?php
                                $gudang_options = array(
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<?php
                                    ...
                                    $master_box_paket = $this->box_paket_m->get_by(array('is_active' => 1));
                                    $master_box_paket = object_to_array($master_box_paket);

                                    foreach ($master_box_paket as $box_paket) {
                                        $jenis_paket_option[$box_paket['id'].'_'.$box_paket['harga'].'_'.$box_paket['tipe']] = $box_paket['nama'];
                                   }

									echo form_dropdown('box_paket_id', $jenis_paket_option, '','id="box_paket_id" class="form-control" ');
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
                                    <input class="form-control text-right" id="harga" name="harga" value="" readonly="">
		...
		<div class="col-md-9">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body"> 
                    ...
                    <span id="tpl_item_row_hidden" class="hidden"><?=htmlentities($item_row_template)?></span>
