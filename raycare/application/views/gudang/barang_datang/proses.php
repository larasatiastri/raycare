...
<div class="portlet light">
	...
	<div class="portlet-body form">
			...
			<div class="col-md-3">
				<div class="tabbable-custom nav-justified">
					<ul class="nav nav-tabs nav-justified">
						<li class="active">
							<a href="#tab_informasi" data-toggle="tab">Form Input</a>
						</li>
						<li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_informasi">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="hidden" name="url_faktur" id="url_faktur" required>
									<div id="upload">
						...
						<?php 
							...
							$id = rtrim($id,"','");
								...
								foreach ($get_data_po as $data_po) {
									...
									$data_pembelian_detail[] = '
										<tr id="item_row_'.$i.'" class="table_item">
											...
											<td class="text-left">
												<a class="jumlah_pesan" data-toggle="modal" data-target="#popup_modal_jumlah_pesan" href="'.base_url().'gudang/barang_datang/modal_jumlah_pesan/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'" >
													<span name="items['.$i.'][jumlah_pesan]">'.$data_pesan.'</span>
												</a>
											</td>
											
											<td class="text-left">
												<a class="jumlah_terima" data-toggle="modal" data-target="#popup_modal_jumlah_terima" href="'.base_url().'gudang/barang_datang/modal_jumlah_terima/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'">
								...
								$pembelian_detail = '<td class="text-center">
											...
											<td class="text-center inline-button-table">
												<a class="btn blue-chambray pemisahan_item" href="'.base_url().'gudang/barang_datang/add_terima_barang/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.intval($data_po['jumlah_pesan']).'/item_row_'.$i.'/'.$draft_detail_id[0]['draft_pmb_detail_id'].'/'.$draft_pmb_id.'/'.$supplier_id.'/'.$gudang_id.'/'.$data_po['id'].'"><i class="fa fa-chain-broken"></i></a>
		...
		<div class="form-actions right">
			...
			<a id="confirm_save" class="btn btn-sm btn-primary btn-circle" href="#" data-confirm="<?=$msg?>" data-toggle="modal"><i class="glyphicon glyphicon-floppy-disk"></i> <?=translate("Simpan", $this->session->userdata("language"))?></a>
