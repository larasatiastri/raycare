...
// =============temp
	...
	$item_cols776 = array(
	    ...
	    'item_jumlah'  	=> '<input type="text" id="1tindakan_jumlah_{0}" name="1resep[{0}][jumlah1]" class="form-control" style="width:300px;" value="1">',
...
<div class="row">
	<div class="col-md-12">
		<form id="form-resep" name="form-resep" autocomplete="off" class="form-horizontal" role="form">		 
			<div class="portlet light bordered">
				<div class="portlet-title">
					...
					<div class="actions" id="appendrow">
			            ...
			            <a id="simpan_resep" title="simpan" data-confirm="<?=translate('Anda yakin akan membuat resep untuk pasien ini?', $this->session->userdata('language'))?>" class="btn btn-icon-only btn-circle btn-primary" name="simpanresep">
	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<?=translate("History Resep Pasien", $this->session->userdata("language"))?>
				</div>
			</div>
			<div class="portlet-body">
				<table class="table table-striped table-bordered table-hover" id="table_history_resep" name="table_history_resep">
               		<thead>
                   		<tr role="row">
                        	<th class="text-center"><?=translate("Nama", $this->session->userdata("language"))?></th>
                        	<th class="text-center" width="1%"><?=translate("Jumlah", $this->session->userdata("language"))?></th>
                        	<th class="text-center" width="1%"><?=translate("Dosis", $this->session->userdata("language"))?></th>
