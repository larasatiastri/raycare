...
class Rujukan_m extends MY_Model {
	 ...
	 */
	public function get_datatable($id=null,$cabang_id=null)
	{	
		  ...
		  $join3 = array('cabang_poliklinik c','c.poliklinik_id = rujukan.poliklinik_tujuan_id','left');
		...
		$this->datatable_prepare($join_tables, $params);
	 	...
	 	$this->db->where('rujukan.tanggal_rujukan < now()');
	 	$this->db->where('rujukan.poliklinik_tujuan_id in (select poliklinik_id from cabang_poliklinik where cabang_id="'.$cabang_id.'")');
		$this->db->group_by(array('poliklinik_id','tanggal_rujukan','tanggal_dirujuk'));
