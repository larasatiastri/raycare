...
mb.app.tindakan_cek_lab.proses = mb.app.tindakan_cek_lab.proses || {};
(function(o){

    var 
        baseAppUrl            = '',
        $form                 = $('#form_proses_cek_lab'),  
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'tindakan/tindakan_cek_lab.proses_manual/';
        handleValidation();
        handleConfirmSave();
        initForm();
        handleDatePickers();
    };
 }(mb.app.tindakan_cek_lab.proses));


// initialize  mb.app.home.table
$(function(){
    mb.app.tindakan_cek_lab.proses.init();
});