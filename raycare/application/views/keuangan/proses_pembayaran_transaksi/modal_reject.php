    <form action="<?=base_url()?>keuangan/proses_pembayaran_transaksi/tolak_permintaan" method="post" id="form_reject" class="form-horizontal">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" id="tipe_dana" name="tipe_dana"  value="<?=$tipe_dana?>" required="required" />
                            <input type="hidden" id="tipe" name="tipe"  value="2" required="required" />
                ...
                <?php
                    $confirm_save       = translate('Anda yakin akan menolak permintaan pembayaran ini ?',$this->session->userdata('language'));
