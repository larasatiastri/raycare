...
(function(o){
    ...
    var 
        baseAppUrl              = '',
        $tablesurat_keterangan_istirahat = $('#tabel_surat_keterangan_istirahat');

    var handleDataTable = function() 
    {
    	$tablesurat_keterangan_istirahat.dataTable({
           	'processing'            : true,
			'serverSide'            : true,
			...
			'order'                	: [[1, 'asc']],
			'columns'               : [
				{ 'name':'surat_istirahat.no_surat no_surat','visible' : true, 'searchable': false, 'orderable': false },
				...
				{ 'name':'surat_istirahat.tanggal_mulai tanggal_mulai','visible' : true, 'searchable': true, 'orderable': true },
				{ 'name':'surat_istirahat.created_date tanggal','visible' : true, 'searchable': true, 'orderable': true },
				{ 'name':'surat_istirahat.id id','visible' : true, 'searchable': false, 'orderable': false },
        		]
        });
        $tablesurat_keterangan_istirahat.on('draw.dt', function (){
			$('.btn', this).tooltip();
 ...
 }(mb.app.surat_keterangan_istirahat));


// initialize  mb.app.home.table
$(function(){
    mb.app.surat_keterangan_istirahat.init();
});