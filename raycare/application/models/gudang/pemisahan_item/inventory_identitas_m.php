...
class Inventory_identitas_m extends MY_Model {
	...
	// Created by Abu for update stock inventory_identitas 
	...
	public function save_simpan_item_identitas($data, $simpan_item_identitas_id)
	{
	...
	{
		$format = "DELETE FROM inventory_identitas WHERE inventory_identitas_id = $inventory_id";
	...
	{
		$format = "SELECT MAX(inventory_identitas_id) FROM inventory_identitas";

		return $this->db->query($format);
	}

	public function save_data($inventory_id, $jumlah, $inventory_identitas_id)
	{
		$id_user = $this->session->userdata('user_id');
		$now = date('Y-m-d');
		$format="INSERT INTO inventory_identitas(inventory_identitas_id, inventory_id, jumlah, created_by, created_date)
				 VALUE ($inventory_identitas_id, $inventory_id, $jumlah, $id_user, '$now')";

		return $this->db->query($format);
	}

	public function delete_inventory_identitas_id($inventory_id)
	{
