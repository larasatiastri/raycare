...
(function(o){
    ...
    var 
		baseAppUrl               = '',
		$tabelProsesKlaim        = $('#table_verifikasi_klaim_bpjs');
		$tabelProsesKlaimHistory = $('#table_verifikasi_klaim_bpjs_history');
 ...
 }(mb.app.verifikasi_klaim_bpjs));


// initialize  mb.app.home.table
$(function(){
    mb.app.verifikasi_klaim_bpjs.init();
});