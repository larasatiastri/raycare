	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase"><?=translate("Data Poliklinik", $this->session->userdata("language"))?></span>
			</div>
			<div class="actions">
	            <a href="<?=base_url()?>master/poliklinik/add" class="btn green-haze">
		...
		<div class="portlet-body form">
			...
			<div class="form-body">
				<div class="form-group">
					<label class="control-label col-md-4"><?=translate("Kode Poliklinik", $this->session->userdata("language"))?> <span class="required"></span>:</label>
					<div class="col-md-2">
						<label class="control-label"><div id="kode2"></div></label>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4"><?=translate("Nama Poliklinik", $this->session->userdata("language"))?> <span class="required"></span>:</label>
					<div class="col-md-3">
