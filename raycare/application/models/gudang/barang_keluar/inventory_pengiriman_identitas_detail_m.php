...
class Inventory_pengiriman_identitas_detail_m extends MY_Model {

	protected $_table        = 'inventory_pengiriman_identitas_detail';
    ...
    public function get_max_id() {
		...
		$this->db->select_max('inventory_pengiriman_identitas_detail_id');
