...
class Os_pembayaran_transaksi_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'o_s_pembayaran_transaksi.o_s_pembayaran_transaksi_id' => 'id',
		...
		'o_s_pembayaran_transaksi.penjamin_id'                 => 'penjamin_id',
		'o_s_pembayaran_transaksi.poliklinik_id'               => 'poliklinik_id',
		'o_s_pembayaran_transaksi.nama_poliklinik'             => 'nama_poliklinik',
		'o_s_pembayaran_transaksi.nama_penjamin'               => 'nama_penjamin',
		'o_s_pembayaran_transaksi.nama_cabang'                 => 'nama_cabang',
		'o_s_pembayaran_transaksi.nama_pasien'                 => 'nama_pasien',
		'o_s_pembayaran_transaksi.`status`'                 => '`status`',
	);
	...
	{
		$this->db->where('o_s_pembayaran_transaksi_id', $id);

		return $this->db->delete($this->_table);
	}

	public function get_data_os($pasien_id)
	{
		$format = "SELECT
						*
					FROM
						`o_s_pembayaran_transaksi`
					WHERE
						o_s_pembayaran_transaksi.pasien_id = $pasien_id
					AND o_s_pembayaran_transaksi.`status` != 1
					ORDER BY
						o_s_pembayaran_transaksi.tanggal ASC";
