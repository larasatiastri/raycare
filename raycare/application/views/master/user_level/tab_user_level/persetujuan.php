...
$attrs_user_level_email = array (
    'id'          => 'user_level_email{0}',
    'name'        => 'user_level[{0}][email]',
    'type'        => 'text',
    'class'       => 'form-control',
);
...
{
    // die_dump($form_data_persetujuan);
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			<?=translate("Permintaan Barang", $this->session->userdata("language"))?>
		</div>
		<div class="actions">
            <a data-toggle="modal" data-target="#modal_user_level" title="<?=translate('Tambah', $this->session->userdata('language'))?>" href="<?=base_url()?>master/user_level/search_user_level" class="btn btn-circle btn-icon-only btn-default">
                <i class="fa fa-plus"></i>
            </a>
             <a class="btn btn-circle btn-icon-only btn-default hidden" id="addRow">
                <i class="fa fa-plus"></i>
            </a>
        </div>
	</div>
	<div class="portlet-body">
        <input type="hidden" id="numRow" value="<?=count($records);?>">
...
<div class="modal fade" id="modal_user_level" role="basic" aria-hidden="true">
