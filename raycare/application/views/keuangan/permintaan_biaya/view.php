...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("View Permintaan Dana", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">    
				...
				<div class="form-body">
	                ...
	                <div class="portlet-body">
						<div class="form-group">
							...
							<div class="col-md-12">
								<label class="control-label"><b><?=formatrupiah($form_data['nominal_setujui'])?></b></label>
							</div>
						</div>
	                </div>
	                <div class="portlet-body">
						<div class="form-group">
							...
							<div class="col-md-12">
								<label class="control-label"><b><?='#'.terbilang($form_data['nominal_setujui']).' Rupiah#'?></b></label>
							</div>
						</div>
	                </div>
