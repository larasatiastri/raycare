	...
	<div class="portlet-title">
		...
		<div class="actions">
			...
			<?php
        		...
        		$data = '<a class="btn btn-circle btn-default" data-backdrop="static" data-keyboard="false" data-target="#modal_item_diluar" data-toggle="modal" href="'.base_url().'klinik_hd/edit_transaksi/modal_item_diluar_paket/'.$form_tindakan['id'].'"><i class="fa fa-plus"></i> '.translate("Gunakan Item Diluar Paket", $this->session->userdata("language")).'</a>';
        		echo restriction_button($data, $user_level_id, 'klinik_hd_edit_transaksi', 'gunakan_item_diluar');
            ?>
			...
			<table class="table table-striped table-hover table-bordered" id="table_item_telah_digunakan">
				<thead>
					<tr>
						...
						<th class="text-center" ><?=translate('Diberikan Oleh', $this->session->userdata('language'))?></th>
