<?php
    ...
    $user_setuju_id = $form_data_persetujuan['disetujui_oleh'];
    $user_setuju = $this->user_m->get($user_setuju_id);

    $tgl_setuju = date('d M Y', strtotime($form_data_persetujuan['tanggal_persetujuan']));
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("View Persetujuan Pembayaran Kasbon History", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">    
	...
	<?php
	if($form_data_persetujuan['status'] == 4){
		?>
	<div class="note note-danger note-bordered">
		<p>
			 NOTE: <?=$form_data_persetujuan['keterangan'].'. Created By: '.$user_setuju->nama.', Created Date: '.$tgl_setuju?>
		</p>
	</div>
	<?php
	}
