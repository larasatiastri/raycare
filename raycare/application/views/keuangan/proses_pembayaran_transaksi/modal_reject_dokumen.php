    <form action="<?=base_url()?>keuangan/proses_pembayaran_transaksi/tolak_proforma_invoice" method="post" id="form_reject" class="form-horizontal">
        
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title font-blue-sharp bold uppercase"><?=translate("Tolak Proforma Invoice", $this->session->userdata("language"))?></h4>
                </div>
                ...
                <?php
                    $confirm_save       = translate('Anda yakin akan menolak proforma invoice PO ini ?',$this->session->userdata('language'));
