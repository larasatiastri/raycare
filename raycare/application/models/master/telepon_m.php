...
class Telepon_m extends MY_Model {
	...
	{
		$format_data = "SELECT id as id, subjek_id as subjek_id, nomor as nomor, is_primary as is_prim
						FROM  cabang_telepon
						WHERE is_active = 1 AND cabang_id = $id";

		return $this->db->query($format_data);
	}
