<?php
			$form_attr = array(
			    "id"            => "form_add_kategori_biaya", 
			    "name"          => "form_add_kategori_biaya", 
			    "autocomplete"  => "off", 
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("kategori biaya", $this->session->userdata("language"))?></span>
		</div>
	</div>
	...
	<div class="portlet-body form">
						...
						<div class="col-md-2">
							<?php
								$sub_option = array('' => translate("Pilih", $this->session->userdata('language')).'..',
													'1' => translate("Kasbon", $this->session->userdata('language')),
													'2' => translate("Biasa", $this->session->userdata('language'))
													);
		...
		<?php $msg = translate("Apakah anda yakin akan menyimpan data kategori biaya  ini?",$this->session->userdata("language"));?>
