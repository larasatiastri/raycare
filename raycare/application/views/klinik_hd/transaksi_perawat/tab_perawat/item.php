			...
			<table class="table table-striped table-hover table-bordered" id="table_item_telah_digunakan">
				<thead>
					<tr>
						...
						<th class="text-center" width="35%"><?=translate('Batch Number', $this->session->userdata('language'))?></th>
						<th class="text-center" width="35%"><?=translate('Expire Date', $this->session->userdata('language'))?></th>
