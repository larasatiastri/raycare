...
class Permintaan_biaya_m extends MY_Model {
	...
	{	
		...
		$this->db->or_where($this->_table.'.status', 11);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 12);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 13);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 15);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 16);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 18);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->datatable_prepare_or($params);
		$this->db->or_where($this->_table.'.status', 19);
		$this->db->where($this->_table.'.tipe', 1);
		$this->db->where($this->_table.'.is_active', 1);
		$this->db->where($this->_table.'.nominal_setujui < ', 1000000);
		$this->datatable_prepare_or($params);
