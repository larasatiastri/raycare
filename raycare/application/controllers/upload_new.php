...
class Upload_new extends CI_Controller {
	...
	public function upload_photo()
	{
		...
		if(isset($_FILES['upl']) && $_FILES['upl']['error'] == 0){
			...
			$targetPath = $_SERVER['DOCUMENT_ROOT'] .config_item('site_img_temp_dir_new');
			$targetThumbnail = $_SERVER['DOCUMENT_ROOT'] .config_item('site_img_temp_thumb_dir_new');
			$targetThumbnail2 = $_SERVER['DOCUMENT_ROOT'] .config_item('site_img_temp_thumb_small_dir_new');
			$targetThumbnail3 = $_SERVER['DOCUMENT_ROOT'] .config_item('site_img_temp_thumb_fix_dir_new');
