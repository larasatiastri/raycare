...
mb.app.resep_obat.proses_view = mb.app.resep_obat.proses_view || {};
            ...
            var 
                ...
                if(found == false)
                {
                    if ($itemKode.val() == "") {
                        ...
                        $btnIdentitas.attr('href', baseAppUrl + 'modal_identitas/' + $(this).data('item').id + '/' + rowId);
                        addItemRow();
...
}(mb.app.resep_obat.proses_view));


// initialize  mb.app.resep_obat.proses_view
$(function(){
    mb.app.resep_obat.proses_view.init();
});