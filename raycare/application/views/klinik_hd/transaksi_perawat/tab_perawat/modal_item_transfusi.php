<div class="modal-header">
    ...
    <h4 class="modal-title">
        <span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Tambah Item Tindakan Transfusi", $this->session->userdata("language"))?></span>
    </h4>
</div>
<div class="modal-body">
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input class="form-control hidden" id="tindakan_transfusi_id" name="tindakan_transfusi_id" value="<?=$tindakan_transfusi_id?>">
...
<script type="text/javascript">
    ...
    function handleBtnSave()
    {
        $('a.modal_ok').click(function()
        {
            ...
            $.ajax ({ 
                type: "POST",
                url: baseAppUrl + "save_item_transfusi",  
