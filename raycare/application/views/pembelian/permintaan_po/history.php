<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("History Permintaan Barang", $this->session->userdata("language"))?></span>
		</div>
		<?php
	...
	<div class="portlet-body">
		<table class="table table-striped table-hover" id="table_permintaan_pembelian_proses">
			<thead>
				<tr>
