...
<div class="modal-body">
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <input class="form-control hidden" id="gudang_id" name="gudang_id" value="<?=$gudang_id?>">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input class="form-control" id="bn_sn_lot" name="bn_sn_lot" readonly>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-4"><?=translate('Expire Date', $this->session->userdata('language'))?> :</label>
        <div class="col-md-4">
            <input class="form-control" id="expire_date" name="expire_date" readonly>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-4"><?=translate('Jumlah', $this->session->userdata('language'))?> :</label>
        <div class="col-md-4" id="input_jumlah">
            <div class="input-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-md-4">
            <input class="form-control" id="id_resep_detail" name="id_resep_detail" value="" readonly>
        </div>
    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="table_item_search">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th><div class="text-center"><?=translate('Batch Number', $this->session->userdata('language'))?></div></th>
                                <th><div class="text-center"><?=translate('Expire Date', $this->session->userdata('language'))?></div></th>
...
<script type="text/javascript">
    ...
    function handleItemSearch(){
        ...
        oTableItemSearch = $("#table_item_search").dataTable(
        {
            ...
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_item_diluar_paket/'+$('input#gudang_id').val()+'/0',
                'type' : 'POST',
            },          
            'pageLength'            : 10,
    ...
    var handleItemSearchSelect = function($btn)
    {
        $btn.on('click', function(e){
            ...
            $('div#input_jumlah').html('<div class="input-group"> <input type="number" class="form-control" id="jumlah_inventory" name="jumlah_inventory" value="1" min="1" max="'+$(this).data('item').jumlah+'"> <span class="input-group-addon" id="label_satuan"> <i> '+$(this).data('item').satuan+' </i> </span> </div>');
