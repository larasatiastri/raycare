...
class Permintaan_biaya extends MY_Controller {

    // protected $menu_parent_id = 2;           // deprecated, pake $menu_tree
    protected $menu_id = '9340801602204f0f1c82796f13f6b4a0';                  // untuk check bit_access
    // protected $menu_id = 'keuangan/permintaan_biaya';                  // untuk check bit_access
    ...
    {
        $assets = array();
        $config = 'assets/keuangan/permintaan_biaya/index';
        ...
        $data = array(
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'keuangan/permintaan_biaya/index',
    ...
    {
        $assets = array();
        $config = 'assets/keuangan/permintaan_biaya/history';
        $this->config->load($config, true);
        $assets = $this->config->item('assets', $config);
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'],
            'js_files'       => $assets['js'],
            'content_view'   => 'keuangan/permintaan_biaya/history',
            );
    ...
    {       
        ...
        $result = $this->pembayaran_status_m->get_datatable_biaya();
        // die_dump($result);
    ...
    {
        $assets = array();
        $assets_config = 'assets/keuangan/permintaan_biaya/add';
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'],
            'js_files'       => $assets['js'],
            'content_view'   => 'keuangan/permintaan_biaya/add',
            'flag'           => 'add',
            'pk_value'       => '',
    ...
    public function save()
    {
       ...
       // die(dump($array_input));
                    ...
                    foreach ($bon as $row_bon) {
                        if($row_bon['url'] != ''){
                            ...
                            $data = array(
                                'nomor_permintaan' => $no_permintaan,
                                'diminta_oleh_id'  => $array_input['id_ref_pasien'],
                                'tanggal'          => date('Y-m-d', strtotime($row_bon['tanggal'])),
                                'nominal'          => $row_bon['nominal_bon'],
                                'nominal_setujui'  => $row_bon['nominal_bon'],
                                'keperluan'        => $row_bon['keterangan'],
                                'tipe'             => $array_input['tipe'],
                                'status'           => 1,
                                'status_revisi'    => 0,
                                'status_proses'    => 0,
                            ...
                            $data_detail = array(
                                ...
                                'isian_1'          => $row_bon['isian_1'],
                                'isian_2'          => $row_bon['isian_2'],
                                'keterangan'          => $row_bon['keterangan'],
                ...
                if($array_input['tipe'] == 2){
                    ...
                    foreach ($bon as $row_bon) {
                        if($row_bon['url'] != ''){
                            ...
                            $user_level_posisi = $this->user_level_m->get(5);
        ...
        if($command === 'revisi')
        {
            ...
            $user_level_kasir = $this->user_level_m->get(5);
