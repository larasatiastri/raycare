...
class Pembelian extends MY_Controller {
    ...
    protected $menu_id = 'bdc531bdfcd00841057256327d6d197d';                  // untuk check bit_access
    ...
    {
        $assets = array();
        $config = 'assets/pembelian/pembelian/index';
        ...
        $data = array(
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'pembelian/pembelian/index',
    ...
    {
        $assets = array();
        $config = 'assets/pembelian/pembelian/history';
        $this->config->load($config, true);
        $assets = $this->config->item('assets', $config);
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'],
            'js_files'       => $assets['js'],
            'content_view'   => 'pembelian/pembelian/history',
            );
    ...
    public function modal_jumlah_terima($detail_id, $item_id, $item_satuan_id)
    {
        ...
        $this->load->view('gudang/barang_datang/modal/modal_jumlah_terima_po.php', $data);
    ...
    {
        $assets = array();
        $assets_config = 'assets/pembelian/pembelian/add';
        ...
        $data = array(
            ...
            'content_view'   => 'pembelian/pembelian/add',
        );
    ...
    public function edit_draft_po($id, $id_sup)
    {
        ...
        $assets = array();
        $config = 'assets/pembelian/pembelian/edit';
        $this->config->load($config, true);
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'], 
            'js_files'       => $assets['js'],
            'content_view'   => 'pembelian/pembelian/edit_draft_po',
    ...
    public function edit_pembelian($id)
    {
        ...
        $data = array(
            ...
            'css_files'           => $assets['css'], 
            'js_files'            => $assets['js'],
            'content_view'        => 'pembelian/pembelian/edit_pembelian',
            'form_data'           => object_to_array($form_data),
    ...
    public function edit_pembelian_tolak($id)
    {
        ...
        $data = array(
            ...
            'css_files'           => $assets['css'], 
            'js_files'            => $assets['js'],
            'content_view'        => 'pembelian/pembelian/edit_pembelian_tolak',
            'form_data'           => object_to_array($form_data),
            'supplier_tipe_bayar' => $supplier_tipe_bayar,
            'form_data_detail'    => (count($form_data_detail) != 0)?object_to_array($form_data_detail):'',
            'pk_value'            => $id                         //table primary key value
    ...
    public function view_proses($id)
    {
        ...
        $assets = array();
        $config = 'assets/pembelian/pembelian/view_proses';
        $this->config->load($config, true);
        ...
        $data = array(
            ...
            'css_files'           => $assets['css'],
            'js_files'            => $assets['js'],
            'content_view'        => 'pembelian/pembelian/view_proses',
            'form_data'           => object_to_array($form_data),
            'supplier_tipe_bayar' => $supplier_tipe_bayar,
            'tipe_bayar'          => $tipe_bayar,
            'form_data_detail'    => (count($form_data_detail) != 0)?object_to_array($form_data_detail):'',
    ...
    {        
        $result = $this->pembelian_m->get_datatable($tipe, $stat, 3);
        // die_dump($result);
        $output = array(
    ...
    // die_dump($records);
        ...
        foreach($records->result_array() as $row)
        {
            ...
            if($row['status'] == 1)
            {
                $action = '<a title="'.translate('View', $this->session->userdata('language')).'" class="btn grey-cascade" href="'.base_url().'pembelian/pembelian/view/'.$row['id'].'"><i class="fa fa-search"></i></a>
                <a title="'.translate('Edit', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/edit_pembelian/'.$row['id'].'" class="btn blue-chambray"><i class="fa fa-edit"></i></a>
            ...
            {
                $action = '<a title="'.translate('Verifikasi Pembelian', $this->session->userdata('language')).'" class="btn btn-primary" href="'.base_url().'pembelian/pembelian/proses_setuju/'.$row['id'].'"><i class="fa fa-check"></i></a>';
            ...
            {
                $action = '<a title="'.translate('View', $this->session->userdata('language')).'" class="btn grey-cascade" href="'.base_url().'pembelian/pembelian/view/'.$row['id'].'"><i class="fa fa-search"></i></a>
                <a title="'.translate('Cancel PO', $this->session->userdata('language')).'" data-target="#modal_cancel_po" data-toggle="modal" href="'.base_url().'pembelian/pembelian/batalkan_po/'.$row['id'].'" class="btn red cancel"><i class="fa fa-undo"></i></a>';
            ...
            $output['data'][] = array(
                ...
                $row['keterangan'],
                $status,
                '<div class="text-left inline-button-table">'.$posisi[0]['nama'].'</div>',
    ...
    {      
        $result = $this->pembelian_m->get_datatable_proses($tipe, 3);
        // die_dump($result);
        $output = array(
            'draw'                 => intval($this->input->post('draw', true)),
            'iTotalRecords'        => $result->total_records,
        ...
        foreach($records->result_array() as $row)
        {
            ...
            if($row['nama_sup'] != null && $row['kode_sup'] != null && $row['tanggal_pesan'] != null && $row['tanggal_kadaluarsa'] != null)
            {
                ...
                $action = '<a title="'.translate('Send PO', $this->session->userdata('language')).'" data-target="#modal_send_po" data-toggle="modal" href="'.base_url().'pembelian/pembelian/send_po/'.$row['id'].'" class="btn btn-success"><i class="fa fa-send"></i></a>
                 <a title="'.translate('View', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/view_proses/'.$row['id'].'" class="btn grey-cascade"><i class="fa fa-search"></i></a>';
                if($row['is_kirim'] == 1){
                     $action .= '<a title="'.translate('Finish PO', $this->session->userdata('language')).'" data-target="#modal_finish_po" data-toggle="modal" href="'.base_url().'pembelian/pembelian/selesaikan_po/'.$row['id'].'" class="btn btn-primary perpanjang"><i class="fa fa-check"></i></a> ';
                }if($row['is_kirim'] == 0){
                     $action .= '<a title="'.translate('Buat PO Pengganti', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/add_pengganti/'.$row['id'].'" class="btn btn-primary"><i class="fa fa-file"></i></a><a title="'.translate('Cancel PO', $this->session->userdata('language')).'" data-target="#modal_cancel_po" data-toggle="modal" href="'.base_url().'pembelian/pembelian/batalkan_po/'.$row['id'].'" class="btn red cancel"><i class="fa fa-undo"></i></a>';
                }



                 $action .= '<a title="'.translate('Print', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/cetak_po/'.$row['id'].'" target="_blank" class="btn default"><i class="fa fa-print"></i></a>';
    ...
    {      
        $result = $this->pembelian_m->get_datatable_history($tipe, 3);
        // die_dump($result);
        $output = array(
            'draw'                 => intval($this->input->post('draw', true)),
            'iTotalRecords'        => $result->total_records,
        ...
        foreach($records->result_array() as $row)
        {
            ...
            if($row['nama_sup'] != null && $row['kode_sup'] != null && $row['tanggal_pesan'] != null && $row['tanggal_kadaluarsa'] != null)
            {
                ...
                $tgl_kadaluarsa = date('d M Y', strtotime($row['tanggal_kadaluarsa']));
                 ...
                 $action = '<a title="'.translate('View', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/view_proses/'.$row['id'].'" class="btn grey-cascade"><i class="fa fa-search"></i></a>
                 <a title="'.translate('Send PO', $this->session->userdata('language')).'" data-target="#modal_send_po" data-toggle="modal" href="'.base_url().'pembelian/pembelian/send_po/'.$row['id'].'" class="btn btn-success"><i class="fa fa-send"></i></a>';
            }
    ...
    public function listing_draft($tipe=null)
    {
        ...
        foreach($records->result_array() as $row)
        {
            ...
            $action = '<a title="'.translate('Edit', $this->session->userdata('language')).'" href="'.base_url().'pembelian/pembelian/edit_draft_po/'.$row['id'].'/'.$row['id_sup'].'" class="btn blue-chambray"><i class="fa fa-edit"></i></a>';
    ...
    public function listing_supplier($tipe=null)
    {
        ...
        $result = $this->supplier_m->get_datatable($tipe, 3);
        // die_dump($this->db->last_query());
    ...
    public function listing_permintaan_terdaftar($item_id=null, $row_id=null, $satuan_id=null)
    {
        ...
        foreach($records->result_array() as $row)
        {
            ...
            if($row['is_active']==1)
            {
                ...
                $satuan_primary = $this->item_satuan_m->get_by(array('item_id' => $row['id'], 'is_primary' => 1),true);
                $action = '<a href="'.base_url().'pembelian/pembelian/data_daftar_link/'.$item_id.'/'.$row['id'].'/'.$row_id.'/'.$satuan_id.'/'.$row['id_detail'].'/'.$row['id'].'/'.$i.'" data-target="#ajax_notes2" data-toggle="modal" data-tipe="1" data-tipe_pembelian="2" title="'.translate('Select', $this->session->userdata('language')).'"  data-item="'.htmlentities(json_encode($row)).'" data-satuan_primary="'.htmlentities(json_encode($satuan_primary)).'" class="btn btn-primary select"><i class="fa fa-check"></i></a>';                
    ...
    public function modal_perpanjang($id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/perpanjang_tanggal.php', $data);
    }
    ...
    public function save()
    {
        ...
        if($command == 'add')
        {
            if($saveDraft == "")
            {
                ...
                $data_user_level_persetujuan = $this->setting_persetujuan_po_m->get_by(array('tipe_po' => 3, 'is_active' => 1));
                ...
                if($tempo->tipe_bayar_id == 1 || $tempo->tipe_bayar_id == 2){
                    ...
                    if(count($user_level_persetujuan) != 0){
                        ...
                        $posisi = 9;
                        $divisi_posisi = $this->user_level_m->get(9);
                    ...
                    for($i=0; $i<3; $i++){
                        ...
                        if($i == 0){
                            $user_level = $this->user_level_m->get(9);
                            ...
                            $user_level = $this->user_level_m->get(19);
                ...
                if($penawaran)
                {
                    foreach ($penawaran as $row) 
                    {
                        if($row['nomor'] != '' || $row['url'] != '')
                        {
                            ...
                            $path_dokumen = '../cloud/'.config_item('site_dir').'pages/pembelian/pembelian/doc/penawaran/'.str_replace(' ', '_', $id_po).'/'.str_replace(' ', '_', $id_po_penawaran);
                ...
                sent_notification_po(3,$nama_supplier, 1);
                ...
                if($penawaran)
                {
                    foreach ($penawaran as $row) 
                    {
                        if($row['id'] == '' && ($row['nomor'] != '' || $row['url'] != ''))
                        {
                            ...
                            $path_dokumen = '../cloud/'.config_item('site_dir').'pages/pembelian/pembelian/doc/penawaran/'.str_replace(' ', '_', $pembelian_id).'/'.str_replace(' ', '_', $id_po_penawaran);
                            if (!is_dir($path_dokumen)){mkdir($path_dokumen, 0777, TRUE);}
                        ...
                        elseif($row['id'] != '')
                        {
                            ...
                            {
                                $path_dokumen = '../cloud/'.config_item('site_dir').'pages/pembelian/pembelian/doc/penawaran/'.str_replace(' ', '_', $pembelian_id).'/'.str_replace(' ', '_', $row['id']);
                                if (!is_dir($path_dokumen)){mkdir($path_dokumen, 0777, TRUE);}
    ...
    public function proses_setuju($id)
    {
        ...
        $data = array(
            ...
            'css_files'           => $assets['css'],
            'js_files'            => $assets['js'],
            'content_view'        => 'pembelian/pembelian/proses_setuju',
            'form_data'           => object_to_array($form_data),
            'supplier_tipe_bayar' => $supplier_tipe_bayar,
            'tipe_bayar'          => $tipe_bayar,
            'form_data_detail'    => (count($form_data_detail) != 0)?object_to_array($form_data_detail):'',
   ...
   public function cetak_po($id)
   {
        ...
        $path_dokumen = '../cloud/'.config_item('site_dir').'pages/pembelian/pembelian/doc/PO/'.$pembelian->id;
        if (!is_dir($path_dokumen)){mkdir($path_dokumen, 0777, TRUE);}
    ...
    {
       $this->load->view('pembelian/pembelian/add_biaya');
    }
    ...
    public function edit_biaya($id_po)
    {
        ...
        $this->load->view('pembelian/pembelian/edit_biaya', $data);
    }
    ...
    public function send_po($po_id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/send_po', $data);
    ...
    public function selesaikan_po($po_id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/finish_po', $data);
    ...
    public function batalkan_po($po_id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/cancel_po', $data);
    ...
    public function kirim_email_po()
    {
        if($this->input->is_ajax_request()){
            ...
            $config = array(
              ...
              'mailtype' => 'html', // change it to yours
              'charset' => 'utf-8', // change it to yours
              'mailpath' => '/usr/sbin/sendmail', // change it to yours
              'charset' => 'iso-8859-1', // change it to yours
              'wordwrap' => TRUE, // change it to yours
            );
    ...
    public function add_jumlah($id_row, $item_id, $satuan_id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/add_jumlah', $data);
    }
    ...
    public function edit_jumlah_edit($id_row, $pembelian_detail_id)
    {
        ...
        $this->load->view('pembelian/pembelian/modals/edit_jumlah', $data);
    }

    public function listing_lunas()
    {      
        $result = $this->pembelian_m->get_datatable_lunas(3);
        // die_dump($result);
        $output = array(
            'draw'                 => intval($this->input->post('draw', true)),
            'iTotalRecords'        => $result->total_records,
    ...
    {
        $assets = array();
        $assets_config = 'assets/pembelian/pembelian/add_pengganti';
        $this->config->load($assets_config, true);
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'],
            'js_files'       => $assets['js'],
            'content_view'   => 'pembelian/pembelian/add_pengganti',
            'form_data'           => object_to_array($form_data),
            'supplier_tipe_bayar' => $supplier_tipe_bayar,
            'form_data_detail'    => (count($form_data_detail) != 0)?object_to_array($form_data_detail):'',
            'data_supplier'       => $data_supplier,
