...
class Pembayaran_masuk_status_m extends MY_Model {

	protected $_table        = 'pembayaran_masuk_status';
	...
	protected $datatable_columns = array(
		...
		'pembayaran_masuk_status.id'              => 'id',
		'pembayaran_masuk_status.created_date'    => 'tanggal',
		'user.inisial'                      	  => 'inisial',
		'pembayaran_masuk_status.tipe_transaksi'  => 'tipe_transaksi',
		'pembayaran_masuk_status.transaksi_nomor' => 'transaksi_nomor',
		'pembayaran_masuk_status.nominal'         => 'nominal',
		'pembayaran_masuk_status.status'          => 'status',
		'b.nama'                            	  => 'nama_level_proses',
		'pembayaran_masuk_status.waktu_akhir'     => 'waktu_akhir',
		'user.nama'                         	  => 'nama',
		'da.kode'                           	  => 'kode_divisi_buat',
		'pembayaran_masuk_status.transaksi_id'    => 'transaksi_id',
		'pembayaran_masuk_status.status_revisi'   => 'status_revisi',
		'pembayaran_masuk_status.status_cancel'   => 'status_cancel',
		'pembayaran_masuk_status.status_keuangan' => 'status_keuangan',
		'pembayaran_masuk_status.user_level_id'   => 'user_level_id',
		'pembayaran_masuk_status.divisi'          => 'divisi',
		'pembayaran_masuk_status.divisi'          => 'divisi',
	...
	{	
		...
		$params['sort_by']="pembayaran_masuk_status.created_date";
	...
	{	
		...
		// get params dari input postnya datatable
		$params = $this->datatable_param($this->datatable_columns);
		$params['sort_by']="pembayaran_masuk_status.id";
		$params['sort_dir']="desc";
	...
	{
		$format = "SELECT MAX(RIGHT(`id`,4)) AS max_id FROM `pembayaran_masuk_status` WHERE SUBSTR(`id`,5,7) = DATE_FORMAT(NOW(), '%m-%Y');";	
		return $this->db->query($format);
	}

}

/* End of file Pembayaran_masuk_status.php */
/* Location: ./application/models/keuangan/Pembayaran_masuk_status.php */