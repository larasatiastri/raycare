...
<form action="#" method="post" id="form_identitas" class="form-horizontal">
    ...
    <script type="text/javascript">
        ...
        function modalOK()
        {
            ...
            // alert(row_id);
            $('input[name$="[jumlah_pesan]"]', $row).val(total_jumlah);
            $('label[name$="[jumlah_pesan]"]', $row).text(total_jumlah);
            $('input[name$="[jumlah_pesan]"]', $row).attr('value', total_jumlah);
            ...
            var jumlah = parseInt($('input[name$="[jumlah_pesan]"]', $row).val()),
