<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase"><?=translate("History Transfer Item", $this->session->userdata("language"))?></span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body">
        <table class="table table-striped table-bordered table-hover" id="table_history_transfer_item">
            <thead>
                <tr>
