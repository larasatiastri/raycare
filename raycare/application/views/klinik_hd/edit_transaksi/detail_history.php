		...
		?>
			...
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions">
						<a class="btn btn-circle btn-default" href="<?=base_url()?>klinik_hd/edit_transaksi">
						...
						<?php
							...
							if (!empty($data_pasien_prev)) {
								$disable_prev = "";
								$url_prev = base_url().'klinik_hd/edit_transaksi/detail_history/'.$data_pasien_prev[0]['id'].'/'.$pasien_id;
							}
							...
							if (!empty($data_pasien_next)) {
								$disable_next = "";
								$url_next = base_url().'klinik_hd/edit_transaksi/detail_history/'.$data_pasien_next[0]['id'].'/'.$pasien_id;
							}
						?>
					...
					<div class="form-body">
					    ...
					    <div class="row">
					    	<div class="col-md-6">
								...
								<div class="form-group">
									<label class="control-label col-md-6"><?=translate("Tanggal", $this->session->userdata("language"))?> :</label>
