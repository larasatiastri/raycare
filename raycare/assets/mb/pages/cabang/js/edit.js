...
(function(o){
    ...
    var 
        ...
        $btnDeletePoliDB       = $('.del-poli-db', $tablePoliklinikDokter);
        tplItemRow             = $.validator.format( $('#tpl_item_row').text() ),
        itemCounter            = $('input#tbl_counter').val(),
        ...
        phoneCounter     = $('input#i_phone').val();
    ...
    var initForm = function()
    {
        $.each(forms2, function(idx, form){
            ...
            $('a.del-db', form.section).on('click', function(){
                ...
                handleDeleteDbPhone(form, id);
            });

            $('a.edit', form.section).on('click', function(){
            var id = $(this).data('id');
            //alert('tes');
            handleEditSubjekTelp(id);
            });
        ...
        $.each($btnDeletePoliDB, function(idx, btn){
            handleBtnDeletePoliDB( $(btn) );
        });
    ...
    var addFieldset = function(form)
    {
        ...
        $('select[name$="[subjek]"]', $newFieldset).select2();
    ...
    var handleEditSubjekTelp = function(counter){
            var $inputSubjekTelp = $('input#subjek_telepon_' + counter),
            ...
            $groupRemoveSubjekTelp = $('div#group_remove_'+counter),
            $groupEditSubjekTelp = $('div#group_edit_'+counter);

        $groupEditSubjekTelp.addClass('hidden');
        $btnEditSubjekTelp.addClass("hidden");
        $btnDeleteSubjekTelp.addClass("hidden");
        $selectSubjekTelp.addClass("hidden");

        $groupRemoveSubjekTelp.removeClass("hidden");
        ...
        $btnSaveSubjekTelp.on('click', function(e){
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $.each(results.data, function(key, value) {
                        ...
                        $selectSubjekTelp.val(results.id);
                }
            });   
        }    
    }
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $.each(results.data, function(key, value) {
                        ...
                        $selectSubjekAlamat.val(results.id);
                }
            });   
        }    
    }
    ...
    var handleEditKelurahan = function(){
        var $inputKelurahan = $('input#input_kelurahan'),
            $selectKelurahan = $('select#kelurahan_desa'),
    ...
    var handleBtnDeletePoliDB = function($btn){
        var 
   ...
   var isValidLastRow = function(){
    ...
    var handleDeleteDbPhone = function(form, id){
        //alert(id);
        bootbox.confirm("Are you sure to delete this phone?", function(result) {
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $provinsi_select.append($("<option></option>")
                            .attr("value", '').text('Pilih Provinsi..'));
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $kota_select.append($("<option></option>")
                            .attr("value", '').text('Pilih Kota..'));

                    $.each(results, function(key, value) {
                        // alert(value.format_kota);
                        $kota_select.append($("<option></option>")
                            .attr("value", value.id).text(value.format_kota));
                        $kota_select.val('');
                    });

                    // $kota_select.select2('destroy');
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $kecamatan_select.append($("<option></option>")
                            .attr("value", '').text('Pilih Kecamatan..'));
            ...
            $.ajax({
                ...
                success  : function( results ) {
                    ...
                    $kelurahan_select.append($("<option></option>")
                            .attr("value", '').text('Pilih Kelurahan..'));
