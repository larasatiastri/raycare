...
mb.app.pasien.edit = mb.app.pasien.edit || {};
(function(o){

    var 
        baseAppUrl               = '',
        $form                    = $('#form_edit_pasien'),
        $tablePelengkap          = $('#table_pelengkap', $form),
        $tableRekamMedis         = $('#table_rekam_medis', $form),
        $tableDokumen            = $('#table_dokumen_pasien', $form),
        $counter                 = $('#counter'),
        $popoverPasienContent    = $('#popover_pasien_content'), 
        $lastPopoverItem         = null,
        $tablePilihPasien        = $('#table_pilih_pasien'),
        tplFormPhone             = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-phone', $form).val() + '</li>',
        tplFormAlamat            = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-alamat', $form).val() + '</li>',
        tplFormHubunganPasien    = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-hubungan-pasien', $form).val() + '<hr></li>',
        tplFormPenanggungJawab   = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-penanggung-jawab', $form).val() + '</li>',
        tplFormHPAlamat          = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-hp-alamat', $form).val() + '<hr></li>',
        tplFormHPPhone           = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-hp-phone', $form).val() + '<hr></li>',
        tplFormPJAlamat          = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-pj-alamat', $form).val() + '<hr></li>',
        tplFormPJPhone           = '<li class="fieldset" style="margin-top:10px;">' + $('#tpl-form-pj-phone', $form).val() + '<hr></li>',
        ...
        hubunganPasienCounter    = $('input#counterHP').val(),
        ...
        pelengkapCounter         = $('tbody tr', $tablePelengkap).length,
        rekamMedisCounter        = $('tbody tr', $tableRekamMedis).length,
        formsPhone = {
                    'phone' : 
                    {            
    ...
    var initForm = function(){
        ...
        $.each(formsPhone, function(idx, form){
            ...
            $('a.edit', form.section).on('click', function(){
                var id = $(this).data('id');
                //alert(counter);
                var counterHP = null;
        ...
        $.each($('.add-hp-alamat'), function(idx){
            // alert($(this).data('row'));
            var hpId = $(this).data('row');
            var hpAlamatCounter = $(this).data('counter');

            formsHPAlamat = {
                'hp_alamat' : 
                {            
                    section  : $('#section-hp-alamat', $('div#hubungan_pasien_'+hpId)),
            ...
            var counterHPAlamat = 1;
            $.each(formsHPAlamat, function(idx, form){
                // handle button add
                $('a.add-hp-alamat', form.section).on('click', function(){
                    addFieldsetHPAlamat(form, hpId);
                    // alert('a');
                });

                $('a.del-db-hp-alamat', form.section).on('click', function(){
                    var id = $(this).data('id');
                    var msg = $(this).data('confirm');

                    handleDeleteDbHPAlamat(form, id, msg, hpId);
                });
                
                $('a.edit-subjek', form.section).on('click', function(){
                    var id = $(this).data('id');
                    
                    handleEditSubjekAlamat(hpId, id, "tab_hubungan_pasien");
                });
                ...
                $('a.edit-negara', form.section).on('click', function(){
                    ...
                    handleEditNegara(hpId, id, "tab_hubungan_pasien");
                });

                $('a.edit-provinsi', form.section).on('click', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleEditProvinsi(hpId, id, "tab_hubungan_pasien");
                });

                $('a.edit-kota', form.section).on('click', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleEditKota(hpId, id, "tab_hubungan_pasien");
                });

                $('a.edit-kecamatan', form.section).on('click', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleEditKecamatan(hpId, id, "tab_hubungan_pasien");
                });

                $('a.edit-kelurahan', form.section).on('click', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleEditKelurahan(hpId, id, "tab_hubungan_pasien");
                });

                $('select.hp_negara', form.section).on('change', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleSelectProvinsi(hpId, id, "tab_hubungan_pasien");
                });

                $('select.hp_provinsi', form.section).on('change', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleSelectKota(hpId, id, "tab_hubungan_pasien");
                });

                $('select.hp_kota', form.section).on('change', function(){
                    var id = $(this).data('id');
                    //alert(counter);
                    handleSelectKecamatan(hpId, id, "tab_hubungan_pasien");
                });

                $('select.hp_kecamatan', form.section).on('change', function(){
                    var id = $(this).data('id');
                    var hpId = null;
                    //alert(counter);
                    handleSelectKelurahan(hpId, id, "tab_hubungan_pasien");
                });

                    // beri satu fieldset kosong
                    // addFieldsetHPAlamat(form, '1');
                    //addFieldsetAlamat(form);
                    counterHPAlamat++; 
                });
        });

        $.each($('.add-hp-phone'), function(idx){
            // alert($(this).data('row'));
            var hpId = $(this).data('row');
            var hpPhoneCounter = $(this).data('counter');


            formsHPPhone = {
                'hp_phone' : 
                {            
                    section  : $('#section-hp-phone', $('div#hubungan_pasien_'+hpId)),
            ...
            $.each(formsHPPhone, function(idx, form){
                ...
                $('a.add-hp-phone', form.section).on('click', function(){
                    addFieldsetHPPhone(form, hpId);
                });
                 

                $('a.del-db-hp-telp', form.section).on('click', function(){
                    var id = $(this).data('id');
                    var msg = $(this).data('confirm');

                    handleDeleteDbHPTelepon(form, id, msg, hpId);
                });

                $('a.edit-subjek-telp', form.section).on('click', function(){
                    var id = $(this).data('id');
                    
                    handleEditSubjekTelp(hpId, id, "tab_hubungan_pasien");
                });
        ...
        $.each($('.scan-ktp'), function(idx){
            // alert($(this).data('id'));
            var id = $(this).data('id');
            handleUploadifyHP(id);
        });
        ...
        $.each(formsHubunganPasien, function(idx, form){
            ...
            $('a.del-db-hub-pasien', form.section).on('click', function(){
                var id = $(this).data('id');
                var msg = $(this).data('confirm');

                handleDeleteDbHubunganPasien(form, id, msg);
            });
           ...
           $('a.set_penanggung_jawab').on('click', function(){
        ...
        // $.each($('.subjek_alamat'), function(idx, value){
        ...
        $btnDeleteDB = $('a.del-item-db', $tablePelengkap);

        $.each($btnDeleteDB, function(idx, btn){
        ...
        $btnDeleteDBRekamMedis = $('a.del-item-db', $tableRekamMedis);

        $.each($btnDeleteDBRekamMedis, function(idx, btn){
            handleBtnDeleteDBRekamMedis( $(btn) );
        });
    ...
    var handleBtnDeleteDBRekamMedis = function($btn){
        var 
            rowId    = $btn.closest('tr').prop('id'),
            $row     = $('#'+rowId, $tableRekamMedis);
    ...
    var addFieldsetAlamat = function(form)
    {
        ...
        $btnSubjekAlamat.on('click', function(){
            handleEditSubjekAlamat(counter, "tab_alamat");
        });

        $btnEditNegara.on('click', function(){
            handleEditNegara(counter, "tab_alamat");
        });

        $btnEditProvinsi.on('click', function(){
            handleEditProvinsi(counter, "tab_alamat");
        });

        $btnEditKota.on('click', function(){
            handleEditKota(counter, "tab_alamat");
        });

        $btnEditKecamatan.on('click', function(){
            handleEditKecamatan(counter, "tab_alamat");
        });

        $btnEditKelurahan.on('click', function(){
            handleEditKelurahan(counter, "tab_alamat");
        });

        // handleSelectNegara(counter);
        handleSelectProvinsi(counter,counter, "tab_alamat");
        handleSelectKota(counter,counter, "tab_alamat");
        handleSelectKecamatan(counter,counter, "tab_alamat");
        handleSelectKelurahan(counter,counter, "tab_alamat");
        $('input[type=radio]', $newFieldset).uniform();
    };
    ...
    var addFieldsetHubunganPasien = function(form)
    {
        ...
        $.each(formsHPAlamat, function(idx, form){
            ...
            // beri satu fieldset kosong
            addFieldsetHPAlamat(form, counter);
            // addFieldsetAlamat(form, counter);
        });
    ...
    var addFieldsetHPAlamat = function(form, counterHP)
    {
        ...
        // $('input#radio_primary_hp_alamat_id_1').prop('checked', true);
        // $('input[name$="[is_primary_hp_alamat]"]').val('');

        // $('input#primary_hp_alamat_id_1').val(1);
        // $('input[name="hp_alamat_is_primary"]', $newFieldset).on('click', function()
        // {
        //     $('input[name$="[is_primary_hp_alamat]"]').val('');
        //     $('input[name$="[is_primary_hp_alamat]"]', $newFieldset).val(1);
        // });
        ...
        $('.hp_alamat_id', $newFieldset).attr('name', counterHP +'_'+ $('.hp_alamat_id', $newFieldset).attr('name'));
        $('.hp_alamat_id', $newFieldset).attr('id', counterHP +'_'+ $('.hp_alamat_id', $newFieldset).attr('id'));

        $('.hp_alamat_is_delete', $newFieldset).attr('name', counterHP +'_'+ $('.hp_alamat_is_delete', $newFieldset).attr('name'));
        $('.hp_alamat_is_delete', $newFieldset).attr('id', counterHP +'_'+ $('.hp_alamat_is_delete', $newFieldset).attr('id'));
        ...
        {
            // alert(counterHP);
            $('.'+counterHP+'_primary_alamat div.radio span').removeClass('checked');
    ...
    var addFieldsetHPPhone = function(form, counterHP)
    {
        ...
        $('.hp_telp_id', $newFieldset).attr('name', counterHP +'_'+ $('.hp_telp_id', $newFieldset).attr('name'));
        $('.hp_telp_id', $newFieldset).attr('id', counterHP +'_'+ $('.hp_telp_id', $newFieldset).attr('id'));

        $('.hp_telp_is_delete', $newFieldset).attr('name', counterHP +'_'+ $('.hp_telp_is_delete', $newFieldset).attr('name'));
        $('.hp_telp_is_delete', $newFieldset).attr('id', counterHP +'_'+ $('.hp_telp_is_delete', $newFieldset).attr('id'));
        ...
        {
            // alert(counterHP);
            $('.'+counterHP+'_primary_telp div.radio span').removeClass('checked');
            $('input.'+counterHP+'_hp_primary_telp').val('');
    ...
    var handleDeleteDbAlamat = function(form, id, msg){
        ...
        bootbox.confirm(msg, function(result) {
            ...
            if (result==true) {
                $('div#alamat_' + id).addClass('hidden');
                $('input#is_delete_alamat_' + id).val(1);
            }
        });
    }

    var handleDeleteDbHPAlamat = function(form, id, msg, row){
        //alert(id);
        bootbox.confirm(msg, function(result) {
        
            if (result==true) {
                // $('div#'+row+'_hp_alamat_' + id).addClass('hidden');
                $('input#'+row+'_hp_alamat_is_delete_' + id).val(1);
            }
        });
    }

    var handleDeleteDbHPTelepon = function(form, id, msg, row){
        //alert(id);
        bootbox.confirm(msg, function(result) {
        
            if (result==true) {
                // $('div#'+row+'_hp_telp_' + id).addClass('hidden');
                $('input#'+row+'_hp_telp_is_delete_' + id).val(1);
            }
        });
    }

    var handleDeleteDbHubunganPasien = function(form, id, msg){
        //alert(id);
        bootbox.confirm(msg, function(result) {
        
            if (result==true) {
                $('div#hubungan_pasien_' + id).addClass('hidden');
                $('input#hubungan_pasien_is_delete_' + id).val(1);
            }
        });
    }
    ...
    var handleConfirmSave = function(){
                        ...
                        ({
                            ...
                            { 
                                ...
                                if(data.success === true){
                                    mb.showToast('success', data.msg, 'Informasi');
                                }
        ...
        $('a#confirm_save_kelayakan', $form).click(function() {
            if (! $form.valid()) return;
        ...
        $('a#confirm_save_penanggung', $form).click(function() {
            if (! $form.valid()) return;
            ...
            bootbox.confirm(msg, function(result) {
                if (result==true) {
                    ...
                    if(i==1)
                    {
                        ...
                        ({
                            type: 'POST',
                            url: baseAppUrl +  "save_penanggung",  
                            data:  $form.serialize(),  
                            dataType : 'json', 
                            beforeSend : function(){
                                Metronic.blockUI({boxed: true });
        ...
        $('a#confirm_save_penjamin', $form).click(function() {
            if (! $form.valid()) return;
            ...
            bootbox.confirm(msg, function(result) {
                if (result==true) {
                    ...
                    if(i==1)
                    {
                        ...
                        ({
                            type: 'POST',
                            url: baseAppUrl +  "save_penjamin_ajax",  
                            data:  $form.serialize(),  
                            dataType : 'json', 
                            beforeSend : function(){
                                Metronic.blockUI({boxed: true });
        ...
        $('a#confirm_save_info_lain', $form).click(function() {
            if (! $form.valid()) return;
    ...
    var handleSelectKota = function(counterHP, counter, tab){
        ...
        if (tab == "tab_alamat") {
            ...
            //var numRow = itemCounter++;
                var numRow = $counter.val();
                // alert('select#'+counterHP+'_hp_kota_' + counter);
                //$('input#warehouse_id').val($(this).val());
    ...
    var handleDataTableDokumen = function(){
 
        oTableDokumen = $tableDokumen.dataTable({
            'processing'            : true,
            'serverSide'            : true,
            'paginate'            : false,
            'filter'            : false,
            ...
            'language'              : mb.DTLanguage(),
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_upload/' + $("input#pasien_id").val(),
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            'lengthMenu'            : [[10, 25, 50, 100], [10, 25, 50, 100]],
        ...
        $tableDokumen.on('draw.dt', function (){
    ...
    {
        var ul = $('#upload_'+counter+' ul.ul-img');
    ...
    var handleUploadifyPJ = function(counter)
    {
        ...
        $('#penanggung_jawab_scan_ktp_'+counter).fileupload({
            ...
            add: function (e, data) {
                ...
                // tpl.find('div.thumbnail').html('<a href="'+mb.baseDir()+'cloud/temp/'+filename+'" target="_blank"><img src="'+mb.baseDir()+'cloud/temp/'+filename+'" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a>');
    ...
    {        
        ...
        $('ul#ul_penanggung_jawab > li#li_penanggung_jawab input.send-data').attr('name', 'set_penanggung_jawab');
        $('ul#ul_penanggung_jawab > li#li_penanggung_jawab input.send-data').attr('id', 'set_penanggung_jawab');
        ...
        $('ul#ul_penanggung_jawab > li#li_penanggung_jawab a.del-db-hub-pasien').remove();
    ...
    var handleAlamatHPIsPrimary = function(){

        $('input.is_primary_hp_alamat').on('click', function()
        {   
            var id = $(this).data('id');
            ...
            $('input.'+row+'_hp_primary_alamat').val('');
            $('input#'+row+'_primary_hp_alamat_id_' + id).val(1);
        })
    }

    var handleTeleponHPIsPrimary = function(){

        $('input.is_primary_hp_phone').on('click', function()
        {   
            var id = $(this).data('id');
            var row = $(this).data('row');
            ...
            $('input.'+row+'_hp_primary_telp').val('');
            $('input#'+row+'_primary_hp_phone_id_' + id).val(1);
        })
    }
    ...
    o.init = function(){
        ...
        handleValidation();
        handleConfirmSave();
        handleDataTableDokumen();
        handleMultiSelect();
        handleDatePickers();
        handlePilihPasien();
        handleUploadify();  
        handleSelectFaskes();
        handleAlamatHPIsPrimary();
        handleTeleponHPIsPrimary();
