...
class Pengiriman_identitas_m extends MY_Model {
	...
	{
		$format = "SELECT MAX(SUBSTRING(`id`,13,4)) AS max_id FROM `pengiriman_identitas` WHERE SUBSTR(`id`,5,7) = DATE_FORMAT(NOW(), '%m-%Y');";	
	...
	{
		$this->db->where('pengiriman_detail_id', $detail_id);
