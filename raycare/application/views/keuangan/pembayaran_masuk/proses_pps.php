	...
	<div class="col-md-4">
		<div class="portlet light bordered" >
			<div class="portlet-title">
				<div class="caption">
				<i class="icon-plus font-blue-sharp"></i>
					<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Proses Penambahan Saldo", $this->session->userdata("language"))?></span>
				</div>
			</div>
			<div class="portlet-body form">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-12"><?=translate('Tanggal Terima', $this->session->userdata('language'))?> :</label>
					<div class="col-md-12">
						<div class="input-group date">
							<input type="text" class="form-control" id="tanggal_terima" name="tanggal_terima" placeholder="Tanggal" value="<?=date('d M Y')?>"readonly required>
				...
				<div class="form-group">
					<label class="col-md-12"><?=translate('Nomor Rekening Koran', $this->session->userdata('language'))?> :</label>
					<div class="col-md-12">
						<input class="form-control" type="text" id="nomor_rk" name="nomor_rk" placeholder="No. Rekening Koran" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-12"><?=translate('Nomor Voucher', $this->session->userdata('language'))?> :</label>
					<div class="col-md-12">
						<input class="form-control" type="text" id="nomor_voucher" name="nomor_voucher" placeholder="No. Voucher" required>
					</div>
				</div>
			</div>
			<?php
