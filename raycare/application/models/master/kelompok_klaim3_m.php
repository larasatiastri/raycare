...
class Kelompok_klaim3_m extends MY_Model {

	protected $_table        = 'penjamin_kelompok';
	...
	protected $datatable_columns = array(
		...
		'penjamin_kelompok.nama'         => 'nama', 
		'penjamin_kelompok.url'   => 'url', 
		 
		//'tindakan.is_active'     => 'is_active',
		'penjamin_kelompok.id'     => 'id',
		'penjamin_kelompok.penjamin_id'     => 'penjamin_id'
	...
	{	
		...
		$this->db->where('penjamin_id',null);
		$this->db->or_where('penjamin_id', $id); 
