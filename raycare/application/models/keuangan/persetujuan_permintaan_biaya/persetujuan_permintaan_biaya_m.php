...
class Persetujuan_permintaan_biaya_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'persetujuan_permintaan_biaya.persetujuan_permintaan_biaya_id' => 'persetujuan_permintaan_biaya_id', 
		'persetujuan_permintaan_biaya.permintaan_biaya_id'             => 'permintaan_biaya_id',
		'persetujuan_permintaan_biaya.user_level_id'                   => 'user_level_id',
		'persetujuan_permintaan_biaya.`order`'                         => 'order_persetujuan',
		'persetujuan_permintaan_biaya.`status`'                        => 'status_persetujuan',
		'persetujuan_permintaan_biaya.tanggal_baca'                    => 'tanggal_baca',
		'persetujuan_permintaan_biaya.dibaca_oleh'                     => 'dibaca_oleh',
		'persetujuan_permintaan_biaya.tanggal_persetujuan'             => 'tanggal_persetujuan',
		'persetujuan_permintaan_biaya.disetujui_oleh'                  => 'disetujui_oleh',
	...
	{	
		...
		$this->db->where('persetujuan_permintaan_biaya.user_level_id', $user_level_id);
		$this->db->where('persetujuan_permintaan_biaya.is_active', 1);
		$this->db->where('persetujuan_permintaan_biaya.`status` <= 3');
		$this->db->group_by('persetujuan_permintaan_biaya.user_level_id');
		$this->db->group_by('persetujuan_permintaan_biaya.permintaan_biaya_id');
	...
	{
		$this->db->select('persetujuan_permintaan_biaya.*, user_baca.nama as nama_baca, user_setuju.nama as nama_setuju, user_level.nama as nama_level');
