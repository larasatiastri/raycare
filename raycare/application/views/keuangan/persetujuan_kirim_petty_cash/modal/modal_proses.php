    <form action="<?=base_url()?>keuangan/persetujuan_kirim_petty_cash/tolak_permintaan" method="post" id="form_reject" class="form-horizontal">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" id="persetujuan_permintaan_setoran_keuangan_id" name="persetujuan_permintaan_setoran_keuangan_id"  value="<?=$persetujuan_permintaan_setoran_keuangan_id?>" required="required" />
                            <input type="hidden" id="setoran_keuangan_kasir_id" name="setoran_keuangan_kasir_id"  value="<?=$setoran_keuangan_kasir_id?>" required="required" />
