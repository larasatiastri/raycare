...
class Order_permintaan_barang_detail_m extends MY_Model {
	...
	{	
		...
		$join3 = array('item', $this->_table.'.item_id = item.id', 'LEFT');
		$join4 = array('item_satuan a',$this->_table.'.item_satuan_id = a.id', 'LEFT');
		$join5 = array('item_satuan b', 'persetujuan_permintaan_barang.satuan_id = b.id', 'LEFT');
		$join6 = array('supplier', $this->_table.'.supplier_id = supplier.id', 'LEFT');
	...
	public function get_datatable_box_paket($id, $user_level_id)
	{	
		$datatable_columns_view_item = array(
		...
		'order_permintaan_barang_detail.item_satuan_id'  				=> 'item_satuan_id',
		'order_permintaan_barang_detail.jumlah'  						=> 'jumlah',
		'order_permintaan_barang_detail.jumlah_paket'  						=> 'jumlah_pesan',
		...
		$join4 = array('item_satuan a',$this->_table.'.item_satuan_id = a.id', 'LEFT');
		$join5 = array('item_satuan b', 'persetujuan_permintaan_barang.satuan_id = b.id', 'LEFT');
		$join6 = array('box_paket', 'order_permintaan_barang_detail.box_paket_id = box_paket.id', 'INNER');
		$join_tables = array($join1, $join2, $join3, $join4, $join5, $join6);
	...
	public function get_detail_order_box($order_permintaan_barang_id)
	{

		$format ="SELECT * FROM order_permintaan_barang_detail WHERE order_permintaan_barang_id = $order_permintaan_barang_id AND box_paket_id IS NOT NULL";
