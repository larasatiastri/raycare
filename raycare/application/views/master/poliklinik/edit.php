<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			<span class="caption-subject font-green-sharp bold uppercase"><?=translate("Edit Poliklinik", $this->session->userdata("language"))?></span>
		</div>
	</div>
	<div class="portlet-body form">
		<?php
		    ...
		    echo form_open(base_url()."master/poliklinik/save", $form_attr, $hidden);
		...
		?>
			<div class="form-body">
			    ...
			    <input type="hidden" id="jml" name="jml" value="<?=count($form_data2)?>">
