...
(function(o){
    ...
    var 
        baseAppUrl              = '',
        $table1 = $('#table_pembayaran_transaksi_history');
    ...
    var handleDataTable = function() 
    {
    	...
    	oTable = $table1.dataTable({
			...
			'columns'               : [
                { 'name' : 'pembayaran_transaksi.tanggal tanggal', 'visible' : true, 'searchable': false, 'orderable': false },
				{ 'name' : 'pembayaran_transaksi.tanggal tanggal', 'visible' : true, 'searchable': true, 'orderable': false },
