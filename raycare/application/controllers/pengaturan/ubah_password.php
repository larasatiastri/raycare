...
class Ubah_password extends MY_Controller {
    ...
    private $menus = array();    
    private $menu_tree = array(0, 4);       // untuk keperluan item menu dengan class 'open', 'selected'
    ...
    {
    	$assets = array();
        $assets_config = 'assets/pengaturan/ubah_password/index';
        ...
        $data = array(
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'pengaturan/ubah_password/index',
        );
    ...
    public function save()
	{
		...
		if($command == "ubah_password")
		{
            ...
            else
            {
                ...
                redirect('pengaturan/ubah_password');
            }
