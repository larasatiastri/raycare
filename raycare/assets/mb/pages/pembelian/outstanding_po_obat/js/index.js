mb.app.outstanding_po_obat = mb.app.outstanding_po_obat || {};
(function(o){

    var 
         baseAppUrl                      = '',
         $tableOutstandingPO       = $('#table_outstanding_po_obat'),
         $tableOutstandingPOKasbon       = $('table.table_os_kasbon'),
         $tableOutstandingPOHistory       = $('#table_outstanding_po_obat_proses'),
    ...
    var handleDataTablePermintaan = function() 
    {
        ...
        $tableOutstandingPOHistory.dataTable({
            ...
            'language'              : mb.DTLanguage(),
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_history/3',
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            'lengthMenu'            : [[10, 25, 50, 100], [10, 25, 50, 100]],
    ...
    var handleButtonSubmit = function(){
        $('a#confirm_save').click(function(){
            ...
            $.ajax({
                ...
                // alert(idx);
                        var x = window.open( mb.baseUrl() + 'pembelian/pembelian_obat/add/'+idx+'/'+result['item_id_array']+'/'+result['item_satuan_id_array']+'/'+result['jumlah_array'], '_blank');                
                    });
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'pembelian/outstanding_po_obat/';
        handleDataTablePermintaan();   
        handleButtonSubmit(); 

    };
 }(mb.app.outstanding_po_obat));


// initialize  mb.app.home.table
$(function(){
    mb.app.outstanding_po_obat.init();
});