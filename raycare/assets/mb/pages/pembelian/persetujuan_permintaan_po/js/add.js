...
(function(o){
     ...
     var 
       ...
       var initForm = function(){
        ...
        var 
            ...
            $btnInfoBox                = $('.pilih-item-box-disetujui', $tableItemBox),
        ...
        handleBtnSearchItemBox($btnInfoBox);  
        ...
        /////////////////////////////////////popover terdaftar////////////////////////////////////////////////////
            ...
            var $ItemBox = $('.pilih-item-box', $tableItemBox);

            $.each($ItemBox, function(idx, col){
                var
                    $col            = $(col),
    ...
    var handlePilihItem = function(){
       pk_value = $('input#pk_value').val();
       user_level_id = $('input#user_level_id').val();
       order_setuju = $('input#order_setuju').val();
        ...
        oTablePilihItem = $tablePilihItem.dataTable({
            ...
            'pagingType'            : 'full_numbers',
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_pilih_item_user/' + pk_value + '/' + user_level_id + '/' +order_setuju,
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            'lengthMenu'            : [[10, 25, 50, 100], [10, 25, 50, 100]],
    ...
    var handlePilihItemTidakTerdaftar = function(){
       ...
       user_level_id = $('input#user_level_id').val();
        oTablePilihItemTidakTerdaftar = $tablePilihItemTidakTerdaftar.dataTable({
            ...
            'pagingType'            : 'full_numbers',
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_pilih_item_user_tidak_terdaftar/' + pk_value + '/' + user_level_id,
                'type' : 'POST',
            },          
            'info'      : false,
            'paginate'  : false,
       ...
       //  });
            // oTable.api().ajax.url(baseAppUrl + 'listing_alat_obat/' + id).load();
                ...
                $tableItemTerdaftar.on('draw.dt', function (){
                    ...
                    oTablePilihItem.api().ajax.url(baseAppUrl + 'listing_pilih_item_user/' + id + '/' + level_id + '/' + order_permintaan_barang_detail_id+'/'+order_setuju).load();
    ...
    var handleBtnInfoPersetujuan = function()
    {

        $('.pilih-item-terdaftar-user').click(function(){
            // alert('klik');
        var $anchor = $(this),
              id    = $anchor.data('id');
              level_id = $anchor.data('level-id');
    ...
    var handleBtnInfoPersetujuanBox = function()
    {

        $('.pilih-item-box-disetujui').click(function(){
            // alert('klik');
        var $anchor = $(this),
              id    = $anchor.data('id');
              level_id = $anchor.data('level-id');
        ...
        oTablePilihItemBox.api().ajax.url(baseAppUrl + 'listing_pilih_item_user_box/' + id + '/' + level_id + '/' + order_permintaan_barang_detail_id).load();
        // oTablePilihItemTidakTerdaftar.api().ajax.url(baseAppUrl + 'listing_pilih_item_tidak_terdaftar/' + id).load();
    ...
    var handleBtnSearchItemBox = function($btn){
        var rowId  = $btn.closest('tr').prop('id');
        // console.log(rowId);
        ...
        $btn.popover({ 
            ...
            // pindahkan $popoverItemContentBox ke .popover-conter
            $popContainer.find('.popover-content').append($popoverItemContentBox);

        }).on('hide.bs.popover', function(){
            //pindahkan kembali $popoverItemContentBox ke .page-content
            $popoverItemContentBox.hide();
            $popoverItemContentBox.appendTo($('.page-content'));
...
var handleValidation = function() {
    ...
    o.init = function(){
        ...
        handlePilihUser();
        uploadfile();
        handleBtnInfoPersetujuan();
        handleBtnInfoPersetujuanBox();
        handleBtnInfoPersetujuanTidakTerdaftar();
