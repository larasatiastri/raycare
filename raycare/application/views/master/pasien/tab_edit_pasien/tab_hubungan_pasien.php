<div class="portlet light" id="section-hubungan-pasien">
	<div class="portlet-title">
		...
		<div class="actions">
			<a class="btn btn-circle btn-icon-only btn-default add-hubungan-pasien">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						...
						<div class="form-group ">
							...
							<div class="col-md-8 '.$indexHP.'_primary_alamat">
					...
					foreach ($data_hp_telp as $hp_telp) {
						...
						<div class="form-group">
							<label class="control-label col-md-4"></label>
							<div class="col-md-8 '.$indexHP.'_primary_telp"">
					...
					if(file_exists(FCPATH.config_item('site_img_pasien_temp_dir_copy').$form_data['no_member'].'/penanggung/'.$hubungan_pasien['url_ktp']) && is_file(FCPATH.config_item('site_img_pasien_temp_dir_copy').$form_data['no_member'].'/penanggung/'.$hubungan_pasien['url_ktp']))
					{
					...
					<div id="group_nama_'.$indexHP.'" >
						<div class="form-group" >
							...
							<div class="col-md-8 input-group">
								<input type="text" class="form-control send-data" id="hubungan_pasien_nama_'.$indexHP.'" name="hubungan_pasien['.$indexHP.'][nama]" value="'.$hubungan_pasien['nama'].'">
					...
					<div id="group_ktp_'.$indexHP.'">
						<div class="form-group" >
							...
							<div class="col-md-8 input-group">
								<input type="text" class="form-control send-data" id="hubungan_pasien_ktp_'.$indexHP.'" name="hubungan_pasien['.$indexHP.'][ktp]" value="'.$hubungan_pasien['no_ktp'].'">
							</div>
						</div>
					</div>
									...
									<li class="working">
										<div class="thumbnail">
											<a href="'.$image_kerabat.'" target="_blank">
												<img src="'.$image_kerabat.'" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;">
											</a>
										</div>
										<span></span>
									</li>
			                ...
			                <div class="col-md-12">
				                <div class="portlet">
					                <div class="portlet-title">
					                    ...
					                    <div class="actions">
					                        <a  class="btn btn-circle btn-icon-only btn-default add-hp-alamat" data-row="'.$indexHP.'" data-counter="'.$indexHPAlamat.'">
						                        <i class="fa fa-plus"></i>
					                    	</a>
					                	</div>
					                </div>
			                ...
			                <div class="col-md-12">
				                <div class="portlet">
					                <div class="portlet-title">
					                    ...
					                    <div class="actions">
					                        <a  class="btn btn-default btn-circle btn-icon-only add-hp-phone" data-row="'.$indexHP.'" data-counter="'.$indexHPPhone.'">
						                        <i class="fa fa-plus"></i>
					                    	</a>
					                	</div>
					                </div>
