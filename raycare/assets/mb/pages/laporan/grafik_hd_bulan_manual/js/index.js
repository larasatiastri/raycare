mb.app.grafik_hd_bulan_manual = mb.app.grafik_hd_bulan_manual || {};
(function(o){
   ...
   var handleGetPasien = function(start, penjamin_id) {
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'laporan/grafik_hd_bulan_manual/';
        handleMonthPeriode();
        handleDataTable();
 ...
 }(mb.app.grafik_hd_bulan_manual));


// initialize  mb.app.home.table
$(function(){
    mb.app.grafik_hd_bulan_manual.init();
});