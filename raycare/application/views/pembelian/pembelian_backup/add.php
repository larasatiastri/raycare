<?php
	...
	$item_cols = array(// style="width:156px;
		'item_kode'          => '<label class="control-label hidden" name="items[{0}][item_kode]"></label><div class="input-group" style="width:200px;">'.form_input($attrs_item_kode).form_input($attrs_item_id).'<span class="input-group-btn">'.$btn_search.'</span></div>',
		'item_name'          => '<label class="control-label" name="items[{0}][item_nama]"></label><div style="width:400px;">'.form_input($attrs_item_nama).'<div id="tabel_simpan_data_{0}" class="hidden"></div></div><div id="detail_kirim" class="hidden"></div>',
		'item_satuan'        => '<div style="width:150px;">'.form_dropdown('items[{0}][satuan]', $satuan_option, "", "id=\"items_satuan_{0}\" data-row=\"{0}\" class=\"form-control satuan\"").form_input($attrs_satuan_nama).form_input($attrs_satuan_id).'</div>',
		'item_harga'         => '<div class="text-right" style="width:150px;"><label class="control-label hidden" name="items[{0}][item_harga]" id="items_hargaEl_{0}"></label></div><div class="input-group col-md-12"><span class="input-group-addon">&nbsp;Rp&nbsp;</span>'.form_input($attrs_item_harga).form_input($attrs_item_harga_lama).'</div>',
		'item_jumlah'        => '<div style="width:100px;"><div class="input-group">'.form_input($attrs_jumlah).form_input($attrs_jumlah_min).'<span class="input-group-btn">'.$btn_jumlah.'</span></div></div>',
		'item_diskon'        => '<div style="width:100px;">'.form_input($attrs_item_diskon).'</div>',
		
		'item_total'         => '<div class="text-right" style="width:150px;"><label class="control-label" name="items[{0}][item_sub_total]"></label></div>'.form_input($attrs_item_total).form_input($attrs_per_item_total),
		'action'             => $btn_del,
	);
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-12">
													<div class="radio-list">
														<label class="radio-inline">
														<input type="radio" name="is_single" id="optionskirimya" value="1"> Ya </label>
														<label class="radio-inline">
						...
						<div class="table-scrollable">
							...
							<table class="table table-striped table-bordered table-hover" id="table_detail_pembelian">
								...
								<tfoot>
									...
									<tr>
										<td colspan="5" class="text-right bold">Biaya Tambahan<div id="biaya_tambahan" class="hidden"></div></td>
										<td>
									...
									<tbody>
										<tr>
											<td rowspan="1" colspan="1" width="4%">
												<div style="width:70px;"><input type="number" class="form-control" name="lama_tenor" id="lama_tenor" min="0" value="0"></input></div>
											</td>
										...
										<td rowspan="1" colspan="1">
											<div class="input-group right" style="width:110px;">
										...
										<td rowspan="1" colspan="1" width="3%">
											<div class="input-group right" style="width:95px;">
