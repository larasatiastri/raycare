...
<div class="portlet light">
	<div class="portlet-title">
		...
		<i class="icon-plus font-blue-sharp"></i>
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Permintaan Dana", $this->session->userdata("language"))?></span>
		</div>
	</div>
	<div class="portlet-body form">
		<div class="form-body">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="portlet light bordered">
						...
						<div class="form-group">
							...
							<label class="col-md-12"> Reimburse / Pencairan </label>
							<div class="col-md-12 hidden">

								<div class="radio-list">
									<label class="radio-inline hidden">
									<input type="radio" id="kasbon" value="1" data-type="1" name="tipe" class="form-control"> Kas</label>
									<label class="radio-inline">
									<input type="radio" id="rembes" value="2" data-type="2" name="tipe" class="form-control" checked> Reimburse / Pencairan </label>
								</div>
							</div>
						</div>
						<div class="form-group">
				...
				<div class="col-md-9 hidden" id="section-biaya">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption">
						...
						<div class="form-body">
						    <div class="portlet-body">
								<?php
				                    ...
				                    $nominal = array(
				                        'id'          => 'biaya_nominal_{0}',
				                        'name'        => 'biaya[{0}][nominal]',
				                        'class'       => 'form-control'
				                    );
				                    $keterangan = array(
				                        'id'          => 'biaya_keterangan_{0}',
				                        'name'        => 'biaya[{0}][keterangan]',
				                        'class'       => 'form-control',
				                    );

				                    $item_cols = array(
										'biaya_jenis'   => form_dropdown('biaya[{0}][biaya_id]', $option_biaya, '', 'id="biaya_id_biaya_{0}" class="form-control"'),
										'biaya_nominal' => '<div class="input-group">
																<span class="input-group-addon">
																	Rp.
																</span>
																<input class="form-control nominal_biaya" id="nominal_biaya_{0}" name="biaya[{0}][nominal]" >
															</div>
						    ...
						    <div class="portlet-body">
								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
											<div class="col-md-12">
												<input class="form-control" id="isian_1_{0}" name="bon[{0}][isian_1]" placeholder="Isian 1">
											</div>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<div class="col-md-12">
												<input class="form-control" id="isian_2_{0}" name="bon[{0}][isian_2]" placeholder="Isian 2">
											</div>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<textarea class="form-control keterangan" id="keterangan_{0}" name="bon[{0}][keterangan]" rows="5" placeholder="Keterangan"></textarea>
											</div>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="hidden" name="bon[{0}][url]" id="bon_url_{0}" required>
												<div id="upload_{0}">
													<span class="btn default btn-file">
