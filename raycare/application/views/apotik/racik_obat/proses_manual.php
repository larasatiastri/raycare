				...
				<div class="portlet-body form">
					<div class="form-body">
						...
						<div class="form-group hidden">
							<label class="control-label col-md-2"><?=translate("Tindakan Resep Obat Manual Id", $this->session->userdata("language"))?> :</label>
							<div class="col-md-2">
								<?php
									$tindakan_resep_obat_manual_id = array(
										"id"			=> "tindakan_resep_obat_manual_id",
										"name"			=> "tindakan_resep_obat_manual_id",
										"autofocus"			=> true,
										"class"			=> "form-control hidden", 
										"placeholder"	=> translate("Tindakan Resep Obat Manual Id", $this->session->userdata("language")), 
										"value"			=> $form_data['id'],
										"help"			=> $flash_form_data['tindakan_resep_obat_manual_id'],
									);
									echo form_input($tindakan_resep_obat_manual_id);
								?>
								<label id="tindakan_resep_obat_manual_id" class="control-label"><?=$form_data['id']?></label>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-2"><?=translate("Satuan Produksi", $this->session->userdata("language"))?> :</label>
							<div class="col-md-2">
								<?php
									$satuan_produksi = array(
										"id"          => "satuan_produksi",
										"name"        => "satuan_produksi",
										"type"        => "text",
										"class"       => "form-control", 
										"placeholder" => translate("Satuan Produksi", $this->session->userdata("language")), 
										"value"       => $flash_form_data['satuan_produksi'],
										"help"        => $flash_form_data['satuan_produksi'],
									);
									echo form_input($satuan_produksi);
								?>	
							</div>
						</div>
							...
							<div class="col-md-2">
								<?php
									$nama_resep = array(
										...
										"value"			=> $flash_form_data['nama_resep'],
			...
			<div class="portlet light">
				...
				<?php 
				 ...
				 //    if(empty($records)){
					...
					// 									<a data-toggle="modal" data-target="#popup_modal" href="'.base_url().'apotik/racik_obat/modal_identitas/'.$data['item_id'].'/item_row_{0}" class="btn btn-primary identitas"><i class="fa fa-info"></i></a>
					// 								  </div>'.form_input($attrs_jumlah),
						...
						<tfoot>
							<tr>
								...
								<td class="text-right" colspan="1">
									<div class="input-group">
									    ...
									    <label id="sub_total" class="control-label form-control"><?=number_format(0,0,'','.')?>,-</label>
							...
							<tr>
								...
								<td class="text-right" colspan="1">
									...
									<label id="harga_jual" class="control-label"><?=number_format(0,0,'','.')?>,-</label>
