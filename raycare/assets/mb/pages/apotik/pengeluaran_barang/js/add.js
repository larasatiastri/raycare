mb.app.pengeluaran_barang = mb.app.pengeluaran_barang || {};
mb.app.pengeluaran_barang.add = mb.app.pengeluaran_barang.add || {};
...
(function(o){
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'apotik/pengeluaran_barang/';
...
}(mb.app.pengeluaran_barang.add));

$(function(){    
    mb.app.pengeluaran_barang.add.init();
});