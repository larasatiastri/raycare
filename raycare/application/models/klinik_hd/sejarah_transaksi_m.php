...
class Sejarah_transaksi_m extends MY_Model {

	protected $_table        = 'rm_tindakan_pasien';
	...
	protected $datatable_columns = array(
		//column di table  => alias
		'c.nama'            => 'namacabang', 
		'd.nama'            => 'namapoliklinik', 
		'b.no_transaksi'    => 'no_transaksi', 
		'b.tanggal'         => 'tanggal', 
		'b.tipe_penanganan' => 'tipe_penanganan', 
	...
	{	
		...
		$join1 = array('tindakan_hd b',$this->_table . '.tindakan_id = b.id');
		$join2 = array('cabang c',$this->_table . '.cabang_id = c.id');
		$join3 = array('poliklinik d',$this->_table . '.poliklinik_id = d.id');
		...
		$this->datatable_prepare($join_tables, $params);
		 $this->db->where('rm_tindakan_pasien.pasien_id',$id);
		 $this->db->where('rm_tindakan_pasien.is_active',1);
		 $this->db->where('rm_tindakan_pasien.tipe',1);
