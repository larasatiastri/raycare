<div class="portlet light">
	...
	<div class="portlet-body form">
		...
		?>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<?php
							...
							echo form_dropdown('kategori_id', $option_kategori,'','id="kategori_id" class="form-control"');
						?>
					</div>
				</div>
				<div class="form-group">
			...
			<?php $msg = translate("Apakah anda yakin akan membuat pemeriksaan lab ini?",$this->session->userdata("language"));?>
