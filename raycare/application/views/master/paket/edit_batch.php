		...
		<div class="portlet-body form">	
			<div class="form-wizard">
				<div class="form-body">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-2">
                            <select class="form-control" id="tipe" name="tipe">
								<option value="<?=$form_data['tipe']?>"><?=$tipe?></option>
					...
					<div class="form-group hidden">
						<label class="control-label col-md-3"><?=translate("Paket_ID_item :", $this->session->userdata("language"))?></label>		
						<div class="col-md-2">
							<?php
								$paket_batch_id = array(
									"name"			=> "paket_batch_id_item",
									"id"			=> "paket_batch_id_item",
									"autofocus"			=> true,
									"class"			=> "form-control", 
									"placeholder"	=> translate("paket_batch_id", $this->session->userdata("language")), 
									"value"			=> $data_paket_item[0]['id'],
								);
								echo form_input($paket_batch_id);
							?>
						</div>
					</div>

					<div class="form-group hidden">
						<label class="control-label col-md-3"><?=translate("Paket_ID_tindakan :", $this->session->userdata("language"))?></label>		
						<div class="col-md-2">
							<?php
								$paket_batch_id = array(
									"name"			=> "paket_batch_id_tindakan",
									"id"			=> "paket_batch_id_tindakan",
									"autofocus"			=> true,
									"class"			=> "form-control", 
									"placeholder"	=> translate("paket_batch_id", $this->session->userdata("language")), 
									"value"			=> $data_paket_tindakan[0]['id'],
								);
								echo form_input($paket_batch_id);
							?>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<?php
								...
								$id_paket_batch = array(
									"name"        => "id_paket_batch",
									"id"          => "id_paket_batch",
									"class"       => "form-control hidden", 
									"value"       => $pk_value,
								);
								echo form_input($id_paket_batch);
	                                    ...
	                                    <table class="table table-condensed table-striped table-bordered table-hover" id="table_paket_tindakan">
	                                        <thead>
	                                            <tr role="row" class="heading">
		                                            ...
		                                            <th scope="col"><div class="text-center"><?=translate("Nama", $this->session->userdata('language'))?></div></th>
		                                            <th scope="col"><div class="text-center"><?=translate("Jumlah", $this->session->userdata('language'))?></div></th>
		                                            <th width="10%"><div class="text-center"><?=translate("Jumlah Di Gunakan", $this->session->userdata('language'))?></div></th>
	                                            </tr>
	                                        </thead>
	                                        <tbody>
				...
				<?php
					$confirm_save       = translate('Apa Kamu Yakin Akan Merubah Paket Batch Ini ?',$this->session->userdata('language'));
