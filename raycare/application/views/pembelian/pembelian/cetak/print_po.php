		...
		<table id="body_info" border="0">
			...
			<tr>
				...
				?>
					...
					<td>:</td>
					<td width="430px" colspan="3"><?=date('d F Y', strtotime($pembelian['tanggal_kirim']))?></td>
				<?php
					}else{
				?>
					<td valign="top">Delivery Condition</td>
					<td valign="top">:</td>
					<td width="430px" colspan="3">
			...
			<tr>
				...
				<?php 
			if (file_exists($_SERVER['DOCUMENT_ROOT']."cloud/".config_item('site_dir')."logo/logo-big.png") && is_file($_SERVER['DOCUMENT_ROOT']."cloud/".config_item('site_dir')."logo/logo-big.png")) 
	        {
