...
class Laporan_kerja_detail_m extends MY_Model {

	protected $_table      = 'realnew_core.laporan_kerja_detail';
	...
	{
		$format = "SELECT MAX(RIGHT(`id`,4)) AS max_id FROM `core.laporan_kerja_detail` WHERE SUBSTRING(`id`,5,7) = DATE_FORMAT(NOW(), '%m-%Y')";	
