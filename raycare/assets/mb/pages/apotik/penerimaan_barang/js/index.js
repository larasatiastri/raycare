mb.app.penerimaan_barang = mb.app.penerimaan_barang || {};
(function(o){

    var 
        baseAppUrl              = '',
        $form   = $('#form_index'),
        $table1 = $('#table_penerimaan_barang'),
    ...
    var handleDataTable = function() 
    {
        ...
        $table1.on('draw.dt', function (){
            ...
            $('a[name="terima[]"]', this).click(function(){
                // alert('klik');
                var $anchor = $(this),
                      id        = $anchor.data('id');
                      msg       = $anchor.data('confirm');
                      // gudang_id = $anchor.data('gudang');

                handleInsertDraf(id, msg);
                // handleInsertDraf(id, gudang_id, msg);
            });
    ...
    var handleInsertDraf = function(id, msg) {

        bootbox.confirm(msg, function(result) {
            if(result==true) {
                location.href = baseAppUrl + 'terima/' + id;
            } 
        });

        // href="'.base_url().'gudang/pengiriman_barang/proses/'.$row['id'].'/'..'"
 ...
 }(mb.app.penerimaan_barang));


// initialize  mb.app.home.table
$(function(){
    mb.app.penerimaan_barang.init();
});