<?php
 ...
 //    /////////////////////////////////////////////////////////////////////
    ...
    } elseif($form_data['status'] == 11){

        $status = '<div class="text-center"><span class="label label-md label-warning">Menunggu Persetujuan Keuangan</span></div>';
    }elseif($form_data['status'] == 12){

        $status = '<div class="text-center"><span class="label label-md label-info">Dibaca Keuangan</span></div>';
    }elseif($form_data['status'] == 13){

        $status = '<div class="text-center"><span class="label label-md label-warning">Disetujui Keuangan</span></div>';
    }elseif($form_data['status'] == 14){

        $status = '<div class="text-center"><span class="label label-md label-danger">Ditolak Keuangan</span></div>';
    }
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("View Permintaan Biaya", $this->session->userdata("language"))?></span> <span><?=$form_data['nomor_permintaan']?></span>
		</div>
		<div class="actions">    
		...
		<div class="col-md-3">
			<div class="portlet light bordered">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<label class="control-label"><strong><?=date('d M Y', strtotime($form_data['tanggal']))?></strong></label>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="input-group">
							...
							?>
							<label class="control-label"><strong><?=$nama_user['nama']?></strong></label>
						</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="input-group">
							<label class="control-label"><strong><?=formatrupiah($form_data['nominal'])?></strong></label>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="input-group">
							<label class="left"><strong><?='#'.terbilang($form_data['nominal']).' Rupiah#'?></strong></label>
						</div>
					</div>
				</div>
			...
			<div class="portlet light bordered">
				...
				<div class="form-body">
				    <div class="portlet-body">
						<div class="form-group">
							<div class="col-md-12">
								<label class="control-label"><strong><?=$form_data['keperluan']?></strong></label>
							</div>
						</div>
	                </div>
				...
				<div class="form-body">
	                ...
	                <div class="portlet-body">
						<div class="form-group">
							...
							<div class="col-md-12">
								<label class="control-label"><strong><?=formatrupiah($form_data['nominal_setujui'])?></strong></label>
							</div>
						</div>
	                </div>
	                <div class="portlet-body">
						<div class="form-group">
							...
							<div class="col-md-12">
								<label class="control-label"><strong><?='#'.terbilang($form_data['nominal_setujui']).' Rupiah#'?></strong></label>
							</div>
						</div>
	                </div>
