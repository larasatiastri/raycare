...
class Simpan_item_identitas_detail_m extends MY_Model {

	protected $_table        = 'simpan_item_identitas_detail';
	...
	protected $datatable_columns = array(
		...
		'simpan_item_identitas_detail.simpan_item_identitas_id' => 'simpan_item_identitas_id',
		'b.nama'                                                => 'nama', 
   ...
   //die(dump($result->records));
	...
	public function delete_simpan_item_identitas_detail_kosong($simpan_item_identitas_id)
	{
	...
	{
		$sql= "select max(Simpan_item_identitas_detail_id) as max_id from simpan_item_identitas_detail;";
