	...
	<div class="portlet light">	
		<div class="portlet-body">
			...
			<div class="form-group hidden">
				<label class="col-md-12"><?=translate("Upload Bukti Setor", $this->session->userdata("language"))?> <span>:</span></label>
				<div class="col-md-12">
        ...
        bootbox.confirm(msg, function(result) {
            if (result==true) {
                ...
                ({
                    ...
                    beforeSend : function(){
                        Metronic.blockUI({boxed: true });
                        $('a#simpan',$form).attr('disabled','disabled');
                    },
                    success:function(data)          //on recieve of reply
                    { 
