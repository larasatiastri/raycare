...
mb.app.pasien.view = mb.app.pasien.view || {};
(function(o){

    var 
        baseAppUrl               = '',
        $form                    = $('#form_view_pasien'),
    ...
    var addFieldsetAlamat = function(form)
    {
        ...
        handleSelectProvinsi(counter, "tab_alamat");
        handleSelectKota(counter, "tab_alamat");
        handleSelectKecamatan(counter, "tab_alamat");
        handleSelectKelurahan(counter, "tab_alamat");
    };
    ...
    var handleUploadify = function()
    {
        ...
        $('#upl').fileupload({
            ...
            add: function (e, data) {
                ...
                tpl.find('div.thumbnail').html('<a href="'+mb.baseUrl()+'assets/mb/var/temp/'+filename+'" target="_blank"><img src="'+mb.baseUrl()+'assets/mb/var/temp/'+filename+'" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a>');
    ...
    var handleUploadifyDokumen = function()
    {
        $('.uploadbutton').each(function(index)
        {
            ...
            var ul = $('#upload_dokumen_'+index+' ul');
            ...
            $('#upload_'+index).fileupload({
                ...
                add: function (e, data) {
                    ...
                    tpl.find('div.thumbnail').html('<a href="'+mb.baseUrl()+'assets/mb/var/temp/'+filename+'" target="_blank"><img src="'+mb.baseUrl()+'assets/mb/var/temp/'+filename+'" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a>');
                    $('input#url_'+index).attr('value',filename);
                    // Add the HTML to the UL element
                    ul.html(tpl);
                    Metronic.unblockUI();
                    // data.context = tpl.appendTo(ul);
