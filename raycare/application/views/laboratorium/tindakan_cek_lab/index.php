<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Daftar Tindakan Lab", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">
			
			<a href="<?=base_url()?>laboratorium/tindakan_cek_lab/history" class="btn default"> <i class="fa fa-history"></i> <span class="hidden-480"><?=translate("Histori", $this->session->userdata("language"))?></span> </a>
		
        </div>
	</div>
	<div class="portlet-body">
		<table class="table table-condensed table-striped table-hover" id="table_tindakan_lab">
			<thead>
				<tr role="row">
