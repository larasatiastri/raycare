...
<div class="portlet light">
	<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-sign-out font-blue-sharp bold"></i>
				<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Konfirmasi Selesaikan Tindakan HD", $this->session->userdata("language"))?></span>
			</div>
		</div>
...
<div class="checkbox-list">
	...
	<div class="form-actions right">
		<a class="btn default kembali" data-bed="<?=$pk_value?>">
			<i class="fa fa-chevron-left"></i>
			<?=translate('Kembali', $this->session->userdata('language'))?>
		</a>
		<a class="btn btn-primary <?=$show?> btn-selesai" id="confirm_save_selesaikan" data-toggle="modal" data-confirm="<?=translate('Apakah anda yakin akan menyelesaikan 	tindakan ini?', $this->session->userdata('language'))?>">
...
</div><!--selesaikan tindakan HD portlet light-->
<?=form_close();?>
