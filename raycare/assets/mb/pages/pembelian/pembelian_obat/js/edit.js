...
(function(o){
    ...
    var calculateTotal = function(){
        ...
        $.each($rows, function(idx, row)
        {
            var 
                ...
                is_active = parseFloat($('input[name$="[is_active]"]', $row).val()),
        ...
        $('input#disk_hidden').val(parseFloat(grandTotal * parseFloat($('input#disk_angka').val())/100));
    ...
    var calculateTotalDiskon = function()
    {
        ...
        grandTotalAll = grandTotal - parseFloat(grandTotal * parseFloat($('input#diskon').val())/100) + parseFloat(grandTotal * parseFloat($('input#pph').val())/100);
    ...
    var calculateTotalPPh = function()
    {
        ...
        var 
            ...
            pph_persen = parseFloat(pph_nominal * 100)/grandTotal;
            ...
            var 
                ...
                if(found == false)
                {
                        ...
                        { 
                            ...
                            $.each(results, function(key, value) {
                                ...
                                if(value.is_primary)
                                {
                                    ...
                                    $itemLabelHarga.text(mb.formatRp(parseFloat(value.harga), 10));
                                    $itemHarga.val(parseFloat(value.harga));
                                }
                    ...
                    if ($itemKode.val() == "") {
                        ...
                        // $itemLabelHarga.text(mb.formatRp(parseFloat($(this).data('item').harga), 10));
    ...
    var handleBtnSearchPermintaan = function($btn){
        ...
        $btn.popover({ 
            ...
            $('a#tambah-link').attr('href', baseAppUrl+'daftar_link/'+$(this).data('id')+'/'+parseFloat($(this).data('row'))+'/'+$(this).data('satuan'));
            ...
            $('table#table_search_permintaan > tbody').append($('div#tabel_simpan_data_'+parseFloat($(this).data('row'))).html());
            // $('#table_search_permintaan > tbody').html($('div#simpan_data_'+parseFloat($(this).data('row')+1)).html());
    ...
    var handlePilihSupplierSelect = function($btn){
        $btn.on('click', function(e){
            ...
            var is_flexible = parseFloat($(this).data('item').is_harga_flexible);
