...
<div class="modal-header">
    ...
    <h4 class="modal-title">Input jumlah item <strong><?=$data_item->nama?></strong> [ <?=$data_item_satuan->nama?> ]</h4>
</div>
    ...
    <div class="portlet light" id="section-jumlah">
        <div class="portlet-body ">
            ...
            <?php
                ...
                $form_jumlah .= ' <input class="form-control jumlah" required id="jumlah_kirim_{0}" name="input_jumlah_'.$index_row.'[{0}][jumlah_kirim]" placeholder="Jumlah Kirim">';             
