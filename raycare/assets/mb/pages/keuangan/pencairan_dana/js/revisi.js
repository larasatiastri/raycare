...
(function(o){
     ...
     var 
        ...
        biayaCounter      = 0;
        uploadCounter     = parseInt($('input#jml_baris').val()),
        formsUpload       = 
        {
            'bon' : 
            {            
    ...
    var initForm = function(){
        ...
        $('input[name$="[nominal_bon]"]', $form).on('change', function(){
//            alert('testse');
            countTotalBon();
        });
            ...
            bootbox.confirm('Anda yakin akan menghapus invoice ini?', function(result) {
                if (result==true) {
                    ...
                    if(i == 1)
                    {
                        ...
                        $('input[name$="[nominal_bon]"]', $fieldset).val(0);
                        $('input[name$="[nominal_bon]"]', $fieldset).attr('value',0);
                        $fieldset.hide();   
                        countTotalBon();     
                    }
                }
