...
class Cabang_m extends MY_Model {
	...
	public function get_data_dokter_edit($poliklinik_id, $dokter_id)
	{
		$format_dokter = "SELECT user.nama as nama
						  ...
						  WHERE
							   ...
							   cabang_poliklinik_dokter.cabang_poliklinik_id = $poliklinik_id AND
							   cabang_poliklinik_dokter.dokter_id = $dokter_id";

		return $this->db->query($format_dokter, $poliklinik_id, $dokter_id);
	}

	public function get_data_dokter_pendaftaran($id_poliklinik,$id_cabang)
	{
		$format_dokter = "SELECT user.id as id,user.nama as nama
						  FROM
							   cabang_poliklinik_dokter ,
							   user ,
							   cabang_poliklinik
						  WHERE
							   ...
							   cabang_poliklinik.poliklinik_id =".$id_poliklinik."
							   and cabang_poliklinik.cabang_id=".$id_cabang;
