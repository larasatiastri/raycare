...
<div class="tabbable-custom nav-justified">
	<ul class="nav nav-tabs nav-justified">
		...
		<li>
			<a href="#tab_pembelian_lunas" data-toggle="tab">
			Pembelian Sudah Lunas </a>
		</li>
	</ul>
		...
		<div class="tab-pane active" id="tab_pembelian_baru">
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions">
			            <a href="<?=base_url()?>pembelian/pembelian/add" class="hidden btn btn-default btn-circle">
...
<!-- 						</div> -->
		...
		<div class="tab-pane" id="tab_pembelian_proses">
			<div class="portlet light">
					<div class="portlet-title">
						...
						<div class="actions">
				            <a href="<?=base_url()?>pembelian/pembelian/history" class="btn default">
		...
		<div class="tab-pane" id="tab_pembelian_lunas">
			<div class="portlet light">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-shopping-cart font-blue-sharp bold"></i>
							<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Pembelian Sudah Lunas", $this->session->userdata("language"))?></span>
						</div>
							
					</div>
				<table class="table table-striped table-hover" id="table_pembelian_lunas">
					<thead>
						<tr>
							<th class="text-center"><?=translate("ID", $this->session->userdata("language"))?> </th>
							<th class="text-center" width="1%"><?=translate("No PO", $this->session->userdata("language"))?> </th>
...
<div id="popover_item_content" class="row">
    <div class="col-md-12">
        <table class="table table-condensed table-striped table-bordered table-hover" id="table_pilih_cetak">
            <thead>
                <tr role="row">
