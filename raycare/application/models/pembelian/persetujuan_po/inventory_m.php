...
class Inventory_m extends MY_Model {
	...
	public function get_stock_item_box_permintaan_barang($item_id, $jumlah)
	{
	...
	public function get_stock_item_permintaan_barang($item_id, $item_satuan_id, $jumlah)
	{
	...
	public function get_stock_item_all($item_id)
	{
