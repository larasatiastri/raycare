...
class Calon_pasien_syarat_penjamin_detail_m extends MY_Model {

	protected $_table        = 'calon_pasien_syarat_penjamin_detail';
 ...
 // die(dump($result->records));
	...
	public function get_data_calon_pasien_syarat_penjamin_detail($penjamin_id, $syarat_id){
		$format = " SELECT
	...
	public function get_data_calon_pasien_syarat_penjamin_detail_by_value($penjamin_id, $syarat_id, $value_detail){
		$format = " SELECT
					calon_pasien_penjamin.id,
					calon_pasien_syarat_penjamin.syarat_id,
					syarat.tipe,
					...
					LEFT JOIN calon_pasien_syarat_penjamin_detail ON calon_pasien_syarat_penjamin.id = calon_pasien_syarat_penjamin_detail.calon_pasien_syarat_penjamin_id
					WHERE
					calon_pasien_penjamin.id = $penjamin_id AND
					syarat.id = $syarat_id AND
					calon_pasien_syarat_penjamin_detail.value = $value_detail";
		return $this->db->query($format);
	}

	public function delete_data($calon_pasien_syarat_penjamin_id, $value){
		$format ="DELETE FROM calon_pasien_syarat_penjamin_detail WHERE calon_pasien_syarat_penjamin_id = $calon_pasien_syarat_penjamin_id AND value != $value";
		return $this->db->query($format);
	}
