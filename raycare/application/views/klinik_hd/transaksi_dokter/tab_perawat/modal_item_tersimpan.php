			...
			<div class="col-md-2">
				<div class="input-group">
					...
					<span class="input-group-btn">
	                    <a class="btn btn-primary btn-modal-identitas" href="<?=base_url()?>klinik_hd/transaksi_dokter/modal_simpan_identitas/<?=$pasien_id?>/<?=$item_id?>/<?=$item_satuan_id?>" data-toggle="modal" data-target="#modal_identitas"><i class="fa fa-info"></i></a>
	                </span>
...
<div class="modal-footer">
	...
	<a class="btn btn-primary simpan_item" data-dismiss="modal" id=""><?=translate('OK', $this->session->userdata('language'))?></a>
</div>
