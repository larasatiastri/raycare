									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div id="upload">
												...
												<ul class="ul-img">
												<li class="working"><div class="thumbnail"><a class="fancybox-button" title="<?=$form_data['url_surat_jalan']?>" href="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/gudang/barang_datang_farmasi/images/<?=$pk_value?>/<?=$form_data['url_surat_jalan']?>" data-rel="fancybox-button"><img src="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/gudang/barang_datang_farmasi/images/<?=$pk_value?>/<?=$form_data['url_surat_jalan']?>" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a></div><span></span></li>
												</ul>
