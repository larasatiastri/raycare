...
class Permintaan_biaya_tipe_m extends MY_Model {

	protected $_table        = 'permintaan_biaya_tipe';
	...
	protected $datatable_columns = array(
		...
		'permintaan_biaya_tipe.biaya_tipe'  => 'biaya_tipe',
	...
	public function get_rupiah($id)
	{

		$format = "SELECT SUM(jumlah) as rupiah
					from permintaan_biaya_tipe
					where permintaan_biaya_id = $id";
