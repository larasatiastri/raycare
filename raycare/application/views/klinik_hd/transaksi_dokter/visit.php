					...
					<div class="form-body">
					    ...
					    <div class="row">
					    	<div class="col-md-6">
					    		...
					    		<div class="form-group">
									<label class="control-label col-md-6"><?=translate("No.Pasien", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-6"><?=translate("Nama Pasien", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-6"><?=translate("Dialisis Terakhir", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-6"><?=translate("Keterangan", $this->session->userdata("language"))?> :</label>
					    	...
					    	<div class="col-md-6">
								...
								<div class="form-group">
									<label class="control-label col-md-2"><?=translate("Berat Awal", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-2"><?=translate("Berat Akhir", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-2"><?=translate("Rujukan", $this->session->userdata("language"))?> :</label>
								...
								<div class="form-group">
									<label class="control-label col-md-2"><?=translate("No.Bed", $this->session->userdata("language"))?> :</label>
			...
			<div class="portlet light">
				...
				<div class="portlet-body">
					<ul class="nav nav-tabs">
						...
						<li>
							<a href="#gambar" data-toggle="tab" class="hidden">
							<?=translate('Item telah tersimpan', $this->session->userdata('language'))?> </a>
						</li>
						<li>
							<a href="#identitas" data-toggle="tab" class="hidden">
							<?=translate('Tagihan Paket', $this->session->userdata('language'))?> </a>
						</li>
						<li>
							<a href="#penjamin" data-toggle="tab" class="hidden">
							<?=translate('Item yang digunakan', $this->session->userdata('language'))?> </a>
						</li>
						<li>
							<a href="#resep" data-toggle="tab" class="hidden">
...
<form id="modalpic" name="modalpic"    autocomplete="off">
    <?
    	$form_alert_danger  = translate('Terdapat beberapa kesalahan. Silahkan cek kembali.', $this->session->userdata('language'));
    	$form_alert_success = translate('Data yang diinputkan akan tersimpan.', $this->session->userdata('language'));
        $msg = translate("Apakah anda yakin akan merubah observasi dialisis ini?",$this->session->userdata("language"));
    ?>
    <div class="modal fade" id="ajax_notes4" role="basic" aria-hidden="true" style="display:none">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title caption-subject font-blue-sharp bold uppercase"><?=translate('Observation Dialysis', $this->session->userdata('language'))?></h4>
                </div>
  				...
  				<div class="modal-footer">
                    <div class="form-actions fluid">    
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-primary" id="confirmsave" data-confirm="<?=$msg?>" data-toggle="modal"><?=translate("Submit", $this->session->userdata("language"))?></a>
						<button type="submit" id="saveobservasi" class="btn default hidden" ><?=translate("Reset", $this->session->userdata("language"))?></button>
						 
						<a class="btn default" id="backbtn"><?=translate("Back", $this->session->userdata("language"))?></a>
                        </div>      
                    </div>
