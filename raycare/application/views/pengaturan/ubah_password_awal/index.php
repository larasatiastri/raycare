<?php
	$form_attr = array(
	    "id"            => "form_ubah_password_awal", 
	    "name"          => "form_ubah_password_awal", 
	    "autocomplete"  => "off", 
    ...
    echo form_open(base_url()."pengaturan/ubah_password_awal/save", $form_attr, $hidden);
				...
				<div class="col-md-3">
					<?php
						$old_password = array(
							...
							"required"    => "required",
							"value"		=> config_item('new_password_reset')
