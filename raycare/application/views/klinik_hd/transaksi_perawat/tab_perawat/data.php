					...
					<div class="portlet light">
						...
						<div class="col-md-9">
							...
							<div class="form-body">
								...
								<div class="form-group">
									<label class="control-label col-md-5"><?=translate("Pendidikan", $this->session->userdata("language"))?> :</label>
									
									<div class="col-md-7">
										  <label class="control-label"><?=(isset($form_pendidikan['nama']) && $form_pendidikan['nama']!= NULL)?$form_pendidikan['nama']:'-' ?></label>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-5"><?=translate("Pekerjaan", $this->session->userdata("language"))?> :</label>
									
									<div class="col-md-7">
										  <label class="control-label"><?=(isset($form_pekerjaan['nama']) && $form_pekerjaan['nama']!=NULL)?$form_pekerjaan['nama']:'-' ?></label>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-5"><?=translate("Cara Masuk", $this->session->userdata("language"))?> :</label>
									
									<div class="col-md-7">
										  <label class="control-label"><?=(isset($form_cara_masuk['nama']) &&  $form_cara_masuk['nama'] != NULL)? $form_cara_masuk['nama']:'-' ?></label>
									</div>
								</div>
					...
					<div class="portlet light" id="section-telepon">
						...
						<div class="portlet-body form">
							<div class="form-body">
								...
								<div class="form-group">
									<label class="control-label col-md-3"><?=(isset($form_sbjk_tlp['nama']) && $form_sbjk_tlp['nama'] != NULL)?$form_sbjk_tlp['nama']:'-' ?> :</label>
							...
							<div class="form-body form">
								...
								<div class="form-group">
 								...
 								<div class="form-group">
									...
									<div class="col-md-4">
										 <label class="control-label"><?=date('d M Y',strtotime($form_pasien['ref_tanggal_rujukan']))?></label>
									</div>
								</div>
								<div class="form-group">
							...
							<div class="form-body form">
								<div class="form-group">
									<?php 
										...
										foreach ($form_alamat as $alamat) 
										{
											$rt = '';
											$rw = '';
											if (isset($alamat['rt_rw']) && $alamat['rt_rw'] != NULL) 
											{
            								...
            								$form_sbjk_alamat = $this->subjek_m->get($alamat['subjek_id']);
								           
            								(isset($form_sbjk_alamat->nama) && $form_sbjk_alamat->nama != NULL)? $form_sbjk_alamat = $form_sbjk_alamat->nama : $form_sbjk_alamat = '';
											...
											{
												echo '<label class="control-label col-md-4 bold">'.$form_sbjk_alamat.' :</label>';
	            								echo '<div class="col-md-6">';
	            								echo '<label class="control-label bold" style="text-align: left;">'.$alamat['alamat'].$rt.$rw.$form_kel_alamat.$form_kec_alamat.$form_kota_alamat.'</label>';
	            								echo '</div>';
											}
											else 
											{
												echo '<label class="control-label col-md-4">'.$form_sbjk_alamat.' :</label>';
	            								echo '<div class="col-md-6">';
	            								echo '<label class="control-label" style="text-align: left;">'.$alamat['alamat'].$rt.$rw.$form_kel_alamat.$form_kec_alamat.$form_kota_alamat.'</label>';
	            								echo '</div>';
											}
					...
					<div class="portlet light" id="section-alamat">
						<div class="portlet-title">
							...
							<div class="actions" id="act1">
	            					<a id="histori" class="btn btn-circle btn-default">
	        				...
	        				<div class="actions" id="act2" style="display:none">
	            					<a id="kembali" class="btn btn-circle btn-default">
