<?php
    ...
    echo form_open(base_url()."tindakan/input_hasil_lab_manual/save", $form_attr, $hidden);
...
<div class="portlet light">
    <div class="portlet-title">
        ...
        <div class="actions">   
            <a class="btn btn-circle btn-default" href="<?=base_url()?>tindakan/input_hasil_lab_manual"><i class="fa fa-chevron-left"></i>  <?=translate("Kembali", $this->session->userdata("language"))?></a>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body"> 
                    ...
                    <?php
                        ...
                        $attrs_item_nilai_normal_manual = array(
                            'id'       => 'item_nilai_normal_manual_{0}',
                            'name'     => 'item[{0}][nilai_normal_manual]',
                            'class'    => 'form-control',
                        );
                        ...
                        $item_cols = array(// style="width:156px;
                            'item_code'   => form_input($attrs_item_pemeriksaan),
                            'item_hasil' => form_input($attrs_item_hasil),
                            'item_nilai_normal' => form_input($attrs_item_nilai_normal_manual),
                            'item_satuan'   => form_input($attrs_item_satuan),
                            'item_keterangan'   => form_textarea($attrs_item_keterangan),
                            'action'      => $btn_del,
                        );
