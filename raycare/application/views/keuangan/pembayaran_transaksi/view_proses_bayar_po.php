							...
							if(count($data_bayar_detail_po) != 0){
								foreach ($data_bayar_detail_po as $key => $bon) {
									...
									<td style="vertical-align: top !important;">
										<a class="fancybox-button" title="'.$bon['url_bukti_bayar'].'" href="'.config_item('site_img_proses_bayar').$bon['id'].'/'.$bon['url_bukti_bayar'].'" data-rel="fancybox-button"><img src="'.config_item('site_img_proses_bayar').$bon['id'].'/'.$bon['url_bukti_bayar'].'" alt="Smiley face" class="img-responsive" ></a>
									</td>
									</tr>';
						...
						<table class="table table-bordered table-hover" id="table_invoice">
							...
							<tfoot>
								<?php
									...
									$tr .= '<tr>
												<th colspan="9" class="text-right" id="th_jenis_bayar_'.$y.'">'.$tipe.'</th>
								...
								?>
								<tr>
									<th colspan="10" class="text-right">Total Penagihan Invoice</th>
								...
								<tr>
									<th colspan="10" class="text-right"><input type="hidden" class="form-control" id="total_bayar" name="total_bayar" value="<?=$total_invoice?>">Total Pembayaran</th>
									<th colspan="2" class="text-right" id="th_total_bayar"><?=formatrupiah($total_invoice)?></th>

								</tr>
								<tr>
									<th colspan="12" class="text-left" id="th_terbilang">Terbilang : # <?=terbilang($total_invoice)?> #</th>
								</tr>
							</tfoot>
						</table>    
