<?php
    ...
    echo form_open(base_url()."pembelian/outstanding_po_obat/save", $form_attr, $hidden);
...
<div class="tabbable-custom nav-justified">
	<ul class="nav nav-tabs nav-justified">
		<li class="active" >
			...
			Outstanding Pembelian Obat & Alkes</a>
		</li>
		<li>
			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Outstanding Pembelian Obat & Alkes", $this->session->userdata("language"))?></span>
					</div>
				</div>
				<div class="portlet-body form">
					<div class="form-body">
						<table class="table table-striped table-hover" id="table_outstanding_po_obat">
							<thead>
								<tr>
						...
						<div class="form-actions right">
							...
							</a>							<a id="button_tolak" class="btn btn-danger" href="<?=base_url()?>pembelian/outstanding_po_obat/tolak_permintaan" data-target="#modal_tolak_permintaan" data-toggle="modal">
			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("OS PO Obat/Alkes Proses Kasbon", $this->session->userdata("language"))?></span>
					</div>
				</div>
		...
		<div class="tab-pane" id="tab_pembelian_proses">
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-list font-blue-sharp bold"></i>
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Outstanding Pembelian Obat & Alkes Telah Diproses", $this->session->userdata("language"))?></span>
					</div>
				</div>
				<div class="portlet-body form">
					<div class="form-body">
						<table class="table table-striped table-hover" id="table_outstanding_po_obat_proses">
							<thead>
								<tr>
									<th class="text-center"><?=translate("ID", $this->session->userdata("language"))?> </th>
