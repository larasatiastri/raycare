...
class Pembayaran_status_online_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'pembayaran_status.waktu_akhir'     => 'waktu_akhir',
		'pembayaran_status.transaksi_id'  => 'transaksi_id',
		'pembayaran_status.status_revisi'          => 'status_revisi',
		'pembayaran_status.status_cancel'          => 'status_cancel',
		'pembayaran_status.status_keuangan'          => 'status_keuangan',
		'pembayaran_status.user_level_id'   => 'user_level_id',
		'pembayaran_status.divisi'          => 'divisi',
		'pembayaran_status.divisi'          => 'divisi',
	...
	{	
		$join1 = array('user_supplier' , $this->_table.'.created_by = user_supplier.id','left');
		$join4 = array('user_level b', $this->_table.'.user_level_id = b.id','left');
		$join5 = array('divisi db', $this->_table.'.divisi = b.id','left');
		$join6 = array('tanda_terima_faktur', $this->_table.'.transaksi_id = tanda_terima_faktur.id','left');
		$join7 = array('supplier', 'tanda_terima_faktur.supplier_id = supplier.id','left');
		$join8 = array('pembelian', 'tanda_terima_faktur.pembelian_id = pembelian.id','left');

 		$join_tables = array($join1, $join4, $join5, $join6, $join7, $join8);
		...
		$this->db->like($this->_table.'.transaksi_id','STF');
