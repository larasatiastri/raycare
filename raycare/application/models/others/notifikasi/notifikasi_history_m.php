...
class Notifikasi_history_m extends MY_Model
{
	protected $_table        = 'notifikasi_history';
	...
	protected $datatable_columns = array(
		...
		'notifikasi_history.id'                 => 'id', 
		'user.nama'                             => 'nama', 
		'user_level.nama'                       => 'nama_level', 
		'notifikasi_history.notifikasi_text'    => 'text', 
		'notifikasi_history.notifikasi_url'     => 'url', 
		'notifikasi_history.email_address'      => 'email_address',
		'notifikasi_history.is_active'          => 'is_active',
		'notifikasi_history.notifikasi_user_id' => 'user_id', 
	);
