    ...
    bootbox.confirm(msg, function(result) {
        if (result==true) {
            ...
            ({ 
                ...
                type: 'POST',
                url: mb.baseUrl() +  "klinik_hd/transaksi_dokter/simpanobservasi",  
                ...
                { 
                    ...
                    // oTableMonitoring.api().ajax.url(mb.baseUrl() +  'klinik_hd/transaksi_dokter/listing_monitoring/' + $("#tindakan_hd_id").val()).load();
                }
