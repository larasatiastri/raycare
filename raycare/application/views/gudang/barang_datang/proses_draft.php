								...
								<tr id="item_row_'.$i.'" class="table_item">
									...
									<td class="text-center">
										<span id="jumlah_pesan" class="control-label label bg-blue">
											<a class="jumlah_pesan" data-toggle="modal" data-target="#popup_modal_jumlah_pesan" href="'.base_url().'gudang/barang_datang/modal_jumlah_pesan/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'" style="cursor:pointer;color:#fff;">
												<span name="items['.$i.'][jumlah_pesan]"><b>'.intval($data_po['jumlah_pesan']).'</b></span>
											</a>
											'.' / '.'
											<a class="jumlah_pesan" name="items['.$i.'][jumlah_pesan_lain]" data-toggle="modal" data-target="#popup_modal_jumlah_pesan_supplier_lain" href="'.base_url().'gudang/barang_datang/modal_jumlah_pesan_supplier_lain/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'" style="cursor:pointer;color:#fff;">
									...
									<td class="text-center">
										<span id="jumlah_terima" class="control-label label bg-blue">
											<a class="jumlah_terima" data-toggle="modal" data-target="#popup_modal_jumlah_terima" href="'.base_url().'gudang/barang_datang/modal_jumlah_terima/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'" style="cursor:pointer;color:#fff;">
												<span name="items['.$i.'][jumlah_diterima]"><b>'.intval($jumlah_pesan_terima).'</b></span>
											</a>
											'.' / '.'
											<a class="jumlah_terima" data-toggle="modal" data-target="#popup_modal_jumlah_terima_supplier_lain" href="'.base_url().'gudang/barang_datang/modal_jumlah_terima_supplier_lain/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'" style="cursor:pointer;color:#fff;">
									...
									<td class="text-center inline-button-table">
										<a class="btn blue-chambray pemisahan_item" href="'.base_url().'gudang/barang_datang/add_terima_barang/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.intval($data_po['jumlah_pesan']).'/item_row_'.$i.'/'.$draft_detail_id[$z]['draft_pmb_detail_id'].'/'.$draft_pmb_id.'/'.$supplier_id.'/'.$gudang_id.'"><i class="fa fa-edit"></i></a>
						...
						$pembelian_detail = '<td class="text-center">
									...
									<td class="text-center jumlah_pesan">
										<label id="jumlah_pesan" class="control-label">
											<a class="jumlah_pesan" name="items[{0}][jumlah_pesan]" data-toggle="modal" data-target="#popup_modal_jumlah_pesan" href="'.base_url().'gudang/barang_datang/modal_jumlah_pesan/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'" style="cursor:pointer;color:#333;">
												<span name="items[{0}][jumlah_pesan]"><b>'.intval(0).'</b></span>
											</a>
											'.' / '.'
											<a class="jumlah_pesan" name="items[{0}][jumlah_pesan_lain]" data-toggle="modal" data-target="#popup_modal_jumlah_pesan_supplier_lain" href="'.base_url().'gudang/barang_datang/modal_jumlah_pesan_supplier_lain/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'" style="cursor:pointer;color:#333;">
									...
									<td class="text-center jumlah_terima">
										<label id="jumlah_terima" class="control-label">
											<a class="jumlah_terima" name="items[{0}][jumlah_diterima]" data-toggle="modal" data-target="#popup_modal_jumlah_terima" href="'.base_url().'gudang/barang_datang/modal_jumlah_terima/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.$url_po_id.'" style="cursor:pointer;color:#333;">
												<span name="items[{0}][jumlah_diterima]"><b>'.intval(0).'</b></span>
											</a>
											'.' / '.'
											<a class="jumlah_terima" name="items[{0}][jumlah_diterima_lain]" data-toggle="modal" data-target="#popup_modal_jumlah_terima_supplier_lain" href="'.base_url().'gudang/barang_datang/modal_jumlah_terima_supplier_lain/'.$supplier_id.'/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'" style="cursor:pointer;color:#333;">
									...
									<td class="text-center inline-button-table">
										<a class="btn blue-chambray pemisahan_item" href="'.base_url().'gudang/barang_datang/add_terima_barang/'.$data_po['item_id'].'/'.$data_po['item_satuan_id'].'/'.intval($data_po['jumlah_pesan']).'/item_row_'.$i.'/'.$draft_detail_id[0]['draft_pmb_detail_id'].'/'.$draft_pmb_id.'/'.$supplier_id.'/'.$gudang_id.'"><i class="fa fa-chain-broken"></i></a>
