									...
									<?php
										...
										if(count($data_invoice) != 0){
											...
											foreach ($data_invoice as $key => $bon) {
												...
												$form_upload_inv .= '<td><a class="fancybox-button" title="'.$bon->url_faktur_pajak.'" href="'.config_item('site_img_bayar').$data_bayar->id.'/'.$bon->url_faktur_pajak.'" data-rel="fancybox-button"><img src="'.config_item('site_img_bayar').$data_bayar->id.'/'.$bon->url_faktur_pajak.'" alt="Smiley face" class="img-responsive" ></a></td>';
												}
