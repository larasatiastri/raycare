...
(function(o){
     ...
     var 
        ...
        id_paket_batch      = $('input#id_paket_batch').val()
    ...
    var handleDataTableItems = function(){
       ...
       oTable = $tablePaketItem.dataTable({
            ...
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_paket_item_batch_edit/' + paket_id + '/' + id_paket_batch,
                'type' : 'POST',
            },          
            'pageLength'            : 10,
    ...
    var handleDataTableItemsTitipan = function(){
        ...
        oTable2 = $tablePaketTindakan.dataTable({
            ...
            'language'              : mb.DTLanguage(),
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_paket_tindakan_batch_edit/' + paket_id + '/' + id_paket_batch,
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            'lengthMenu'            : [[10, 25, 50, 100], [10, 25, 50, 100]],
