...
class Penerima_customer_m extends MY_Model {
	...
	{	
		...
		$join2 = array('inf_lokasi', 'customer_alamat.kode_lokasi = inf_lokasi.lokasi_kode','left');
		$join3 = array('customer_telepon', $this->_table.'.id = customer_telepon.customer_id');
