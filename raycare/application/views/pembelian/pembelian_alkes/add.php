<?php
	...
	if($data_item != '')
	{
		...
		foreach ($data_item as $key => $detail) 
		{
			...
			$btn_jumlah_db  = '<a class="btn blue-chambray add-jumlah" href="'.base_url().'pembelian/pembelian_alkes/add_jumlah/item_row_{0}" data-original-title="Tambah Jumlah" title="'.translate('Tambah Jumlah', $this->session->userdata('language')).'" data-toggle="modal" data-target="#popup_modal_jumlah" ><i class="fa fa-truck"></i></a>';
	...
	$btn_search        = '<a class="btn btn-primary search-item" data-original-title="Search Item" data-status-row="item_row_add" title="'.translate('Pilih Item', $this->session->userdata('language')).'"><i class="fa fa-search"></i></a>';
	$btn_jumlah        = '<a class="btn blue-chambray add-jumlah" href="'.base_url().'pembelian/pembelian_alkes/add_jumlah/item_row_{0}" data-original-title="Tambah Jumlah" title="'.translate('Tambah Jumlah', $this->session->userdata('language')).'" data-toggle="modal" data-target="#popup_modal_jumlah"  disabled><i class="fa fa-truck"></i></a>';
							...
							<table class="table table-striped table-bordered table-hover" id="table_detail_pembelian">
								...
								<tfoot>
									...
									<tr>
										...
										<td>
											<a class="btn blue-chambray add-biaya" title="<?=translate('Tambah Biaya', $this->session->userdata('language'))?>" href="<?=base_url()?>pembelian/pembelian_alkes/add_biaya" data-toggle="modal" data-target="#modal_biaya">
