...
<body>
	<div id="header" style="padding-top:30px;background-color:#FFF;border-bottom:1px solid #2462AC;">
		<?php 
			if (file_exists(FCPATH."assets/mb/global/image/logo/logo-big-apotik.png") && is_file(FCPATH."assets/mb/global/image/logo/logo-big-apotik.png")) 
	        {
	            $image_header = base_url()."assets/mb/global/image/logo/logo-big-apotik.png";
	        }
	        else 
	        {
