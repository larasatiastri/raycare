<form action="#" id="form_send_po" class="form-horizontal">
        <div class="modal-header">
            ...
            <div class="caption">
                <span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Batalkan PO ".$data_po['no_pembelian'], $this->session->userdata("language"))?></span>
            </div>
        </div>
...
<script>
    ...
    function handleFinishPO(){
        $('a#modal_ok').click(function() {
            ...
            $.ajax({
                type     : 'POST',
                url      : mb.baseUrl() + 'pembelian/pembelian_alkes/cancel_po',
