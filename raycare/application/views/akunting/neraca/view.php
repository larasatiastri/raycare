                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="background-color: #357ebd;">
                                    ...
                                    <th width="25%" class="text-right"><?=formatrupiah($liability['nominal'])?></th>
                                </tr>
                            <?php  
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td width="25%" class="text-right"><?=formatrupiah($current['liability'])?></td>
                                </tr>
                            <?php       
                                }
                                $i++;
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="background-color: #357ebd;">
                                    ...
                                    <th width="25%" class="text-right"><?=formatrupiah($equity['nominal'])?></th>
                                </tr>
                            <?php   
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td width="25%" class="text-right"><?=formatrupiah($equity['nominal'])?></td>
                                </tr>
                            <?php       
                                }
                                $i++;
