...
class Faskes_temp_m extends MY_Model {

	protected $_table      = 'faskes_temp';
    ...
    public function get_data_faskes($id)
    {
    	$format = "SELECT
					faskes.id,
					faskes.marketing_id,
					...
					user_level.nama as nama_marketing
					FROM
					faskes
					LEFT JOIN `user` ON faskes.marketing_id = `user`.id
