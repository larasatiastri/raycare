<?php
	...
	if($data_item != '')
	{
		...
		foreach ($data_item as $key => $detail) 
		{
			...
			$btn_jumlah_db  = '<a class="btn blue-chambray add-jumlah" href="'.base_url().'pembelian/pembelian/add_jumlah/item_row_{0}" data-original-title="Tambah Jumlah" title="'.translate('Tambah Jumlah', $this->session->userdata('language')).'" data-toggle="modal" data-target="#popup_modal_jumlah" ><i class="fa fa-truck"></i></a>';

			$item = $this->item_m->get_by(array('id' => $detail), true);
			$item = object_to_array($item);

			$item_satuan_data = $this->item_satuan_m->get_by(array('id' => $data_item_satuan[$key]), true);
			$item_satuan_data = object_to_array($item_satuan_data);
			...
			if($supplier_item->is_harga_flexible == 0) {
				$attrs_item_harga_db['readonly'] = 'readonly';
			}elseif($supplier_item->is_harga_flexible == 1) {
			...
			if($supplier_item->is_pph == 1){
				$total_pph_23 = $total_pph_23 +  (($persen_pph/100)*($data_jumlah[$key] *$supplier_harga[0]['harga']));
			}
			...
			$item_cols_db = array(// style="width:156px;
				...
				'item_satuan'        => '<label class="control-label" name="items['.$i.'][nama_item_nama]">'.$item_satuan_data['nama'].'</label>'. form_dropdown('items['.$i.'][satuan_id]', $satuan_option,$data_item_satuan[$key], 'id="items_satuan_'.$i.'" data-row="'.$i.'" class="form-control satuan hidden"'),
	...
	$item_cols = array(// style="width:156px;
		...
		'item_total'         => '<div class="text-right" style="min-width:150px;"><label class="control-label" name="items[{0}][item_sub_total]"></label></div>'.form_input($attrs_item_total).form_input($attrs_per_item_total),
		'action'             => $btn_del.form_input($attrs_is_pph),
	);
				...
				<div class="col-md-3">
					<div class="portlet box blue-sharp">
						<div class="portlet-title"  style="margin-bottom: 0px !important;">
							<div class="caption"><?=translate("Supplier", $this->session->userdata("language"))?></div>						
						</div>
						...
						<input type="hidden" id="jumlah_item" name="jumlah_item" value="<?=$i?>">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<div class="radio-list">
												...
												<input type="radio" name="tipe_supplier" id="tipe_supplier_1" value="1" checked> <?=translate("DN", $this->session->userdata("language"))?> </label>
												<label class="radio-inline">
												<input type="radio" name="tipe_supplier" id="tipe_supplier_2" value="2"> <?=translate("LN", $this->session->userdata("language"))?> </label>
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<?php
													...
													$is_pph_supp = array(
														...
														"name"        => "is_pph_supp",
														"class"       => "form-control hidden",
														"value"  		=> (count($data_supplier) != 0)?$data_supplier[0]['is_pph']:0,
													);
													echo form_input($is_pph_supp);
							...
							<div class="portlet-title"  style="margin-bottom: 0px !important;">
								<div class="caption"><?=translate("Informasi", $this->session->userdata("language"))?></div>						
							</div>
							<div class="portlet-body">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-12 bold"><?=translate("Tgl Pesan", $this->session->userdata("language"))?> :</label>
											<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-12 bold"><?=translate("Kirim Satu Tgl", $this->session->userdata("language"))?> :</label>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<div class="input-group date">
													<input type="text" class="form-control" id="tanggal_garansi" name="tanggal_garansi" value="<?=date('d M Y')?>" readonly >
													<span class="input-group-btn">
														<button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
													</span>
												</div>
									...
									<div class="col-md-6">
										<div class="form-group" id="tgl_kirim">
											<label class="col-md-12 bold"><?=translate("Tanggal Kirim", $this->session->userdata("language"))?> :</label>
											<div class="col-md-12">
												<div class="input-group date">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group" hidden>
											...
											<div class="col-md-12">
												<div class="input-group date">
													<input type="text" class="form-control" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" value="<?=date('d M Y' , strtotime("+2 weeks"))?>" readonly >
													<span class="input-group-btn">
														<button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
													</span>
												</div>
							...
							<div class="portlet-title"  style="margin-bottom: 0px !important;">
								<div class="caption"><?=translate("Penerima", $this->session->userdata("language"))?></div>						
							</div>
							<div class="portlet-body">
								<div class="row">
					...
					<div class="portlet box blue-madison">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								...
								<table class="table table-striped table-hover" id="table_penawaran">
									<thead>
										<tr>
							...
							<table class="table table-striped table-hover" id="table_detail_pembelian">
								<thead>
									<tr>
										...
										<th class="text-center" width="10%"><?=translate("Harga Sistem", $this->session->userdata("language"))?> </th>
								...
								<tfoot>
									...
									<tr>
										<td colspan="5" class="text-right bold" style="background-color:#f9f9f9">Diskon</td>
									...
									<tr>
										<td colspan="6" class="text-right bold">Total Setelah Diskon</td>
										<td colspan="2">
											<div class="input-group col-md-12">
												<span class="input-group-addon">
													&nbsp;IDR&nbsp;
									...
									<tr>
										<td colspan="5" class="text-right bold" style="background-color:#f9f9f9">PPN</td>
										<td style="background-color:#f9f9f9">
											<div class="input-group col-md-12">
												<input class="form-control text-right" type="number" value="0" min="0" max="100" id="pph" name="pph" value="<?=$persen_ppn?>">
												<span class="input-group-addon">
													&nbsp;%&nbsp;
												</span>
											</div>
									...
									<tr>
										...
										<td colspan="2">
											<div class="input-group col-md-12">
												...
												<input class="form-control text-right" readonly value="<?=$total_pph_23?>" id="total_pph_23" name="total_pph_23">
											</div>
											<input class="form-control text-right hidden" readonly value="<?=$total_pph_23?>" id="total_pph_23_hidden" name="total_pph_23_hidden">
										</td>
									</tr>
									
									<tr class="hidden">
										<td colspan="6" class="text-right bold" style="background-color:#f9f9f9">Pembulatan</td>
										<td colspan="2" style="background-color:#f9f9f9">
											<div class="input-group col-md-12">
												<span class="input-group-addon">
													&nbsp;IDR&nbsp;
									...
									<tr>
										<td colspan="5" class="text-right bold" style="background-color:#f9f9f9">DP</td>
										<td style="background-color:#f9f9f9">
											<div class="input-group col-md-12">
									...
									<tr>
										<td colspan="5" class="text-right bold" style="background-color:#f9f9f9">Biaya Tambahan<div id="biaya_tambahan" class="hidden"></div></td>
										<td style="background-color:#f9f9f9">
											<a class="btn blue-chambray add-biaya" title="<?=translate('Tambah Biaya', $this->session->userdata('language'))?>" href="<?=base_url()?>pembelian/pembelian/add_biaya" data-toggle="modal" data-target="#modal_biaya">
								...
								<table class="table table-striped table-hover" id="table_detail_pembelian">
									<thead>
										<tr>
											...
											<th colspan="2" class="text-center" width="5%"><?=translate("Denda/Hari", $this->session->userdata("language"))?> </th>
											<th class="text-center" width="5%"><?=translate("Adm Denda", $this->session->userdata("language"))?> </th>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<td rowspan="1" colspan="1">
											<div class="input-group right" style="min-width:160px;">
												<span class="input-group-addon">
													&nbsp;IDR&nbsp;
												</span>
										...
										<td rowspan="1" colspan="1" width="3%">
											<div class="input-group right" style="min-width:95px;">
												<input id="denda_persen" name="denda_persen" class="form-control" type="text" value="">
												<span class="input-group-addon">
													&nbsp;%&nbsp;
												</span>
											</div>
										...
										<td rowspan="1" colspan="1">
											<div class="input-group right" style="min-width:150px;">
												...
												<input id="denda_nominal" name="denda_nominal" class="form-control" type="text" value="">
											</div>
										</td>
										<td rowspan="1" colspan="1">
											<div class="input-group right" style="min-width:150px;">
												...
												<input id="denda_adm" name="denda_adm"  class="form-control" type="text" value="">
											</div>
										</td>
...
<div id="popover_item_content" class="row" style="display:none;">
    <div class="col-md-12">
        <table class="table table-condensed table-striped table-hover" id="table_pilih_supplier">
            <thead>
                <tr>
...
<div id="popover_penerima_content_cabang" class="row" style="display:none;">
    <div class="col-md-12">
        <table class="table table-condensed table-striped table-hover" id="table_pilih_cabang">
            <thead>
                <tr>
                    <th><div class="text-center"><?=translate('ID', $this->session->userdata('language'))?></div></th>
...
<div id="popover_penerima_content_customer" class="row" style="display:none;">
    <div class="col-md-12">
        <table class="table table-condensed table-striped table-hover" id="table_pilih_customer">
            <thead>
                <tr>
                    <th><div class="text-center"><?=translate('ID', $this->session->userdata('language'))?></div></th>
                    <th><div class="text-center"><?=translate('Kode', $this->session->userdata('language'))?></div></th>
...
<div id="popover_item_content_pembelian" class="row" style="display:none;">
    <div class="col-md-12">
        <table class="table table-condensed table-striped table-hover" id="table_item_search">
            <thead>
                <tr>
                    <th><div class="text-center"><?=translate('Id', $this->session->userdata('language'))?></div></th>
                    <th><div class="text-center"><?=translate('Kode', $this->session->userdata('language'))?></div></th>
...
<div id="popover_jumlah_pesan" class="row" style="display:none;">
    <div class="col-md-12">
		<div class="portlet">
			...
			<div class="portlet-body">
        		<table class="table table-condensed table-striped table-hover" id="table_search_permintaan">
		            <thead>
		                <tr role="row">
