						...
						<div class="col-md-3">
							...
							<div class="portlet box blue-sharp">
								...
								<div class="portlet-body">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-12">
														...
														<input class="form-control input-sm hidden" id="nomer_{0}" name="cabang_id" value="<?=$this->session->userdata('cabang_id')?>" placeholder="Kasir Titip Uang ID">
									...
									<div class="form-group">
											<label class="col-md-12 bold"><?=translate("Jenis Permintaan", $this->session->userdata("language"))?> :</label>
											
											<div class="col-md-12">
												<div class="radio-list">
													<label class="radio-inline">
													<input type="radio" name="jenis_permintaan" id="optionskirimya" value="1" checked="checked"> Umum </label>
													<label class="radio-inline">
													<input type="radio" name="jenis_permintaan" id="optionskirimtdk" value="2"> Obat &amp; Alkes </label>
