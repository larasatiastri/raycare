<?php
    ...
    $user_level_minta = $this->user_level_m->get($user_level_id);
     ...
     if($form_data_persetujuan['status'] == 1)
    {
        $status = '<span class="label label-md label-warning">Menunggu Persetujuan</span>';
    
    } elseif($form_data_persetujuan['status'] == 2){

        $status = '<span class="label label-md label-info">Dibaca</span>';

    }elseif($form_data_persetujuan['status'] == 3 || $form_data_persetujuan['status'] == 8){

        $status = '<span class="label label-md label-success">Disetujui</span>';

    } elseif($form_data_persetujuan['status'] == 4 || $form_data_persetujuan['status'] == 19){

        $status = '<span class="label label-md label-danger">Ditolak</span>';
    } elseif($form_data_persetujuan['status'] == 5 || $form_data_persetujuan['status'] == 18){

        $status = '<span class="label label-md label-success">Diproses</span>';
    } elseif($form_data_persetujuan['status'] == 16 ){
						    ...
						    <div class="portlet-body">
                                ...
                                <div class="form-group">
									<label class="col-md-12 bold">
										<?=translate("Status", $this->session->userdata("language"))?> :
									</label>		
