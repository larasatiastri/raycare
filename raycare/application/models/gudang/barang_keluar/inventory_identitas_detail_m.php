...
class Inventory_identitas_detail_m extends MY_Model {
	...
	public function delete_inventory_identitas_detail($id)
	{
		$format = "DELETE FROM inventory_identitas_detail WHERE inventory_identitas_id = $id";
	...
	public function count_identitas_detail($inventory_identitas_id) {

		$format = "SELECT COUNT(1) 
					FROM inventory_identitas_detail
					WHERE inventory_identitas_id = $inventory_identitas_id ";
