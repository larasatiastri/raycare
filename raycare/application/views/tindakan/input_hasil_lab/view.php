...
<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="actions">
			<a class="btn btn-circle btn-primary" href="<?=base_url()?>tindakan/input_hasil_lab">
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				<table class="table table-striped table-hover" id="table_detail_periksan">
					...
					?>
						<tr>
							<td><?=$periksa_lab->nama?></td>
							<td><?=$detail['hasil']?></td>
							<td><?=$periksa_lab_detail->nilai_normal_bawah.' - '.$periksa_lab_detail->nilai_normal_atas?></td>
							<td><?=$periksa_lab->satuan?></td>
				...
				?>
					<ul class="list-inline blog-images" style="display: inline;" id="upload_sign">               
						<li>                
						<a class="fancybox-button" target="_blank" title="<?=$dokumen['url']?>" href="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/tindakan/input_hasil_lab/images/<?=$dokumen['hasil_lab_id']?>/<?=$dokumen['url']?>" data-rel="fancybox-button"><img src="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/tindakan/input_hasil_lab/images/<?=$dokumen['hasil_lab_id']?>/<?=$dokumen['url']?>" alt="Tidak ditemukan"></a> <span></span>
						</li> 
					</ul>
				<?php
					endforeach;				
