...
(function(o){
    ...
    var
        ...
        gambarCounter              = $('input#gambar_counter').val(),
        ...
        identitasCounter     = parseInt($('input#jml_identitas').val()),
    ...
    var initForm = function(){
        ...
        $.each(formsIdentitas, function(idx, form){
            // handle button add
            var $btnTambahIdentitas = $('a#tambah_identitas', form.section);
            $btnTambahIdentitas.click(function(){
                addFieldsetIdentitas(form);
            });
        });
        

        $.each($('.url_gambar'), function(idx){
            // alert($(this).data('id'));
            var id = $(this).data('id');
            handleUploadify(id);
        });
    ...
    var addFieldsetGambar = function(form)
    {
        ...
        $('input[name="gambar_is_primary"]', $newFieldset).on('click', function()
        {
            ...
            $('.primary_gambar div.radio span').removeClass('checked');
    ...
    var handleDeleteDbGambar = function(form, id, msg){
        ...
        bootbox.confirm(msg, function(result) {
            ...
            if (result==true) {
                ...
                $('input#gambar_is_delete_' + id).val(1);
            }
        });
    }
    ...
    var handleDataTableModal = function(){
        ...
        $tableHargaItemSatuanModal.dataTable({
            ...
            'columns'               : [
                ...
                { 'name':'item_satuan.nama nama','visible' : true, 'searchable': false, 'orderable': true },
                { 'name':'item_harga.harga harga','visible' : true, 'searchable': true, 'orderable': true },
    ...
    var handleGambarIsPrimary = function(){

        $('input[name="gambar_is_primary"]').on('click', function()
        {   
            var id = $(this).data('id');
    ...
    var handleSetSale = function(){
        if( $('input#is_sale').is(':checked') ){
            $('li.penjualan').removeClass('hidden');
        }else{
            $('li.penjualan').addClass('hidden');
        }
    ...
    var handleSetIdentitas = function(){
        if( $('input#is_identitas').is(':checked') ){
            $('li.identitas').removeClass('hidden');
        }else{
            $('li.identitas').addClass('hidden');
        }
