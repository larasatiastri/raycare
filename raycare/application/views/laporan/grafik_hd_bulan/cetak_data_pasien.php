<?php
	...
	$start_muncul = str_replace('%20', '-' , $start);
?>
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-list font-blue-sharp"> </i>
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Data Pasien Aktif Tindakan Bulan ", $this->session->userdata("language")).date('M Y', strtotime($start_muncul))?></span>
		</div>
		<div class="actions">
          
				<a href="<?=base_url()?>laporan/grafik_hd_bulan" class="btn default"> <i class="fa fa-chevron-left"></i> 
	           		<span class="hidden-480">
	                     <?=translate("Kembali", $this->session->userdata("language"))?>
	                </span>
	            </a>
	            <a href="<?=base_url()?>laporan/grafik_hd_bulan/csv/<?=$start?>/<?=$penjamin_id?>/<?=$tipe?>" class="btn default"> <i class="fa fa-print"></i> 
	           		<span class="hidden-480">
