<?php
	$form_attr = array(
	    "id"            => "form_view_setoran", 
	    "name"          => "form_view_setoran", 
	    "autocomplete"  => "off", 
				...
				<div class="portlet-body form">
					<div class="form-body">
						<div class="form-group">
						    ...
						    <input type="hidden" id="tanggal_setor" value="<?=date('d M Y', strtotime($form_data['tanggal_setor']))?>"></input>
		              	...
		              	<div class="form-group">
						    ...
						    <input type="hidden" id="tanggal" value="<?=date('d M Y', strtotime($form_data['tanggal']))?>"></input>
						...
						<div class="form-group">
						    ...
						    <input type="hidden" id="tipe" value="<?=$form_data['shift']?>"></input>
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								...
								<div id="upload">
									...
									<ul class="ul-img">
									<li class="working"><div class="thumbnail"><a class="fancybox-button" title="<?=$form_data['url_bukti_setor']?>" href="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/kasir/setoran_kasir/images/<?=$pk_value?>/<?=$form_data['url_bukti_setor']?>" data-rel="fancybox-button"><img src="<?=config_item('base_dir')?>cloud/<?=config_item('site_dir')?>pages/kasir/setoran_kasir/images/<?=$pk_value?>/<?=$form_data['url_bukti_setor']?>" alt="Smiley face" class="img-thumbnail" style="max-width:200px; max-height:200px;"></a></div><span></span></li>
									</ul>
						...
						<div class="table-responsive">
                            <table class="table table-condensed table-striped table-hover" id="table_invoice">
                                <thead>
                                    ...
                                    <th class="text-center" width="15%"><?=translate("Jumlah Bayar", $this->session->userdata('language'))?></th>
                                </thead>
                                <tbody>
                                </tbody>
                            </table>
