<?php
	...
	echo form_open(base_url()."reservasi/titip_terima_uang", $form_attr, $hidden);
?>
<div class="row">
	<div class="col-md-12">
		<div class="portlet light">
			<div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?=base_url()?>reservasi/titip_terima_uang/add" class="btn btn-primary">
		...
		<div class="portlet light">
			<div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?=base_url()?>reservasi/titip_terima_uang/add_terima_uang" class="btn btn-primary">
                        <i class="fa fa-plus"></i>
                        <span class="hidden-480">
                             <?=translate("Tambah", $this->session->userdata("language"))?>
                        </span>
