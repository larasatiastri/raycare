    ...
    bootbox.confirm(msg, function(result) {
        if (result==true) {
            ...
            ({ 
                ...
                type: 'POST',
                url: mb.baseUrl() +  "klinik_hd/edit_transaksi/updateobservasi",  
                data:  {jam:$("#waktu").val(),tda:$("#tekanan_darah_1").val(),tdb:$("#tekanan_darah_2").val(),ufg:$("#ufg_").val(),ufr:$("#ufr_").val(),ufv:$("#ufv_").val(),qb:$("#qb_").val(),userid:$("#perawat_id").val(),keterangan:$("#keterangan_").val(),id_observasi:$("#monitoring_id").val()},  
                dataType : 'json',
