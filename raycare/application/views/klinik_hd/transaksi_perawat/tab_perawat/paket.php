<div class="portlet light">
	...
	<div class="portlet-title">
		...
		<div class="actions">
			<a class="btn btn-circle btn-primary" id="modalpacket" data-toggle="modal" data-target="#modal_paket"  href="<?=base_url()?>klinik_hd/transaksi_perawat/modal_paket/0/0/0/1/0"><i class="fa fa-plus"></i> <?=translate("Tambah Paket", $this->session->userdata("language"))?></a>
			 <a class="btn btn-primary reload-table2 hidden" title=""><i class="fa fa-undo"></i></a>
		</div>
	</div>
