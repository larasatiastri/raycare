...
class kcc_paket_fpdf extends FPDF
{
	

	function KCC_PAKET_FPDF($orientation='P', $unit='mm', $size='A4')
	{
	...
	function Header($data_header)
	{
		...
		//NAMBAHIN LOGO
		// $image_header = base_url()."assets/img/header.png";
		// $this->Cell( 40, 40, $this->Image($image_header, $this->GetX()+5, $this->GetY()+3, 70,13), 0, 0, 'L', false );
		// $this->Ln(3);
	    ...
	    $this->Cell(0,0,"TANDA TERIMA JASA HEMODIALISA",0,0,'C');
		$this->Ln(4);
