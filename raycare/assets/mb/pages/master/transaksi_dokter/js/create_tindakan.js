...
(function(o){
    ...
    var handletabbutn1 = function(){
     ...
     var handlehistoribtn = function(){
        $('#histori').click(function() {
            ...
            $("#act2").show();
        $("#act1").hide();
          oTable4.api().ajax.url(baseAppUrl + 'listing4/1/2').load();
          oTable5.api().ajax.url(baseAppUrl + 'listing4/2/2').load();
    ...
    var handlehistoribtn2 = function(){
        ...
        $("#act2").hide();
        $("#act1").show();
          oTable4.api().ajax.url(baseAppUrl + 'listing4/1/1').load();
          oTable5.api().ajax.url(baseAppUrl + 'listing4/2/1').load();
    ...
    var addItemRow2 = function(tabel,counter,text,value){
        var numRow = $('tbody tr', $tableOrderItem).length;
 ...
 handleDTsyarat();
    ...
    var handleDTItems2 = function(){
       ...
       $("#table_cabang").dataTable({
            ...
            'language'              : mb.DTLanguage(),
            'ajax'                  : {
                'url' : baseAppUrl + 'listing2' + '/' + $("#pk").val(),
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            'lengthMenu'            : [[10, 25, 50, 100], [10, 25, 50, 100]],
    ...
    $('input[name$="[dokumen]"]', table).uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                {
                                    $('label[name$="[choosen_file_1]"]', table).html("<img src="+ mb.baseUrl() + "assets/mb/pages/master/klaim_asuransi/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
...
var uploadfile2 = function(table) {
    ...
    $('#uploaddokumen').uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                if(param2=='jpg' || param2=='jpeg' || param2=='png' || param2=='gif')
                                {
                                    $('#uploadchoosen_file_1').html("<img src="+ mb.baseUrl() + "assets/mb/pages/master/transaksi_dokter/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
 ...
 var handleDatePickers = function () {
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'master/transaksi_dokter/';
