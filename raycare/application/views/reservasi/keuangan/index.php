		...
		<div class="form-body">
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Laporan Keuangan", $this->session->userdata("language"))?></span>
					</div>
					<div class="actions">
				  
	            <a href="<?=base_url()?>reservasi/keuangan/add" class="btn btn-primary" >
			...
			<div class="portlet light">
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover" id="table_laporan_keuangan">
						<thead>
							...
							<tr class="heading">
			                    ...
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Debit", $this->session->userdata("language"))?></th>
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Kredit", $this->session->userdata("language"))?></th>
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Saldo", $this->session->userdata("language"))?></th>
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Saldo", $this->session->userdata("language"))?></th>
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Saldo", $this->session->userdata("language"))?></th>
			                    <th class="text-center" style="width : 250px !important;"><?=translate("Saldo", $this->session->userdata("language"))?></th>
						...
						<tfoot>
							<tr class="footer">
								...
								<td class="text-right"><div id="totalbiaya1"></div></td>
								<td class="text-right"><div id="totalbiaya2"></div></td>
								<td class="text-right"><div id="totalbiaya3"></div></td>
							</tr>
