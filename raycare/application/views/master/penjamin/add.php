...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Informasi Penjamin", $this->session->userdata("language"))?></span>
		</div>
		...
		<div class="actions">	
			...
			<a id="confirm_save" class="btn btn-circle btn-primary" href="#" data-confirm="<?=$msg?>" data-toggle="modal"><i class="fa fa-floppy-o"></i> <?=translate("Simpan", $this->session->userdata("language"))?></a>
			...
			<div class="form-body">
			    ...
			    <div class="alert alert-success display-hide">
			 	...
			 	<div class="form-group">
					...
					<input type="hidden" id="suspval" name="suspval" value="0">
					<div class="checkbox-list">
						<label>
							<input type="checkbox" id="susp" name="susp" value="1">
							<?=translate("Suspended", $this->session->userdata("language"))?>
						</label>						
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3"><?=translate("Masuk Kelompok", $this->session->userdata("language"))?> :</label>
					<div class="col-md-3">
						<div class="radio-list">
							<label class="radio-inline">
								<input type="radio" class="" name="kel" id="kel1" value="1">
								<?=translate("Ya", $this->session->userdata("language"))?>
							</label>
							<label class="radio-inline">
								<input type="radio" class="" name="kel" id="kel2" value="2" checked>
								<?=translate("Tidak", $this->session->userdata("language"))?>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
				    ...
				    <div class="col-md-2">
				    	<div class="input-group input-medium-date date date-picker">
							...
							<input class="form-control" id="date1" name="tggl1" readonly value="<?=date('d F Y')?>">
