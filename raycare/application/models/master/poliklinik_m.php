...
class Poliklinik_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'poliklinik.kode'         => 'kode', 
		'poliklinik.nama'   => 'nama', 
		'poliklinik.keterangan'   => 'keterangan',
		//'poliklinik.is_active'     => 'is_active',
		'poliklinik.id'     => 'id'
	...
	public function getdataall($id){
		$sql= "select a.id,a.nama from poliklinik a join cabang_poliklinik b on a.id=b.poliklinik_id where b.cabang_id=?  and a.is_active=1 and b.is_active=1";
