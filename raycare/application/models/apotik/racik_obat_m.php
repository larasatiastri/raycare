...
class Racik_obat_m extends MY_Model {
	...
	public function get_data_racik_obat_manual($id){
		$format = "SELECT
					...
					racik_obat.jumlah_produksi,
					racik_obat.satuan_produksi,
	...
	public function get_komposisi_racikan($id){
		$format = "SELECT
					...
					LEFT JOIN inventory ON racik_obat_detail.item_id = inventory.item_id AND racik_obat_detail.item_satuan_id = inventory.item_satuan_id
					WHERE
					racik_obat.id = $id
					GROUP BY
					item.id";
