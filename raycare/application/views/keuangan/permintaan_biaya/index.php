...
<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="actions">
			<a class="btn btn-default btn-circle" href="<?=base_url()?>keuangan/permintaan_biaya/history">
				<i class="fa fa-history"></i> 
				<?=translate('History', $this->session->userdata('language'))?>
			</a>
			<a class="btn btn-default btn-circle" href="<?=base_url()?>keuangan/permintaan_biaya/add">
	...
	<div class="portlet-body">
		...
		<table class="table table-striped table-hover" id="table_permintaan_biaya">
			<thead>
			<tr>
