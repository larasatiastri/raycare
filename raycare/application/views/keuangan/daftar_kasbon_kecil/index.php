...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Daftar Kasbon Kurang Dari Satu Juta", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">
	...
	<div class="portlet-body">
		...
		<table class="table table-striped table-bordered table-hover" id="table_permintaan_biaya">
			<thead>
			<tr>
