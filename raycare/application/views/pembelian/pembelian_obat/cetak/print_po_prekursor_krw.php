...
<body>
	...
	<div id="body">
		<div class="head-title" style="padding:40px 113px 0 113px;">
			<div class="title" style="border-bottom:1px solid #000;font-size:16px;" align="center"><b>SURAT PESANAN OBAT MENGANDUNG PREKURSOR FARMASI</b></div>
		...
		<div style="background-color:red !important;height:30px;width:100%;margin-top:15px;">
			<div style="float:left;height:30px;width:700px;padding-top:15px;">		
				<table id="head_content" border="0">
					...
					<tr>
						...
						<td style="vertical-align:top;" width="350px">Kepala Instalasi Farmasi</td>
					</tr>
					<tr>
			...
			<table id="head_content" border="0">	
					<tr>
						<td style="vertical-align:top;" width="700px;" colspan="3">Mengajukan pesanan obat mengandung Prekursor Farmasi kepada :</td>
					</tr>
					<tr>
						<td style="height:6px;"></td>
					</tr>
		...
		<div id="text">Jenis obat mengandung Prekursor Farmasi yang dipesan adalah :</div>
		...
		<table id="body_content" class="table" style="border:1px solid #2462AC !important;">
			<tr>
				...
				<th width="27%;" class="text-center" style="background:#2462AC;color:#fff;">Nama Obat Mengandung Prekursur Farmasi</th>
				<th width="30%;" class="text-center" style="background:#2462AC;color:#fff;">Zat Aktif Prekursor Farmasi</th>
		...
		<div style="margin-bottom:5px;">Obat mengandung Prekursor Farmasi tersebut akan digunakan untuk memenuhi kebutuhan :</div>

		<div style="float:left;height:30px;width:700px;padding-right:250px;">	
			<table id="body_info" border="0">
				<tr>
					<td width="140px">Nama Klinik</td>
					<td width="8px">:</td>
					<td width="350px" colspan="3">Klinik Raycare Karawaci</td>
				</tr>
				<tr>
					<td width="80px">Alamat Lengkap</td>
					<td width="6px">:</td>
					<td width="350px" colspan="3">Jl. Imam Bonjol No. 1 Sukajadi Karawaci - Tangerang Kota 15115</td>
				</tr>
				<tr>
					<td width="80px" height="20px"></td>
				</tr>
				<tr>
					<td width="80px">Surat Ijin Klinik</td>
					<td width="6px">:</td>
					<td width="350px" colspan="3">445.5/Kep-52/BPMPTSP/KLINIK/2016</td>
				</tr>
		...
		<div style="float:right;height:30px;width:207px;">
				<table id="head_info">
					<tr>
						<td style="text-align:left;">Tangerang, <?=date('d F Y', strtotime($pembelian['tanggal_pesan']))?></td>
					</tr>
					<tr>
