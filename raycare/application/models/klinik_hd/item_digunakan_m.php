...
class Item_digunakan_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'rm_obat_pasien.created_date'        => 'tanggal_resep', 
		'b.nama'        => 'namaitem',
		'c.nama'        => 'namapaket',
		'rm_obat_pasien.jumlah'        => 'jumlah',
		'rm_obat_pasien.is_paket'        => 'is_paket',
		'd.nama'        => 'nurse',
	...
	{	
		...
		$join2 = array('paket c',$this->_table . '.paket_id = c.id','left');
		$join3 = array('user d',$this->_table . '.created_by = d.id','left');
