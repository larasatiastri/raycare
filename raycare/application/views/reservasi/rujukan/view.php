<div class="portlet light">
	<div class="portlet-body form">
		<?php
			$form_attr = array(
			    "id"            => "form_view_rujukan", 
			    "name"          => "form_view_rujukan", 
			    "autocomplete"  => "off", 
		...
		<div class="form-body">
			<div class="portlet light" id="section-telepon">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate('View Rujukan', $this->session->userdata('language'))?></span>
					</div>
				</div>
