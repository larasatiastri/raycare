...
class Pengiriman_penjualan_detail_m extends MY_Model {

	protected $_table        = 'pengiriman_penjualan_detail';
	...
	public function get_jumlah_kirim($penjualan_detail_id) {
		...
		$sql = "SELECT SUM(jumlah) AS jumlah_kirim FROM pengiriman_penjualan_detail
