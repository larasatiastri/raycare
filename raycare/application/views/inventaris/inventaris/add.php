<?php
			$form_attr = array(
			    "id"            => "form_add_inventaris", 
			    "name"          => "form_add_inventaris", 
			    "autocomplete"  => "off", 
			...
			<div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group date" id="tanggal_pembelian">
                        <input type="text" class="form-control" id="tanggal_pembelian" name="tanggal_pembelian" value="<?=date('d M Y')?>" required readonly >
            ...
            <div class="form-group">
				...
				<div class="col-md-6">
					<?php
						...
						echo form_dropdown('pembeli_id', $user_option, '', 'id="pembeli_id" class="form-control"');
					?>
				</div>
			</div>
            <div class="form-group">
			...
			<div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group date" id="tanggal_serah_terima">
                        <input type="text" class="form-control" id="tanggal_serah_terima" name="tanggal_serah_terima" value="<?=date('d M Y')?>" required readonly >
                        <span class="input-group-btn">
                            <button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
                        </span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group date" id="tanggal_kembali">
                        <input type="text" class="form-control" id="tanggal_kembali" name="tanggal_kembali" value="<?=date('d M Y')?>" required readonly >
                        <span class="input-group-btn">
                            <button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
                        </span>
                    </div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<?php
						...
						echo form_dropdown('user_id', $user_option, '', 'id="user_id" class="form-control"');
					?>
				</div>
			</div>
			<div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group date" id="jadwal_maintenance">
                        <input type="text" class="form-control" id="jadwal_maintenance" name="jadwal_maintenance" value="<?=date('d M Y')?>" required readonly >
                        <span class="input-group-btn">
                            <button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
                        </span>
                    </div>
