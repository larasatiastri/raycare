					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="input-group date">
								<input type="text" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal" value="<?=date('d M Y')?>"readonly required>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="input-group">
								...
								<input class="form-control text-right" type="text" id="nominal_show" name="nominal_show" placeholder="Nominal" required>
