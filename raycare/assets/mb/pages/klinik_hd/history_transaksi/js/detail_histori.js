...
var handleisidata = function(data){
                                ...
                                $.ajax
                                    ...
                                    $("#bn_dialyzer").val(data.bn_dialyzer_value);
    ...
    var handleObservasi2 = function(){
      ...
      oTableObservasi2=$("#table_dialysis2").dataTable({
            ...
            'columns'               : [
                ...
                { 'name':'observasi_dialisis_hd.waktu_pencatatan od_waktu_pencatatan','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.tekanan_darah_1 od_tekanan_darah','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.ufg od_ufg','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.ufr od_urf','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.ufv od_ufv','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.qb od_qb','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'b.nama nama_pasien','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.keterangan od_keterangan','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'observasi_dialisis_hd.keterangan od_keterangan', 'visible' : false, 'searchable': false, 'orderable': false },
...
var handleResepObat= function(){
      ...
      oTableViewResepObat=$("#table_resep_obat").dataTable({
            ...
            'columns'               : [
                ...
                { 'name':'b.nama nama_obat','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'tindakan_resep_obat.tipe_item tipe_item','visible' : true, 'searchable': true, 'orderable': true },
                { 'name':'tindakan_resep_obat.jumlah jumlah_obat','visible' : true, 'searchable': true, 'orderable': true },

                {'name':'tindakan_resep_obat.dosis dosis','visible' : true, 'searchable': true, 'orderable': true },
    ...
    $('#uploaddokumen').uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                if(param2=='jpg' || param2=='jpeg' || param2=='png' || param2=='gif')
                                {
                                    $('#uploadchoosen_file_1').html("<img src="+ mb.baseUrl() + "assets/mb/pages/klinik_hd/history_transaksi/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
    ...
    $('#uploaddokumen2').uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                if(param2=='jpg' || param2=='jpeg' || param2=='png' || param2=='gif')
                                {
                                    $('#uploadchoosen_file_12').html("<img src="+ mb.baseUrl() + "assets/mb/pages/klinik_hd/history_transaksi/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
                                    $('#uploadchoosen_file_container_12').show();
