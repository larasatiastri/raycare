<?php
	...
	if($form_data_detail != '')
	{
		...
		foreach ($form_data_detail as $detail) 
		{
			...
			$item_cols_db = array(// style="width:156px;
				...
				'item_name'          => '<label class="text-left" name="items['.$i.'][item_nama]">'.$detail['nama'].'</label>'.form_input($attrs_item_nama_db).form_input($attrs_id_db),
				...
				'item_jumlah_terima'        => '<label class="control-label" name="items['.$i.'][jumlah_terima]"><a class="jumlah_terima" data-toggle="modal" data-target="#popup_modal_jumlah_terima" href="'.base_url().'pembelian/pembelian_obat/modal_jumlah_terima/'.$detail['id'].'/'.$detail['item_id'].'/'.$detail['item_satuan_id'].'">'.$jml_diterima.'</a> </label>',
	...
	$item_cols = array(// style="width:156px;
		...
		'item_name'          => '<label class="text-left" name="items[{0}][item_nama]"></label>'.form_input($attrs_item_nama).form_input($attrs_id_db),
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group <?=$hidden?>" id="tgl_kirim">
										<label class="col-md-12 bold"><?=translate("Tgl Kirim", $this->session->userdata("language"))?> :</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-12 bold"><?=translate("Tgl Kadaluarsa", $this->session->userdata("language"))?> :</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<label class="col-md-12"><?=$form_data[0]['nama'].' ['.$form_data[0]['kode'].']'?> </label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<label class="col-md-12"><?=$form_data[0]['no_telp']?> </label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-12 bold"><?=translate("Email", $this->session->userdata("language"))?> :</label>
										<label class="col-md-12"><?=$email_supplier?></label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-12 bold"><?=translate("Alamat", $this->session->userdata("language"))?> :</label>
								<label class="col-md-12"><?=$form_data[0]['alamat'].', '.$form_data[0]['rt_rw'].', '.$form_data[0]['kelurahan'].', '.$form_data[0]['kecamatan'].', '.$form_data[0]['kota'].', '.$form_data[0]['propinsi'].', Indonesia'?> </label>
							</div>
						...
						<div class="portlet-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<label class="col-md-12"><?=$data_customer->nama?></label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-12 bold"><?=translate("Kontak", $this->session->userdata("language"))?> :</label>
										<label class="col-md-12"><?=$data_customer->penanggung_jawab?></label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-12 bold"><?=translate("Email", $this->session->userdata("language"))?> :</label>
										<label class="col-md-12"><?=$customer_email->url?></label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-12 bold"><?=translate("Alamat", $this->session->userdata("language"))?> :</label>
								<label class="col-md-12"><?=$customer_alamat[0]['alamat'].', '.$customer_alamat[0]['nama_kelurahan'].', '.$customer_alamat[0]['kecamatan'].','.$customer_alamat[0]['kabkot'].', '.$customer_alamat[0]['propinsi']?></label>
							</div>
						</div>
					</div>
						...
						<div class="portlet-body">
							...
							<?php
								if($data_penawaran)
								{
									...
									{
										?>
											<li><a target="_blank" href="<?=base_url()?>assets/mb/pages/pembelian/pembelian/doc/penawaran/<?=$pk_value?>/<?=$penawaran['id']?>/<?=$penawaran['url']?>"><?=($penawaran['nomor_penawaran'] != '')?$penawaran['nomor_penawaran']:$penawaran['url']?></a></li>
										<?php
									}
								}else{
									?>
										<li>Tidak ada penawaran untuk pembelian ini.</li>
									<?php
								}
							?>
							</ul>
					...
					<div class="portlet box blue-sharp">
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-hover" id="table_detail_pembelian">
								<thead>
									<tr>
										<th class="text-center" style="min-width : 20px !important;"><?=translate("Kode", $this->session->userdata("language"))?> </th>
										<th class="text-center"><?=translate("Nama", $this->session->userdata("language"))?> </th>
										
										<th class="text-center"style="min-width : 120px !important;"><?=translate("Harga Sistem", $this->session->userdata("language"))?> </th>
								...
								<tfoot>
									...
									<tr>
										...
										<td class="text-right" style="background-color:#f9f9f9"><?=$form_data[0]['diskon']?> %</td>
										<td class="text-right" style="background-color:#f9f9f9"><?=formatrupiah(($form_data[0]['diskon']/100)*$total)?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="text-right" style="background-color:#f9f9f9"><?=$form_data[0]['pph']?> %</td>
										<td class="text-right" style="background-color:#f9f9f9"><?=formatrupiah(($form_data[0]['pph']/100)*$grand_total)?></td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="7" class="text-right bold" style="background-color:#f9f9f9">Grand Total</td>
										<td class="text-right bold" style="background-color:#f9f9f9"><?=formatrupiah($grand_total_non_biaya)?></td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="6" class="text-right bold" style="background-color:#f9f9f9">Biaya Tambahan</td>
										<td class="text-left" style="background-color:#f9f9f9"><?=($form_data[0]['ket_tambahan'] == '')?'-':$form_data[0]['ket_tambahan']?></td>
										<td class="text-right" style="background-color:#f9f9f9"><?=formatrupiah($form_data[0]['biaya_tambahan'])?></td>
									</tr>
									<tr>
