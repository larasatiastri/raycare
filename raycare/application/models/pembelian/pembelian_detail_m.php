...
class Pembelian_detail_m extends MY_Model {
	...
	public function get_max_hpp($item_id, $item_satuan_id)
	{
		$format = "SELECT MAX(harga_beli_primary) AS max_harga_primary FROM `pembelian_detail` WHERE item_id = '$item_id' AND item_satuan_id = '$item_satuan_id';";	
		return $this->db->query($format);
	}
