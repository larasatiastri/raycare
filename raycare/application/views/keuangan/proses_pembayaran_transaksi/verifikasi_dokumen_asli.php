...
<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="actions">
			...
			<a id="confirm_reject" class="btn btn-circle red-intense" href="<?=base_url()?>keuangan/proses_pembayaran_transaksi/tolak_dokumen_asli/<?=$pk_value?>" data-toggle="modal" data-target="#popup_modal_proses">
