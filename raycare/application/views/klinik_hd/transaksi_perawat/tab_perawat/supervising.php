	...
	<div class="portlet-title">
		...
		<div class="actions">
			<?php
        		...
        		$data = '<a class="btn btn-circle btn-default edit_supervising"><i class="fa fa-edit"></i> '.translate('Edit', $this->session->userdata('language')).'</a>';
        		echo restriction_button($data, $user_level_id, 'klinik_hd_transaksi_perawat', 'edit_supervising');
            ?>
								...
								<div class="input-group">
									<?php
						                $remaining = array(
						                    ...
						                    "readonly"		=> "readonly",
						                    "value"			=> ($form_assesment[0]['remaining_of_priming'] == '' || $form_assesment[0]['remaining_of_priming'] == NULL )?0:$form_assesment[0]['remaining_of_priming']
						                );
								...
								<div class="input-group">
									<?php
						                $washout = array(
						                    ...
						                    "readonly"		=> "readonly",
						                    "value"			=> ($form_assesment[0]['wash_out'] == '' || $form_assesment[0]['wash_out'] == NULL)?0:$form_assesment[0]['wash_out']
						                );
								...
								<div class="input-group">
									<?php
						                $drip_of_fluid = array(
						                    ...
						                    "readonly"		=> "readonly",
						                    "value"			=> ($form_assesment[0]['drip_of_fluid'] == '' || $form_assesment[0]['drip_of_fluid'] == NULL)?0:$form_assesment[0]['drip_of_fluid']
						                );
								...
								<div class="input-group">
									<?php
						                $blood = array(
						                    ...
						                    "readonly"		=> "readonly",
						                    "value"			=> ($form_assesment[0]['blood'] == '' || $form_assesment[0]['blood'] == NULL)?0:$form_assesment[0]['blood']
						                );
