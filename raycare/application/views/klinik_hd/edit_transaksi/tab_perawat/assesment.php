		...
		<!-- BEGIN FORM-->
			...
			<div class="form-body">
				<div class="row">
					...
					<div class="form-group">
						<label class="control-label col-md-3"><?=translate('Dry Weight', $this->session->userdata('language'))?> :</label>
						<div class="col-md-4">
							<label class="control-label"><?=$form_pasien['berat_badan_kering']?> Kg</label>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3"><?=translate('Weight Pre HD', $this->session->userdata('language'))?> :</label>
						<div class="col-md-2">
							<div class="input-group">
								<input class="form-control" id="berat_awal" name="berat_awal" value="<?=$form_tindakan['berat_awal']?>" readonly required>
					...
					<div class="form-group">
						<label class="control-label col-md-3"><?=translate('Weight Post HD', $this->session->userdata('language'))?> :</label>
						<div class="col-md-2">
							<div class="input-group">
								<input class="form-control" id="berat_akhir" name="berat_akhir" value="<?=$form_tindakan['berat_akhir']?>" readonly required>
								<span class="input-group-addon">
									&nbsp;Kg&nbsp;
								</span>
							</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-5">
								<?php
									$data_bed = $this->bed_m->get_by(array('is_active' => 1));
									$bed_option = array();

									foreach ($data_bed as $bed) 
									{
										$bed_option[$bed->id] = $bed->kode;
									}

									echo form_dropdown('machine_no_id', $bed_option, $form_tindakan['bed_id'], 'id="machine_no_id" class="form-control" readonly');
