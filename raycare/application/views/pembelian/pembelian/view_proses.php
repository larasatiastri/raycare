	...
	if($form_data_detail != '')
	{
		...
		foreach ($form_data_detail as $detail) 
		{
			...
			$item_cols_db = array(// style="width:156px;
				...
				'item_jumlah_terima'        => '<label class="control-label" name="items['.$i.'][jumlah_terima]"><a class="jumlah_terima" data-toggle="modal" data-target="#popup_modal_jumlah_terima" href="'.base_url().'pembelian/pembelian/modal_jumlah_terima/'.$detail['id'].'/'.$detail['item_id'].'/'.$detail['item_satuan_id'].'">'.$jml_diterima.'</a> </label>',
