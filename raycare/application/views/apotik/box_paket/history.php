...
<div class="portlet light">
    <div class="portlet-title"> 
        ...
        <div class="actions">   
            <a class="btn btn-circle btn-default" href="<?=base_url()?>apotik/box_paket/history_all"><i class="fa fa-undo"></i>  <?=translate("History", $this->session->userdata("language"))?></a>
            <a class="btn btn-circle btn-info" href="<?=base_url()?>apotik/box_paket"><i class="fa fa-chevron-left"></i>  <?=translate("Kembali", $this->session->userdata("language"))?></a>
    ...
    <div class="portlet-body form">
        <div class="form-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="table_stok_box_paket">
                <thead>
                <tr>
