...
class Tindakan_hd_note_history_m extends MY_Model {

	protected $_table        = 'tindakan_hd_note_history';
	...
	protected $datatable_columns = array(
		...
		'tindakan_hd_note_history.note'    => 'note', 
		'a.nama'                   => 'nama_perawat_buat', 
		'b.nama'                   => 'nama_perawat_edit', 
		'tindakan_hd_note_history.status'  => 'status', 
		'tindakan_hd_note_history.id'    => 'id', 
	);
	...
	{	
		...
		$params['sort_by'] = 'tindakan_hd_note_history.id';
		$params['sort_dir'] = 'asc';
