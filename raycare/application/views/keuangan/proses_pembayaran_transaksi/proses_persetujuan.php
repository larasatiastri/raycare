			...
			<div class="row">
				<div class="col-md-3">
					<div class="portlet light bordered">
						...
						<div class="form-group">
							<div class="col-md-12">
								<label><?=translate('Nomor', $this->session->userdata('language'))?> :</label>
							</div>
							<div class="col-md-12">
								<label><b><?=$form_data['nomor_permintaan']?></b></label>
								<input type="hidden" name="nomor_permintaan" id="nomor_permintaan" value="<?=$form_data['nomor_permintaan']?>">
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
						...
						<div class="form-group">								
							...
							<div class="col-md-12">
								...
								<input type="hidden" name="keperluan" id="keperluan" value="<?=$form_data['keperluan']?>">
								<input type="hidden" name="tipe_kasbon" id="tipe_kasbon" value="<?=$form_data['tipe_kasbon']?>">
							</div>
						</div>	
						<div class="form-group hidden">
							<div class="col-md-12">
				...
				<div class="col-md-9">
					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject"><?=translate("Detail Item Kasbon", $this->session->userdata("language"))?></span>
							</div>
						</div>
						<div class="form-body">
									...
									if($form_data['tipe'] == 2 && $form_data['nominal'] > 0){
										...
										if(count($form_data_detail) != 0){
											foreach ($form_data_detail as $key => $bon) {
												...
												<td style="vertical-align: top !important;"><input type="hidden" name="biaya['.$i.'][permintaan_biaya_bon_id]" id="biaya_permintaan_biaya_bon_id_'.$i.'" value="'.$bon['id'].'"><input type="hidden" name="biaya['.$i.'][no_bon]" id="biaya_no_bon_'.$i.'" value="'.$bon['no_bon'].'">'.$bon['no_bon'].'</td>
												...
												<td style="vertical-align: top !important;"><input type="hidden" name="biaya['.$i.'][total_biaya]" id="biaya_total_bon_'.$i.'" value="'.$bon['total_bon'].'">'.formatrupiah($bon['total_bon']).'</td>
