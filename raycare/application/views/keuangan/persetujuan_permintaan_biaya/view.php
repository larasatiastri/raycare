			...
			<div class="row">
				<div class="col-md-3">
					<div class="portlet light bordered">
						...
						<div class="form-group">								
							<div class="col-md-12">
								<labell class="bold"><?=translate('Diminta Oleh', $this->session->userdata('language'))?> :</label>
							</div>
							<div class="col-md-12">
						...
						<div class="form-group">								
							<div class="col-md-12">
								<labell class="bold"><?=translate('Nominal', $this->session->userdata('language'))?> :</label>
							</div>
							<div class="col-md-12">
						...
						<div class="form-group">								
							<div class="col-md-12">
								<labell class="bold"><?=translate('Terbilang', $this->session->userdata('language'))?> :</label>
							</div>
							<div class="col-md-12">
						...
						<div class="form-group">								
							<div class="col-md-12">
								<labell class="bold"><?=translate('Keperluan', $this->session->userdata('language'))?> :</label>
							</div>
							<div class="col-md-12">
						...
						<div class="form-body">
						    <div class="portlet-body">
                                ...
                                <div class="form-group">
									...
									<label class="col-md-12"><a  data-toggle="modal" data-target="#modal_view" href="<?=base_url()?>keuangan/persetujuan_permintaan_biaya/modal_view/<?=$form_data['id']?>"><?=formatrupiah($form_data['nominal_setujui'])?></a></label>
