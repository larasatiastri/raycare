mb.app.ubah_password = mb.app.ubah_password || {};

// mb.app.home.ubah_password namespace
(function(o){

    var $form = $('#form_ubah_password');
    var baseAppUrl = '';
    ...
    o.init = function(){
    	baseAppUrl = mb.baseUrl() + "pengaturan/ubah_password/";
    	handleValidation();
    	handleConfirmSave();

    };

}(mb.app.ubah_password));


// initialize  mb.app.ubah_password
$(function(){
	mb.app.ubah_password.init();
});