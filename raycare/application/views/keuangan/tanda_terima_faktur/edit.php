<?php
    ...
    echo form_open(base_url()."gudang/request_item/submit_permintaan_item", $form_attr,$hidden);
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <?php
                ...
                $confirm_save   = translate('Apa Kamu Yakin Akan Ubah Request Item Ini ?',$this->session->userdata('language'));
            ...
            <div class="form-wizard">
                ...
                <div class="form-body">
                    ...
                    <div class="alert alert-success display-hide">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4"><?=translate("Request Ke :", $this->session->userdata("language"))?></label>     
                            <div class="col-xs-2">
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4"><?=translate("Tanggal Request", $this->session->userdata("language"))?> :</label>
                            <div class="col-xs-2">
                                <?php
                                    $tanggal = array(
                                        "id"            => "tanggal_request",
                                        ...
                                        "placeholder"   => translate("Tanggal Request", $this->session->userdata("language"))
                                    );
                        ...
                        $attrs_item_delete    = array (
                            ...
                            $item_cols = array(// style="width:156px;
                                ...
                                'item_stok'             => '<div class="text-center">
                                                            ...
                                                            <input class="form-Control text-center hidden" name="items[{0}][stock_tersedia]">
                                                            <label class="control-label" name="items[{0}][stock_tersedia]"></label>
                                                            </div>',
                            ...
                            if($records)
                            {
                                ...
                                foreach ($records as $key => $data) 
                                {
                                    ...
                                    $attrs_transfer_item_id['value'] = $data['request_item_id'];
                                    ...
                                    $item_cols = array(// style="width:156px;
                                        ...
                                        'item_stok'             => '<div class="text-center">
                                                                    ...
                                                                    <label class="control-label" name="items[{0}][stock]">'.$data['stock'].'</label> / <label class="control-label" name="items[{0}][stock_tersedia]"></label>
                                                                    </div>',
                                        'item_jumlah_kirim'         => '<div class="input-group text-right" style="width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Item Yang Diminta", $this->session->userdata("language"))?></span>
                                    </div>
                                </div>
