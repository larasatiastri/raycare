    <form action="<?=base_url()?>keuangan/proses_pembayaran_transaksi/tolak_invoice" method="post" id="form_reject" class="form-horizontal">
        
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title font-blue-sharp bold uppercase"><?=translate("Tolak Invoice PO", $this->session->userdata("language"))?></h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea id="keterangan_tolak" name="keterangan_tolak" class="form-control" rows="3" placeholder="Keterangan"></textarea>
                ...
                <?php
                    $confirm_save       = translate('Anda yakin akan menolak invoice PO ini ?',$this->session->userdata('language'));
