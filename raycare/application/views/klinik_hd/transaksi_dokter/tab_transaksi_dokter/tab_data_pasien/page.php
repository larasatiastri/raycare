									...
									<div class="input-group">
										<?php
							                $bb_awal = array(
							                    ...
							                    "maxlength"		=> "255",
							                    "class"			=> "form-control", 
							                    "placeholder"	=> translate("Berat Badan Awal", $this->session->userdata("language")), 
							                    "readonly"		=> "readonly",
							                    // "value"			=> date("d M Y", strtotime($date_value))
							                );
							                echo form_input($bb_awal);
							            ?>	
								...
								<div class="col-md-6">
									...
									<?php
						                $bb_akhir = array(
						                    ...
						                    "maxlength"		=> "255",
						                    "class"			=> "form-control", 
						                    "placeholder"	=> translate("Berat Badan Akhir", $this->session->userdata("language")), 
						                    "readonly"		=> "readonly",
						                    // "value"			=> date("d M Y", strtotime($date_value))
						                );
						                echo form_input($bb_akhir);
						            ?>	
						            <span class="input-group-addon">
											<i> Kg </i>
										</span>
				...
				<div class="form-body">
					<div class="table-container">
						...
						<tr role="row" class="heading">
							...
							<th width="10%">
								<center> <?=translate("Diinput Oleh", $this->session->userdata("language"))?></center>
							</th>
							<th width="10%">
				...
				<div class="form-body">
					<div class="table-container">
						...
						<tr role="row" class="heading">
							...
							<th width="15%">
								<center> <?=translate("Diberikan Oleh", $this->session->userdata("language"))?></center>
							</th>
							<th width="15%">
