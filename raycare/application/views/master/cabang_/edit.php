<div class="portlet light">
	...
	<div class="portlet-body form">
		...
		?>
					...
					<div class="col-md-3">
						<?php
							$no_telp1 = array(
								...
								"required"    => "required",
								"value"       => $form_data['nomor_telepon1']
							);
					...
					<div class="col-md-3">
						<?php
							$no_telp2 = array(
								...
								"value"       => $form_data['nomor_telepon2']						
							);
			...
			<?php $msg = translate("Apakah anda yakin akan merubah data cabang ini?",$this->session->userdata("language"));?>
