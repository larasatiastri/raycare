...
class Penjualan_customer_m extends MY_Model {
	...
	{	
		$join1 = array('customer_alamat', $this->_table.'.id = customer_alamat.customer_id', 'left');
		$join2 = array('customer_telepon', $this->_table.'.id = customer_telepon.customer_id', 'left');
		$join3 = array('inf_lokasi', 'customer_alamat.kode_lokasi = inf_lokasi.lokasi_kode', 'left');
		$join4 = array('customer_email', $this->_table.'.id = customer_email.customer_id', 'left');
		...
		$this->db->where('customer_email.is_primary',1);
