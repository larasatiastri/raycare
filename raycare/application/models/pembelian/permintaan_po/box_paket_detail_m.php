...
class Box_paket_detail_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'box_paket_detail.id'				=> 'id_box_paket_detail',
		'box_paket_detail.box_paket_id'		=> 'box_paket_id',
		'box_paket_detail.item_id'			=> 'item_id',
		'box_paket_detail.item_satuan_id'	=> 'item_satuan_id',
		'box_paket_detail.jumlah'			=> 'jumlah',
		'SUM(box_paket_detail.jumlah)' 		=> 'jumlah_box'
	);
	...
	public function get_box_detail($box_paket_id)
	{

		$format = "SELECT
					box_paket_detail.id,
					box_paket_detail.box_paket_id,
					box_paket_detail.item_id,
					box_paket_detail.item_satuan_id,
					box_paket_detail.jumlah,
					SUM(jumlah) as jumlah_box,
					box_paket_detail.modified_date
					FROM
					box_paket_detail
					WHERE
					box_paket_detail.box_paket_id = $box_paket_id";
...
/* End of file Box_paket_detail_m.php */
/* Location: ./application/models/master/Box_paket_detail_m.php */