...
class Customer_alamat_m extends MY_Model {
	...
	public function get_alamat($customer_id){
		...
		$this->db->select('customer_alamat.subjek_id AS subjek_id, customer_alamat.alamat AS alamat, customer_alamat.rt_rw AS rt_rw, customer_alamat.kode_pos AS kode_pos, 
							inf_lokasi.lokasi_nama AS lokasi_nama, inf_lokasi.nama_propinsi AS nama_propinsi, inf_lokasi.nama_kabupatenkota AS nama_kabupatenkota, 
							inf_lokasi.nama_kecamatan AS nama_kecamatan, inf_lokasi.nama_kelurahan AS nama_kelurahan');
