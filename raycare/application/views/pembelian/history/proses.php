<?php
		    ...
		    echo form_open(base_url()."pembelian/history/save", $form_attr, $hidden);
			...
			$item_cols = array(// style="width:156px;
				'item_kode'          => '<label class="control-label hidden" name="items[{0}][item_kode]" style="text-align : left !important; width : 150px !important;"></label><div class="input-group">'.form_input($attrs_item_id).form_input($attrs_item_kode).form_input($attrs_action_items).form_input($attrs_is_delete_items).form_input($attrs_draft_id).form_input($attrs_detail_id).'<span class="input-group-btn">'.$btn_search.'</span></div>',
				'item_name'          => '<label class="control-label" name="items[{0}][item_nama]">'.$attrs_item_nama['value'] = $data['nama'].'</label>'.form_input($attrs_item_nama).'<div id="tabel_simpan_data_{0}" class="hidden"></div>',
...
<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="actions">
			...
			<a id="confirm_save" class="btn btn-sm btn-primary btn-circle" href="#" data-confirm="<?=$msg?>" data-toggle="modal"><i class="fa fa-check"></i> <?=translate("Buat PO", $this->session->userdata("language"))?></a>
					...
					<div class="portlet">
						...
						<div class="portlet-body form">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<?php
											...
											echo form_input($tipe_supplier);
										?>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3"><?=translate("Supplier", $this->session->userdata("language"))?> :</label>
									<div class="col-md-6">
										<?php
											$nama_supplier = array(
												"id"			=> "nama_supplier",
								...
								<!-- <div class="form-group">
									<label class="control-label col-md-3"><?=translate("Tipe Produk", $this->session->userdata("language"))?> :</label>
									<div class="col-md-8">
										<?php
											$tipe_produk = array(
												"id"			=> "nama_supplier",
											...
											echo form_input($tipe_produk);
										?>
									</div>
								</div> -->
								<div class="form-group">
									<label class="control-label col-md-3"><?=translate("Kontak", $this->session->userdata("language"))?> :</label>
									<div class="col-md-5">
										<?php
								...
								<div class="form-group">
									<label class="control-label col-md-3"><?=translate("Email", $this->session->userdata("language"))?> :</label>
									<div class="col-md-5">
										<?php
								...
								<div class="form-group">
									<label class="control-label col-md-3"><input type="checkbox" id="check"><?=translate("Info", $this->session->userdata("language"))?> :</label>
									<div class="col-md-6">
										<?php
											$info_supplier = array(
												"id"			=> "info_supplier",
												...
												"rows"			=> 5,
												"class"			=> "form-control",
												"placeholder"	=> translate("Info", $this->session->userdata("language")),
												"style"			=> "resize: none;",
												"readonly"		=> "readonly"
											);
											echo form_textarea($info_supplier);
										?>
									</div>
								</div>
							</div>
				...
				<div class="portlet-body">
					...
					<table class="table table-striped table-bordered table-hover" id="table_detail_pembelian">
						...
						<tr>
							...
							<td colspan="2">
								<div class="input-group col-md-12">
									<input class="form-control text-right" type="number" value="0" min="0" id="diskon" name="diskon">
									<span class="input-group-addon">
										&nbsp;%&nbsp;
									</span>
								</div>
						...
						<tr>
							...
							<td colspan="2">
								<div class="input-group col-md-12">
									<input class="form-control text-right" type="number" value="0" min="0" id="pph" name="pph">
									<span class="input-group-addon">
										&nbsp;%&nbsp;
									</span>
								</div>
