													...
													<td class="details" colspan="3">
														...
														foreach ($data_identitas as $identitas) {
															...
															$htmlx .= '<tr>
																...
																<td>'.$identitas['jumlah'].' '.$item['satuan'].'</td>
																<td>'.$status.'</td>
															</tr>';	
														}
											...
											foreach ($form_data_item_pulang as $item) {
												...
												if ($item['is_identitas'] == 1) {
													$input_jumlah = '<div class="input-group">
																...
																<span class="input-group-btn"><button type="button" data-toggle="modal" data-target="#popup_modal_jumlah_keluar" href="'.base_url().'apotik/resep_obat/add_identitas/item_pulang_'.$i.'/'.$item['item_id'].'/'.$form_data['cabang_id'].'" class="btn blue-chambray add-identitas" name="item['.$i.'][identitas]" title="Tambah Jumlah"><i class="fa fa-info"></i></button></span>
															</div>';
												}
