...
class Pengiriman_identitas_detail_m extends MY_Model {
	...
	public function get_item_identitas($id)
	{
		...
		$format = "SELECT
					pengiriman_identitas.id as id,
					pengiriman_identitas.pengiriman_detail_id,
					pengiriman_identitas.jumlah,
					pengiriman_identitas_detail.identitas_id,
					pengiriman_identitas_detail.judul,
					pengiriman_identitas_detail.`value`,
					identitas.tipe,
					inventory.harga_beli,
					inventory.jumlah as jumlah_inventory
					FROM
					pengiriman_identitas
					LEFT JOIN pengiriman_identitas_detail ON pengiriman_identitas.id = pengiriman_identitas_detail.id
					LEFT JOIN identitas ON pengiriman_identitas_detail.identitas_id = identitas.id
					LEFT JOIN inventory ON pengiriman_identitas.pengiriman_detail_id = inventory.pengiriman_detail_id
					WHERE
					 	pengiriman_identitas.id = '$id'
					";

		return $this->db->query($format);
	}

	public function get_data_identitas($kirim_identitas_detail_id, $identitas_id)
	{
		$format = "SELECT pengiriman_identitas_detail.*, pengiriman_identitas.jumlah
					FROM
					pengiriman_identitas_detail
					JOIN pengiriman_identitas ON pengiriman_identitas_detail.pengiriman_identitas_id = pengiriman_identitas.id
					WHERE pengiriman_identitas_detail.pengiriman_identitas_id IN ('$kirim_identitas_detail_id') 
					ORDER BY pengiriman_identitas_detail.identitas_id ASC, pengiriman_identitas_detail.value ASC";
		return $this->db->query($format);
	}
}
