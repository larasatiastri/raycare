...
//        }
    ...
    private function _pre_input() {
        ...
        // yani modif 
        $date_wrapper = ($this->func == 'form_date') ? '<div class="input-group input-medium date date-picker " data-date="' . $this->elm_options['value'] . '" data-date-format="dd-mm-yyyy" data-date-viewmode="years">' : '';
    ...
    private function _post_input() {
        // return '</div>' ;
        // yani add close $date_wrapper div 
        return '</div>' . (($this->func == 'form_date') ? '</div>' : '');
    }
    ...
    private function _label() {
        ...
        //added by yani
        //add html after text label like <span class="required">*</span>
        $label_post_html = '';
        if (isset($this->elm_options['label_post_html'])) {
          $label .= $this->elm_options['label_post_html'];
          // remove it, so it not used on _build_input
          unset($this->elm_options['label_post_html']);
        } 
