	...
	if($form_data_detail != '')
	{
		...
		foreach ($form_data_detail as $detail) 
		{
			...
			$item_cols_db = array(// style="width:156px;
				...
				'item_jumlah'        => '<label class="control-label" name="items['.$i.'][jumlah_pesan]">'.$detail['jumlah_pesan'].' </label>',
				'item_jumlah_setujui'        => '<label class="control-label" name="items['.$i.'][jumlah_setujui]">'.$detail['jumlah_disetujui'].' </label>',
				'item_total'         => '<div class="text-right"><label class="control-label" name="items['.$i.'][item_total]">'.formatrupiah(($detail['harga_beli'] - (($detail['diskon']/100)*$detail['harga_beli'])) * $detail['jumlah_pesan']).'</label>'.form_input($attrs_item_total_db).'</div>',
			);
...
<div class="portlet light">
	...
	<div class="portlet-body form">
		<div class="form-body">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="portlet box blue-sharp" id="section-bon">
	                    ...
	                    <div class="portlet-title" style="margin-bottom: 0px !important;">
	                        <div class="caption">
	                            <span class="caption-subject"><?=translate("Supplier", $this->session->userdata("language"))?></span>
	                        </div>
	                    </div>
	                    <div class="portlet-body">
		                    <div class="row">
	                	...
	                	<div class="portlet-title" style="margin-bottom: 0px !important;">
	                        <div class="caption">
	                            <span class="caption-subject"><?=translate("Customer", $this->session->userdata("language"))?></span>
	                        </div>
	                    </div>
	                    <div class="portlet-body">
	                    	<div class="row">
							...
							<table class="table table-striped table-hover" id="table_detail_pembelian">
								<thead>
									<tr>
										...
										<th class="text-center" style="width : 150px !important;"><?=translate("Jumlah Disetujui", $this->session->userdata("language"))?> </th>
