...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Verifikasi Dokumen Pembayaran", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">
			<a class="btn default" href="<?=base_url()?>keuangan/pembayaran_transaksi/history">
	...
	<div class="portlet-body">
		...
		<table class="table table-striped table-hover" id="table_pembayaran_transaksi">
			<thead>
			<tr>
