<div class="portlet light">
	<div class="portlet-title">
		...
		<div class="actions">
           <div class="actions">
				<a href="<?=base_url()?>laporan/grafik_hd_bulan" class="btn btn-circle btn-default"> <i class="fa fa-chevron-left"></i> 
	           		<span class="hidden-480">
	                     <?=translate("Kembali", $this->session->userdata("language"))?>
	                </span>
	            </a>
	            <a href="<?=base_url()?>laporan/grafik_hd_bulan/csv/<?=$start?>/<?=$penjamin_id?>/<?=$tipe?>" class="btn btn-circle btn-default"> <i class="fa fa-print"></i> 
	           		<span class="hidden-480">
