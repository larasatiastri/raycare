...
class Pendaftaran_tindakan_history_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'pendaftaran_tindakan_history.cabang_id'     => 'cabang_id',
		'pendaftaran_tindakan_history.poliklinik_id' => 'poliklinik_id',
	...
	protected $datatable_columns_history = array(
		...
		'pendaftaran_tindakan_history.`status`'      => 'status',
		'pendaftaran_tindakan_history.status_verif'  => 'status_verif',
		'pendaftaran_tindakan_history.tanggal_verif'  => 'tanggal_verif',
		'pendaftaran_tindakan_history.created_date'  => 'tanggal',
		'poliklinik.nama'                    => 'nama_poliklinik',
		'`user`.nama'                        => 'nama_user',
		'pasien.nama'                        => 'nama_pasien',
	...
	{
		$join1 = array('poliklinik', 'pendaftaran_tindakan_history.poliklinik_id = poliklinik.id', 'left');
		$join2 = array('`user`', 'pendaftaran_tindakan_history.created_by = `user`.id', 'left');
		$join3 = array('pasien', 'pendaftaran_tindakan_history.pasien_id = pasien.id', 'left');
		$join4 = array('penjamin', 'pendaftaran_tindakan_history.penjamin_id = penjamin.id', 'left');
		$join5 = array('pasien_penjamin', 'pendaftaran_tindakan_history.pasien_id = pasien_penjamin.pasien_id AND pendaftaran_tindakan_history.penjamin_id = pasien_penjamin.penjamin_id', 'left');
	...
	public function get_datatable_history()
	{
		...
		$join4 = array('penjamin', 'pendaftaran_tindakan_history.penjamin_id = penjamin.id', 'left');
		$join5 = array('pasien_penjamin', 'pendaftaran_tindakan_history.pasien_id = pasien_penjamin.pasien_id AND pendaftaran_tindakan_history.penjamin_id = pasien_penjamin.penjamin_id', 'left');
		$join6 = array('`user`as user_verif', 'pendaftaran_tindakan_history.user_verif_id = user_verif.id', 'left');

		$join_tables = array($join1, $join2, $join3, $join4, $join5, $join6);

		// get params dari input postnya datatable
		$params = $this->datatable_param($this->datatable_columns_history);
		$params['sort_by'] = 'pendaftaran_tindakan_history.tanggal_verif';		
...
/* End of file pendaftaran_tindakan_history_m.php */
/* Location: ./application/models/pendaftaran_tindakan_history_m.php */