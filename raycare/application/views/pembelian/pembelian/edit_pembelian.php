<?php
	...
	if($form_data_detail != '')
	{
		...
		$hidden = ''; 
		if($form_data['is_single'] == 1) $hidden = 'hidden';
									...
									<div class="tab-pane" id="tab_info_pembelian">
										<div class="form-body">
											...
											<div class="form-group <?=$hidden?>" id="tgl_kirim">
												...
												<div class="col-md-12">
													<div class="input-group date">
														<input type="text" class="form-control" id="tanggal_kirim" name="tanggal_kirim" value="<?=date('d M Y', strtotime($form_data['tanggal_kirim']))?>" readonly >
														<span class="input-group-btn">
															<button class="btn default date-set" type="button" ><i class="fa fa-calendar"></i></button>
														</span>
													</div>
							...
							<table class="table table-striped table-bordered table-hover" id="table_detail_pembelian">
								...
								<tfoot>
									...
									<tr>
										...
										<td>
											<div class="input-group col-md-12">
												<input class="form-control text-right" min="0" max="100" id="pph_23" name="pph_23" value="<?=$form_data[0]['pph_23']?>">
												<span class="input-group-addon">
													&nbsp;%&nbsp;
												</span>
											</div>
										...
										<td colspan="2">
											<div class="input-group col-md-12">
												...
												<input class="form-control text-right" id="pph_23_nominal" name="pph_23_nominal" value="<?=$form_data[0]['pph_23_nominal']?>">
											</div>
										</td>
									</tr>
