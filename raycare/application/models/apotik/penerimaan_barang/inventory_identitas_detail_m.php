...
class Inventory_identitas_detail_m extends MY_Model {
	...
	protected $_order_by     = 'inventory_identitas_detail_id';
	...
	{
		$format = "SELECT MAX(inventory_identitas_detail_id) as max_id_identitas_detail FROM inventory_identitas_detail";
