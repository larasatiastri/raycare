    <form action="<?=base_url()?>keuangan/persetujuan_pembayaran_kasbon/tolak_permintaan" method="post" id="form_reject" class="form-horizontal">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" id="persetujuan_pembayaran_kasbon_id" name="persetujuan_pembayaran_kasbon_id"  value="<?=$persetujuan_pembayaran_kasbon_id?>" required="required" />
                            <input type="hidden" id="pengajuan_pembayaran_kasbon_id" name="pengajuan_pembayaran_kasbon_id"  value="<?=$pengajuan_pembayaran_kasbon_id?>" required="required" />
