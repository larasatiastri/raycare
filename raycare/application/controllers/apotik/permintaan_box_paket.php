...
class Permintaan_box_paket extends MY_Controller {
    ...
    {
        $assets = array();
        $config = 'assets/apotik/permintaan_box_paket/index';
        ...
        $data = array(
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'apotik/permintaan_box_paket/index',
            );
    ...
    public function history()
    {
        ...
        $data = array(
            ...
            'css_files'      => $assets['css'],
            'js_files'       => $assets['js'],
            'content_view'   => 'apotik/permintaan_box_paket/history',
            );
    ...
    {        
        ...
        foreach($records->result_array() as $row)
        {
            ...
            $action = '<a title="'.translate('Proses', $this->session->userdata('language')).'" href="'.base_url().'apotik/permintaan_box_paket/proses/'.$row['id'].'" data-toggle="modal" data-target="#modal_proses" class="btn btn-primary"><i class="fa fa-check"></i></a>
    ...
    {   
        ...
        if ($array_input['command'] == "add") {
            ...
            $tindakan_hd_item_id = insert_data_api($data_tindakan_hd_item,$data_cabang['url'],$path_model);
            ...
            $tindakan_hd_ass_id = update_data_api($data_assesment,$data_cabang['url'],$path_model,$wheres_assesment);
            ...
            $edit_permintaan = $this->permintaan_box_paket_m->edit_data($data_permintaan,$permintaan_id);

            $path_model = 'apotik/permintaan_box_paket_m';
            $edit_permintaan_api = insert_data_api_id($data_permintaan,$data_cabang['url'],$path_model,$permintaan_id);
    ...
    public function delete($id)
    {
        ...
        // save data
        $resep_racik_obat_id = $this->permintaan_box_paket_m->edit_data($data, $id);
        ...
        redirect("apotik/permintaan_box_paket");
    }
    ...
    public function proses($id)
    {
        ...
        $this->load->view('apotik/permintaan_box_paket/modal_proses',$data);
    }
