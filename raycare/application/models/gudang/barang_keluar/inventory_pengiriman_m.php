...
class Inventory_pengiriman_m extends MY_Model {

	protected $_table        = 'inventory_pengiriman';
	...
	{
		$format = "SELECT MAX(inventory_pengiriman_id) AS inventory_pengiriman_id FROM inventory_pengiriman";
