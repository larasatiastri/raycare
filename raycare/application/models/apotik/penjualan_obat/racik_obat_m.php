...
class Racik_obat_m extends MY_Model {
	...
	{		
		$join1 = array('resep_racik_obat', $this->_table.'.resep_racik_obat_id = resep_racik_obat.id', 'LEFT');
		$join2 = array('user', 'resep_racik_obat.user_id = user.id', 'LEFT');
		$join3 = array('item_satuan', $this->_table.'.satuan_produksi = item_satuan.id', 'LEFT');
