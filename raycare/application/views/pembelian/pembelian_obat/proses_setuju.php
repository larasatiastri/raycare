<?php
	...
	if($form_data_detail != '')
	{
		...
		foreach ($form_data_detail as $detail) 
		{
			...
			$btn_jumlah_db        = '<a class="btn blue-chambray add-jumlah '.$hidden_btn.'" href="'.base_url().'pembelian/pembelian_obat/edit_jumlah_edit/item_row_'.$i.'/'.$detail['id'].'" data-original-title="Tambah Jumlah" title="'.translate('Tambah Jumlah', $this->session->userdata('language')).'" data-toggle="modal" data-target="#popup_modal_jumlah" ><i class="fa fa-truck"></i></a>';
									...
									<?php
										if($data_penawaran)
										{
											...
											foreach ($data_penawaran as $penawaran)
											{
												?>
												<tr>
													<td><a target="_blank" href="<?=base_url()?>assets/mb/pages/pembelian/pembelian_obat/doc/penawaran/<?=$pk_value?>/<?=$penawaran['id']?>/<?=$penawaran['url']?>"><?=($penawaran['nomor_penawaran'] != '')?$penawaran['nomor_penawaran']:$penawaran['url']?></a></td>
												</tr>
												<?php
											}
										}
							...
							<table class="table table-striped table-bordered table-hover" id="table_detail_pembelian">
								...
								<tfoot>
									...
									<tr>
										...
										<td >
											<a class="btn blue-chambray add-biaya" title="<?=translate('Tambah Biaya', $this->session->userdata('language'))?>" href="<?=base_url()?>pembelian/pembelian_obat/edit_biaya/<?=$pk_value?>" data-toggle="modal" data-target="#modal_biaya">
