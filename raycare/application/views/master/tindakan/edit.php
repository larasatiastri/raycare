<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			<span class="caption-subject font-green-sharp bold uppercase"><?=translate("Edit Tindakan", $this->session->userdata("language"))?></span>
		</div>
	</div>
		...
		?>
			<div class="form-body">
				...
				<div class="form-group">
					<label class="control-label col-md-2"><?=translate("Kode Poliklinik", $this->session->userdata("language"))?> <span class="required">*</span>:</label>
					<div class="col-md-2">
						<?php
							$kode_cabang = array(
								"name"			=> "kode1",
								...
								"autofocus"			=> true,
								"class"			=> "form-control", 
								"placeholder"	=> translate("Kode Poliklinik", $this->session->userdata("language")), 
								"required"		=> "required",
				...
				<div class="form-group">
					<label class="control-label col-md-2"><?=translate("Nama Poliklinik", $this->session->userdata("language"))?> <span class="required">*</span>:</label>
					<div class="col-md-3">
						<?php
							$nama_cabang = array(
								"name"			=> "nama1",
								"id"			=> "nama1",
								"class"			=> "form-control", 
								"placeholder"	=> translate("Nama Poliklinik", $this->session->userdata("language")), 
								"required"		=> "required",
				...
				<div class="form-group">
					<label class="control-label col-md-2"><?=translate("Harga Pusat", $this->session->userdata("language"))?> <span class="required">*</span>:</label>
					<div class="col-md-3">
						<?php
							$nama_cabang = array(
								"name"			=> "harga1",
			...
			<?php $msg = translate("Apakah anda yakin akan merubah tindakan ini?",$this->session->userdata("language"));?>
