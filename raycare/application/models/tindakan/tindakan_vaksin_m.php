...
class Tindakan_vaksin_m extends MY_Model {

	protected $_table        = 'tindakan_vaksin';
	...
	protected $datatable_columns = array(
		...
		'tindakan_vaksin.id'               => 'id',
		'tindakan_vaksin.pasien_nama'      => 'nama_pasien',
		'master_vaksin.nama'               => 'nama_vaksin',
		'tindakan_vaksin.tanggal'          => 'tanggal',
		'a.nama'                           => 'nama_dokter',
		'b.nama'                           => 'nama_perawat',
		'cabang.nama'                      => 'nama_cabang',
		'tindakan_vaksin.master_vaksin_id' => 'master_vaksin_id',
		'tindakan_vaksin.cabang_id'        => 'cabang_id',
		'tindakan_vaksin.tipe_pasien'      => 'tipe_pasien',
		'tindakan_vaksin.pasien_id'        => 'pasien_id',
		'tindakan_vaksin.dokter_id'        => 'dokter_id',
		'tindakan_vaksin.perawat_id'       => 'perawat_id'
	);
	...
	{
		$format = "SELECT MAX(SUBSTRING(`id`,13,4)) AS max_id FROM `tindakan_vaksin` WHERE SUBSTR(`id`,5,7) = DATE_FORMAT(NOW(), '%m-%Y');";	
		return $this->db->query($format);
	}

	public function get_data($transaksi_id)
	{
		$format = "SELECT pembayaran_tipe, nomor_tipe, SUM(total) as total FROM `tindakan_vaksin` WHERE transaksi_id = '$transaksi_id' GROUP BY pembayaran_tipe, nomor_tipe";
		return $this->db->query($format);
