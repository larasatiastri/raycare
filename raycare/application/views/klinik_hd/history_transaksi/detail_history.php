			...
			<div class="portlet light">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Detail Histori Tindakan HD", $this->session->userdata("language"))?></span>
					</div>
					<div class="actions">
						<a class="btn default" href="<?=base_url()?>klinik_hd/history_transaksi">
						<i class="fa fa-chevron-left"></i>
							<?=translate("Kembali", $this->session->userdata("language"))?>
						</a>

						<?php
							$data_pasien_prev = $this->tindakan_hd_history_m->get_data_hd_pasien($id, $pasien_id, "prev")->result_array();
							$data_pasien_next = $this->tindakan_hd_history_m->get_data_hd_pasien($id, $pasien_id, "next")->result_array();
							...
							if (!empty($data_pasien_prev)) {
								$disable_prev = "";
								$url_prev = base_url().'klinik_hd/history_transaksi/detail_history/'.$data_pasien_prev[0]['id'].'/'.$pasien_id;
							}
							...
							if (!empty($data_pasien_next)) {
								$disable_next = "";
								$url_next = base_url().'klinik_hd/history_transaksi/detail_history/'.$data_pasien_next[0]['id'].'/'.$pasien_id;
							}
						?>
						<a class="btn default btn-icon-only" <?=$disable_prev?> href="<?=$url_prev?>">
							<i class="fa fa-fast-backward"></i>
						</a>
						<a class="btn default btn-icon-only" <?=$disable_next?> href="<?=$url_next?>">
					    ...
					    <div class="row">
					    	<div class="col-md-3">
					    		<div class="portlet light bordered"> 
									...
									<label class="col-md-12 bold"><?=translate("No.Transaksi", $this->session->userdata("language"))?> :</label>
									
									 	<label class="col-md-12"><?=$form_data_kiri[0]['no_transaksi']?></label>
								...
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Tanggal", $this->session->userdata("language"))?> :</label>
									 		...
									 		<label class="col-md-12"><?=($form_data_kiri[0]['tanggal']!= NULL || $form_data_kiri[0]['tanggal']!='')?date('d M Y',strtotime($form_data_kiri[0]['tanggal'])):'-'?></label>
										
								</div>

					    		<div class="form-group">
									<label class="col-md-12 bold"><?=translate("No.Pasien", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kiri[0]['no_member']?></label>
								...
								<div class="form-group">
									<label class=" col-md-12 bold"><?=translate("Nama Pasien", $this->session->userdata("language"))?> :</label>
									 		...
									 		<label class="col-md-12"><?=$form_data_kiri[0]['nama']?></label>
									
								</div>

								<div class="form-group">
									<label class=" col-md-12 bold"><?=translate("Dialisis Terakhir", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=($form_data_kiri[0]['tanggal_terakhir']!= NULL || $form_data_kiri[0]['tanggal_terakhir']!='')?date('d M Y',strtotime($form_data_kiri[0]['tanggal'])):'-'?></label>
								...
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Keterangan", $this->session->userdata("language"))?> :</label>
									 		...
									 		<label class="col-md-12"><?=$form_data_kiri[0]['keterangan']?></label>
								...
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Dokter", $this->session->userdata("language"))?> :</label>
									 		...
									 		<label class="col-md-12"><?=$form_data_kanan[0]['nama']?></label>
										
								</div>
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Berat Awal", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kanan[0]['berat_awal']?> Kg</label>
										
								</div>
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Berat Akhir", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kanan[0]['berat_akhir']?> Kg</label>
										
								</div>
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Rujukan", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kanan[0]['nama_poli']?></label>
										
								</div>
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("No.Bed", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kanan[0]['kode']?></label>
										
								</div>
								<div class="form-group">
									<label class="col-md-12 bold"><?=translate("Klaim", $this->session->userdata("language"))?> :</label>
								 
										
									 		<label class="col-md-12"><?=$form_data_kanan[0]['nama_penjamin']?></label>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="control-label col-md-3"><?=translate("Batch Number :", $this->session->userdata("language"))?></label>
									...
									<div class="col-md-6">
										...
										<?php
							                $bn_dialyzer = array(
							                    ...
							                    "maxlength"		=> "255",
							                    "class"			=> "form-control", 
							                    "placeholder"	=> translate("Batch Number", $this->session->userdata("language")), 
							                    "readonly"		=> "readonly",
							                    // "value"			=> $dialyzer_value
							                );
