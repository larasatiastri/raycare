...
class Penjualan_identitas_detail_m extends MY_Model {

	protected $_table        = 'penjualan_identitas_detail';
	...
	{
		$format = "SELECT
						penjualan_identitas.id,
						penjualan_identitas.jumlah,
						penjualan_identitas_detail.identitas_id,
						penjualan_identitas_detail.judul,
						penjualan_identitas_detail.`value`,
						penjualan_identitas.dus,
						penjualan_identitas.penjualan_detail_id
					FROM
						penjualan_identitas
					JOIN penjualan_identitas_detail ON penjualan_identitas.id = penjualan_identitas_detail.penjualan_identitas_id
					WHERE
						penjualan_identitas.id = ".$id."
				";
