    ...
    <div class="form-group">
        ...
        <div class="col-md-2" id="input_jumlah">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <a class="btn btn-primary btn-modal-identitas" href="<?=base_url()?>klinik_hd/edit_transaksi/modal_inventori_identitas" data-toggle="modal" data-target="#modal_identitas"><i class="fa fa-info"></i></a>
                </span>
            </div>
        </div>
        <div class="col-md-3">
