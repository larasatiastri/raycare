...
class Order_permintaan_pembelian_detail_other_m extends MY_Model {
	...
	{	
		...
		$join2 = array('persetujuan_permintaan_pembelian','order_permintaan_pembelian.id = persetujuan_permintaan_pembelian.order_permintaan_pembelian_id AND persetujuan_permintaan_pembelian.order_permintaan_pembelian_detail_id = order_permintaan_pembelian_detail_other.id', 'LEFT');
