<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("Daftar Surat Traveling", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">
            <a href="<?=base_url()?>klinik_hd/surat_traveling/index" class="btn btn-circle btn-default">
	...
	<div class="portlet-body">
		<table class="table table-striped table-bordered table-hover" id="tabel_surat_traveling" style=" border-collapse: collapse !important;">
			<thead>
				<tr>
