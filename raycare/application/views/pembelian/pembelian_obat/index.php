		...
		<div class="tab-pane active" id="tab_pembelian_baru">
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions">
			            <a href="<?=base_url()?>pembelian/pembelian_obat/add" class="btn btn-default btn-circle hidden">
		...
		<div class="tab-pane" id="tab_pembelian_proses">
			<div class="portlet light">
					<div class="portlet-title">
						...
						<div class="actions">
				            <a href="<?=base_url()?>pembelian/pembelian_obat/history" class="btn default">
