mb.app.pembayaran_transaksi = mb.app.pembayaran_transaksi || {};
(function(o){
    ...
    var handleDataTable = function() 
    {
    	...
    	oTable = $table1.dataTable({
			...
			'columns'               : [
                { 'name' : 'pembayaran_transaksi.id id', 'visible' : true, 'searchable': false, 'orderable': false },
                { 'name' : 'pembayaran_transaksi.created_date tanggal', 'visible' : true, 'searchable': false, 'orderable': false },
                ...
                { 'name' : 'b.nama nama_level_proses','visible' : true, 'searchable': false, 'orderable': false },
 ...
 }(mb.app.pembayaran_transaksi));


// initialize  mb.app.home.table
$(function(){
    mb.app.pembayaran_transaksi.init();
});