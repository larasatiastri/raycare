            ...
            bootbox.confirm(msg, function(result) {
                if (result==true) {
 					...
 					if($("#pilih_opsi").val()=='clear' || $("#pilih_opsi").val()=='all')
 					{
 						...
 						$.each($("#table_edit_paket tbody tr"),function(){
                        	ItemArray.push({
    							item_id :  $('input[name$="[itemid2]"]',this).val(), 
    							jumlah : $('input[name$="[user2]"]',this).val(),
                    ...
                    ({ 
                        ...
                        data:  {data:ItemArray,data2:ItemArray2,transaksiid:$("#idtindakanpaket").val(),paket_id:$("#idtindakanpaketid").val(),tindakanhdpaketid:$("#tindakanhdpaketid").val(),tggl_tindakan:$("#tggl_tindakan").val(),keterangan_tindakan:$("#keterangan_tindakan").val()},  
                        dataType : 'json',
               //           beforeSend : function(){
               //  			Metronic.blockUI({boxed: true });
                        ...
                        { 
                             //alert('sukses');
                           //  $(".modal_batal3")[0].click();
                             // $(".modal_batal3").attr("data-dismiss","modal");
                        ...
                        ({ 
                                ...
                                { 
                                    ...
                                    $.each($("#table_edit_paket tbody tr"),function(){
                                      ...
                                      $.each($("#table_edit_paket tbody tr"),function(){
                             				$('input[name$="[user]"]',this).val($('input[name$="[sisa2]"]',this).val());
                	...
                	// 				Metronic.blockUI({boxed: true });
                                ...
                                { 
                                    ...
                                    $.each($("#table_edit_tindakan tbody tr"),function(){
                                      ...
                                      $.each($("#table_edit_tindakan tbody tr"),function(){
                             				$('input[name$="[user4]"]',this).val($('input[name$="[sisa5]"]',this).val());
