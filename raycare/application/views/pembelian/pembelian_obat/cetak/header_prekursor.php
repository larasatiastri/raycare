...
<body>
	<div id="header" style="padding-top:30px;background-color:#FFF;border-bottom:1px solid #2462AC;">
		<?php 
			if (file_exists($_SERVER['DOCUMENT_ROOT']."cloud/".config_item('site_dir')."logo/logo-big-apotik.png") && is_file($_SERVER['DOCUMENT_ROOT']."cloud/".config_item('site_dir')."logo/logo-big-apotik.png")) 
	        {
	            $image_header = config_item('base_dir')."cloud/".config_item('site_dir')."/logo/logo-big-apotik.png";
	        }
	        else 
	        {
	            $image_header = config_item('base_dir')."cloud/".config_item('site_dir')."/logo/logo-big-apotik.png";
