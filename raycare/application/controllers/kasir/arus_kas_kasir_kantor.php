...
class Arus_kas_kasir_kantor extends MY_Controller {

    // protected $menu_parent_id = 2;           // deprecated, pake $menu_tree
    protected $menu_id = 'e0882b84a52528ae5aa6b9085c74c773';                  // untuk check bit_access
    ...
    {       
        ...
        $this->load->model('kasir/arus_kas_kasir_kantor/kasir_arus_kas_m');
    ...
    {
        $assets = array();
        $config = 'assets/kasir/arus_kas_kasir_kantor/index';
        $this->config->load($config, true);
        $assets = $this->config->item('assets', $config);
        
        // die(dump( $assets['css'] ));
        $data = array(
            'title'          => config_item('site_name').' | '.translate('Arus Kas Kasir Kantor', $this->session->userdata('language')), 
            'header'         => translate('Arus Kas Kasir Kantor', $this->session->userdata('language')), 
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'kasir/arus_kas_kasir_kantor/index',
            );
    ...
    public function listing($tgl_awal=null,$tgl_akhir=null)
    {
        ...
        $result = $this->kasir_arus_kas_m->get_datatable($tgl_awal,$tgl_akhir);
        // die_dump($result);
...
/* End of file arus_kas_kasir_kantor.php */
/* Location: ./application/controllers/keuangan/arus_kas_kasir_kantor.php */