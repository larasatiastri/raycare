	...
	<div class="portlet-body">
		...
		<div class="col-md-12">
			<div class="portlet light bordered">
							...
							if(count($data_bayar_detail_po) != 0){
								foreach ($data_bayar_detail_po as $key => $bon) {
									...
									<td style="vertical-align: top !important;">
										<div class="col-md-12">
												<input type="hidden" required name="invoice['.$i.'][url]" id="invoice_url_'.$i.'">
												<div id="upload_'.$i.'">
													<span class="btn default btn-file">
														<span class="fileinput-new">'.translate('Pilih Foto', $this->session->userdata('language')).'</span>		
														<input type="file" class="upl_invoice" name="upl" id="upl_'.$i.'" data-url="'.base_url().'upload/upload_photo" multiple />
													</span>
                ...
                <div class="portlet-body"> 
					<div class="form-group">
						<label class="col-md-3"><?=translate("Keterangan", $this->session->userdata("language"))?> :</label>
						<div class="col-md-6">
