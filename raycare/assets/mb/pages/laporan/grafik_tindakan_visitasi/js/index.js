mb.app.grafik_tindakan_visitasi = mb.app.grafik_tindakan_visitasi || {};
(function(o){
    ...
    var handleDataTable = function() 
    {
        ...
        $tableTindakanBulanan.on('draw.dt', function (){
            var jml_tindakan = $('input#input_tindakan', this).val(),
                ...
                jml_total = $('input#input_total', this).val();
            ...
            if(!isNaN(jml_total))
            {
                jml_total = parseInt(jml_total);
                $('th#total_nominal', this).text(mb.formatRp(jml_total));  
            }
            else
            {
                $('th#total_nominal', this).text(0);  
            }
            if(!isNaN(jml_pagi))
            {
   ...
   var handleGetPasien = function(start, penjamin_id) {
    ...
    o.init = function(){
        baseAppUrl = mb.baseUrl() + 'laporan/grafik_tindakan_visitasi/';
        handleMonthPeriode();
        handleDataTable();
 ...
 }(mb.app.grafik_tindakan_visitasi));


// initialize  mb.app.home.table
$(function(){
    mb.app.grafik_tindakan_visitasi.init();
});