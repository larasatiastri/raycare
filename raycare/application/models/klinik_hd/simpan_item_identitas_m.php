...
class Simpan_item_identitas_m extends MY_Model {

	protected $_table        = 'simpan_item_identitas';
   ...
   //die(dump($result->records));
	...
	{	
		...
		$this->db->group_by('simpan_item.item_id, simpan_item.item_satuan_id');
	...
	public function delete_simpan_item_identitas_kosong($simpan_item_identitas_id)
	{
		$this->db->where('simpan_item_identitas_id', $simpan_item_identitas_id);
	...
	{
		$sql= "select max(simpan_item_identitas_id) as max_id from simpan_item_identitas;";
