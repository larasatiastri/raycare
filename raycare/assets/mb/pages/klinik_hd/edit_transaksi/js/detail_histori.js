    ...
    $('#uploaddokumen').uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                if(param2=='jpg' || param2=='jpeg' || param2=='png' || param2=='gif')
                                {
                                    $('#uploadchoosen_file_1').html("<img src="+ mb.baseUrl() + "assets/mb/pages/klinik_hd/edit_transaksi/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
    ...
    $('#uploaddokumen2').uploadify({
                            ...
                            "onUploadSuccess"   : function(file, data, response) {
                             var paramsArray = data.split('%%__%%');
                                ...
                                if(param2=='jpg' || param2=='jpeg' || param2=='png' || param2=='gif')
                                {
                                    $('#uploadchoosen_file_12').html("<img src="+ mb.baseUrl() + "assets/mb/pages/klinik_hd/edit_transaksi/images/temp/"+param1+" style='border: 1px solid #000; max-width:200px; max-height:200px;'>");
                                    $('#uploadchoosen_file_container_12').show();
