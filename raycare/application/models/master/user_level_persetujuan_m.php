...
class User_level_persetujuan_m extends MY_Model {
	...
	public function get_data_by_user_level_id_and_user_level_menyetujui_id($user_level_id, $user_level_menyetujui_id)
	{
		$this->db->select('user_level_persetujuan.id,
		...
		$this->db->where('user_level_menyetujui_id', $user_level_menyetujui_id);
