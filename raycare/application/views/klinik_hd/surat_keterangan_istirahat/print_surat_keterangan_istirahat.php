<html>
	...
	<body>
		<?php
			$cabang_id = $data_istirahat['cabang_id'];
		...
		<div id="body_surat">
			<div id="title">
				<b>SURAT KETERANGAN ISTIRAHAT</b>
			</div>
			<div id="no_surat"><span style="border-top:2px solid #000;">NO:<?=$data_istirahat['no_surat']?></span>
				
			</div>
			<br>
			<br>
			<div id="tanggal_surat">
				Jakarta, <?=date('d/m/Y', strtotime($data_istirahat['created_date']));?>
			</div>
			<br>
			<br>
			<div id="isi_surat">
				...
				<br>
				<br>
				<span id="paragraf_surat">Berdasarkan hasil pemeriksaan, bahwa yang bersangkutan dalam keadaan: Sakit.
				<br>
				Maka harus istirahat selama <?=$data_istirahat['lama_istirahat']?> hari. Terhitung mulai tanggal <?=date('d/m/Y', strtotime($data_istirahat['tanggal_mulai']))?> s/d <?=date('d/m/Y', strtotime($data_istirahat['tanggal_selesai']))?>.
				<br>
				Demikian harap maklum.</span>
			</div>
			<br>
			<br>
