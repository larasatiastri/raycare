...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-blue-sharp bold uppercase"><?=translate("History Pembayaran Transaksi", $this->session->userdata("language"))?></span>
		</div>
		<div class="actions">
			<a class="btn btn-default btn-circle" href="<?=base_url()?>keuangan/pembayaran_transaksi">
	...
	<div class="portlet-body">
		...
		<table class="table table-striped table-hover" id="table_pembayaran_transaksi_history">
			<thead>
			<tr>
