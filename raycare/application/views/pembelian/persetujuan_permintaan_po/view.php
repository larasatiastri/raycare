					...
					<div class="row">
						<div class="col-md-3">
							<div class="portlet light bordered">
								...
								<div class="form-group">
									<label class="control-label col-md-4"><?=translate("Cabang :", $this->session->userdata("language"))?></label>		
									<div class="col-md-8">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									<div class="table-responsive">
	                                    <table class="table table-condensed table-striped table-bordered table-hover" id="table_item_terdaftar">
	                                        <thead>
	                                            <tr>
						...
						<div class="col-md-9 hidden" id="section_tidak_terdaftar">
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									<div class="table-responsive">
	                                    <table class="table table-condensed table-striped table-bordered table-hover" id="table_item_tidak_terdaftar">
	                                        <thead>
	                                            <tr>
