...
(function(o){
    ...
    { 
          ...
          $tableCabang.on('draw.dt', function (){
              ...
              handleDeleteRow(id,msg,$('#sales_status', $tableCabang).val());
              });  
       
          });

          $(theadFilterTemplate).appendTo($('thead', $tableCabang));
        $( '#sales_status', $tableCabang ).on( 'change', function () {
            //$tableitemArrival.fnFilter( this.value, 4);
          oTable.api().ajax.url(baseAppUrl + 'listing/' + this.value).load();
          // alert($(this).val());
        } );
    		  
    }

    var handleDeleteRow = function(id,msg,stat){
        ...
        $.ajax
                        ({ 
                                ...
                                { 
                                   ...
                                   oTable.api().ajax.url(baseAppUrl + 'listing/' + stat).load();
