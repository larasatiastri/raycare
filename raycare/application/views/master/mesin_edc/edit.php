<?php
			$form_attr = array(
			    "id"            => "form_edit_mesin_edc", 
			    "name"          => "form_edit_mesin_edc", 
			    "autocomplete"  => "off", 
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<?php
						...
						echo form_dropdown('bank_id', $bank_option, $form_data['bank_id'], 'id="bank_id" class="form-control"');
					?>
				</div>
			</div>

		</div>
		<?php $msg = translate("Apakah anda yakin akan mengubah data mesin edc ini?",$this->session->userdata("language"));?>
