...
class Permintaan_biaya_bon_m extends MY_Model {
	...
	protected $datatable_columns = array(
		...
		'permintaan_biaya.id' 				=> 'id_permintaan',
		'`user`.nama'						=> 'nama_user',
	    'permintaan_biaya.tanggal' 			=> 'tanggal',
		'permintaan_biaya.nomor_permintaan' => 'nomor_permintaan',
		'permintaan_biaya_bon.no_bon' 		=> 'no_bon',
		'permintaan_biaya_bon.tgl_bon' 		=> 'tgl_bon',
		'permintaan_biaya_bon.total_bon' 	=> 'total_bon',
		'permintaan_biaya_bon.keterangan' 	=> 'keterangan',
		'permintaan_biaya_bon.url' 			=> 'url',
		'permintaan_biaya_bon.id' 			=> 'id_permintaan_detail'
	);
	...
	{	
		...
		$this->db->where_in('permintaan_biaya.status', $array_status);
		if($status != NULL) {
