...
mb.app.resep_obat.add_resep_manual = mb.app.resep_obat.add_resep_manual || {};

// mb.app.resep_obat.add_resep_manual namespace
(function(o){

    var 
        baseAppUrl              = '',
        $form                   = $('#form_add_resep_manual'),
    ...
    var handleItemSearchSelect = function($btn){
        $btn.on('click', function(e){
            var 
                ...
                $itemKode = null,
                $itemNama = null,
                $classrow   = $('.table_resep_obat', $tableItemDigunakan),
...
}(mb.app.resep_obat.add_resep_manual));


// initialize  mb.app.resep_obat.add_resep_manual
$(function(){
    mb.app.resep_obat.add_resep_manual.init();
});