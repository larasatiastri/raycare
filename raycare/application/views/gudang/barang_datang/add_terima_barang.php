<?php
    $form_attr = array(
        "id"            => "form_add_barang_datang", 
        "name"          => "form_add_barang_datang", 
        "autocomplete"  => "off", 
    ...
    echo form_open(base_url()."gudang/barang_datang/save", $form_attr);
...
<div class="portlet light">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a id="tambah_identitas" class="btn btn-default btn-circle">
...
<script type="text/javascript">
    ...
    function handleBtnSaveAjax($btn)
    {
        ...
        $btn.on('click', function(){
            ...
            $.ajax({
                type     : 'POST',
                url      : mb.baseUrl() + 'gudang/barang_datang/save_draft_detail',
