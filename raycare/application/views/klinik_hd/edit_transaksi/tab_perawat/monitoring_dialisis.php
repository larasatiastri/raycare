	...
	<div class="portlet-title">
		...
		<div class="actions">
			<?php
        		...
        		$data = '<a class="btn btn-circle btn-default" data-toggle="modal" href="'.base_url().'klinik_hd/edit_transaksi/add_monitoring/'.$form_tindakan['id'].'/'.$form_assesment[0]['id'].'" data-target="#modal_dialisis_add"><i class="fa fa-plus"></i> '.translate('Tambah', $this->session->userdata('language')).'</a>';
        		echo restriction_button($data, $user_level_id, 'klinik_hd_edit_transaksi', 'add_dialisis');
            ?>
