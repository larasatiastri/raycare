...
(function(o){
     ...
     var 
        baseAppUrl                    = '',
        $form                         = $('#form_proses_manual'),
        $tableAddItem                 = $('#table_add_item', $form),
    ...
    var addItemRow = function(){
        ...
        $('select.select-resep', $newItemRow).select2();
    ...
    var handleDataTableItems = function(){
       ...
       oTable = $tablePilihItem.dataTable({
            ...
            'ajax'                  : {
                'url' : baseAppUrl + 'listing_item/' + cabang_id,
                'type' : 'POST',
            },          
            'pageLength'            : 10,
            ...
            'columns'               : [
                ...
                { 'name' : 'gudang.nama nama_gudang','visible' : true, 'searchable': true, 'orderable': true },
    ...
    var handleItemSelect = function($btn){
        $btn.on('click', function(e){
            ...
            var 
                ...
                $itemGdgIn = $('input[name$="[gudang_id]"]', $row);
                $itemGdgEl = $('label[name$="[gudang_nama]"]', $row);
                ...
                $('.search-item', $tableAddItem).popover('hide');
                    ...
                    $itemGdgIn.val($(this).data('item')['gudang_id']);
                    $itemGdgEl.text($(this).data('item')['nama_gudang']);
