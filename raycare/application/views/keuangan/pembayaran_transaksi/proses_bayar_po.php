	...
	<div class="portlet-body">
		...
		<div class="col-md-6">
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject"><?=translate("Daftar Proforma Invoice", $this->session->userdata("language"))?></span>
					</div>
				</div>
                ...
                <div class="portlet-body">
                    ...
                    $form_upload_bon = '
                        ...
                        if($form_data[0]['is_pkp'] == 1){
							$form_upload_bon .= '<div class="form-group upload_pkp">
                                <label class="col-md-12">'.translate("Upload Faktur Pajak", $this->session->userdata("language")).' :<span class="required">*</span></label>
                                <div class="col-md-12">
                                    <input type="hidden" name="bon[{0}][url_pajak]" id="bon_url_pajak_{0}" required>
                                    <div id="upload_pajak_{0}">
                                        <span class="btn default btn-file">
                                            <span class="fileinput-new">'.translate('Pilih Foto', $this->session->userdata('language')).'</span>        
                                            <input type="file" class="upl_invoice" name="upl" id="upl_pajak_{0}" data-url="'.base_url().'upload/upload_photo" multiple />
                                        </span>
