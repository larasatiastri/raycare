<form id="form_tindakan_lain" name="form_tindakan_lain" autocomplete="off" class="form-horizontal" role="form">		 
<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="actions">
			<a id="simpan_tindakan_lain" title="simpan" data-confirm="<?=translate('Anda yakin akan membuat tindakan lain untuk pasien ini?', $this->session->userdata('language'))?>" class="btn btn-icon-only btn-circle btn-primary" name="simpanresep">
			...
			<div class="form-group" id="kantong_transfusi">
				...
				<div class="col-md-6">
					<div class="input-group">
						<input type="number" id="jumlah_kantong_darah" name="jumlah_kantong_darah" class="form-control" value="1" min="1" max="6"> 
						<input type="hidden" id="pasienid" name="pasienid" class="form-control" value="<?=$form_tindakan['pasien_id']?>"> 
