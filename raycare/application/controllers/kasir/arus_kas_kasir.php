...
class Arus_kas_kasir extends MY_Controller {
    ...
    {       
        ...
        $this->load->model('kasir/arus_kas_kasir/kasir_arus_kas_m');
    ...
    {
        $assets = array();
        $config = 'assets/kasir/arus_kas_kasir/index';
        ...
        $data = array(
            ...
            'js_files'       => $assets['js'],
            'content_view'   => 'kasir/arus_kas_kasir/index',
            );
...
/* End of file arus_kas_kasir.php */
/* Location: ./application/controllers/keuangan/arus_kas_kasir.php */